...
*akeyless.V2Api* | [**updateAWSTarget**](docs/V2Api.md#updateAWSTarget) | **PUT** /update-aws-target | 
...
*akeyless.V2Api* | [**updateAzureTarget**](docs/V2Api.md#updateAzureTarget) | **PUT** /update-azure-target | 
...
*akeyless.V2Api* | [**updateEKSTarget**](docs/V2Api.md#updateEKSTarget) | **PUT** /update-eks-target | 
*akeyless.V2Api* | [**updateGKETarget**](docs/V2Api.md#updateGKETarget) | **PUT** /update-gke-target | 
*akeyless.V2Api* | [**updateGcpTarget**](docs/V2Api.md#updateGcpTarget) | **PUT** /update-gcp-target | 
*akeyless.V2Api* | [**updateItem**](docs/V2Api.md#updateItem) | **POST** /update-item | 
*akeyless.V2Api* | [**updateNativeK8STarget**](docs/V2Api.md#updateNativeK8STarget) | **PUT** /update-k8s-target | 
*akeyless.V2Api* | [**updateRDPTargetDetails**](docs/V2Api.md#updateRDPTargetDetails) | **POST** /update-rdp-target-details | 
*akeyless.V2Api* | [**updateRabbitMQTarget**](docs/V2Api.md#updateRabbitMQTarget) | **PUT** /update-rabbitmq-target | 
