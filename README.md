...
*akeyless.V2Api* | [**createManagedKey**](docs/V2Api.md#createManagedKey) | **POST** /create-managed-key | 
...
*akeyless.V2Api* | [**gatewayUpdateItem**](docs/V2Api.md#gatewayUpdateItem) | **POST** /update-managed-key | 
...
## Documentation for Models
 ...
 - [akeyless.CreateManagedKey](docs/CreateManagedKey.md)
 - [akeyless.CreateManagedKeyOutput](docs/CreateManagedKeyOutput.md)
 ...
 - [akeyless.CreateTargetOutput](docs/CreateTargetOutput.md)
 ...
 - [akeyless.ManagedKeyDetailsInfo](docs/ManagedKeyDetailsInfo.md)
 - [akeyless.ManagedKeyStatusInfo](docs/ManagedKeyStatusInfo.md)
 - [akeyless.ManagedKeyTargetInfo](docs/ManagedKeyTargetInfo.md)
 ...
 - [akeyless.UpdateManagedKey](docs/UpdateManagedKey.md)
 ...
 - [akeyless.UpdateRotatedSecretSC](docs/UpdateRotatedSecretSC.md)
 - [akeyless.UpdateRotatedSecretSCOutput](docs/UpdateRotatedSecretSCOutput.md)
