...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.UidListChildren();
  });
  ...
  describe('UidListChildren', function() {
    it('should create an instance of UidListChildren', function() {
      // uncomment below and update the code to test UidListChildren
      //var instane = new akl.UidListChildren();
      //expect(instance).to.be.a(akl.UidListChildren);
    });
