...
(function(root, factory) {
  ...
  describe('EsmGet', function() {
    it('should create an instance of EsmGet', function() {
      // uncomment below and update the code to test EsmGet
      //var instane = new akeyless.EsmGet();
      //expect(instance).to.be.a(akeyless.EsmGet);
    });
