...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.UidGenerateToken();
  });
  ...
  describe('UidGenerateToken', function() {
    it('should create an instance of UidGenerateToken', function() {
      // uncomment below and update the code to test UidGenerateToken
      //var instane = new akl.UidGenerateToken();
      //expect(instance).to.be.a(akl.UidGenerateToken);
    });
