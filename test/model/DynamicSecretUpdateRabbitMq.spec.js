...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateRabbitMq();
  });
  ...
  describe('DynamicSecretUpdateRabbitMq', function() {
    it('should create an instance of DynamicSecretUpdateRabbitMq', function() {
      // uncomment below and update the code to test DynamicSecretUpdateRabbitMq
      //var instane = new akeyless.DynamicSecretUpdateRabbitMq();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateRabbitMq);
    });
