...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AccountCustomFieldUpdate();
  });
  ...
  describe('AccountCustomFieldUpdate', function() {
    it('should create an instance of AccountCustomFieldUpdate', function() {
      // uncomment below and update the code to test AccountCustomFieldUpdate
      //var instance = new akeyless.AccountCustomFieldUpdate();
      //expect(instance).to.be.a(akeyless.AccountCustomFieldUpdate);
    });
