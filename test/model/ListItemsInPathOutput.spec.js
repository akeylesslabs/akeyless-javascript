...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.ListItemsInPathOutput();
  });
  ...
  describe('ListItemsInPathOutput', function() {
    it('should create an instance of ListItemsInPathOutput', function() {
      // uncomment below and update the code to test ListItemsInPathOutput
      //var instane = new akl.ListItemsInPathOutput();
      //expect(instance).to.be.a(akl.ListItemsInPathOutput);
    });
