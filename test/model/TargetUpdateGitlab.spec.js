...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGitlab();
  });
  ...
  describe('TargetUpdateGitlab', function() {
    it('should create an instance of TargetUpdateGitlab', function() {
      // uncomment below and update the code to test TargetUpdateGitlab
      //var instane = new akeyless.TargetUpdateGitlab();
      //expect(instance).to.be.a(akeyless.TargetUpdateGitlab);
    });
