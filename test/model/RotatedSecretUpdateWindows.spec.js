...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateWindows();
  });
  ...
  describe('RotatedSecretUpdateWindows', function() {
    it('should create an instance of RotatedSecretUpdateWindows', function() {
      // uncomment below and update the code to test RotatedSecretUpdateWindows
      //var instane = new akeyless.RotatedSecretUpdateWindows();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateWindows);
    });
