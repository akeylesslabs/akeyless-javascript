...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateRabbitMq();
  });
  ...
  describe('TargetCreateRabbitMq', function() {
    it('should create an instance of TargetCreateRabbitMq', function() {
      // uncomment below and update the code to test TargetCreateRabbitMq
      //var instane = new akeyless.TargetCreateRabbitMq();
      //expect(instance).to.be.a(akeyless.TargetCreateRabbitMq);
    });
