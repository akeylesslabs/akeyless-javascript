...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGrok();
  });
  ...
  describe('TargetUpdateGrok', function() {
    it('should create an instance of TargetUpdateGrok', function() {
      // uncomment below and update the code to test TargetUpdateGrok
      //var instance = new akeyless.TargetUpdateGrok();
      //expect(instance).to.be.a(akeyless.TargetUpdateGrok);
    });
    ...
    it('should have the property grokUrl (base name: "grok-url")', function() {
      // uncomment below and update the code to test the property grokUrl
      //var instance = new akeyless.TargetUpdateGrok();
      //expect(instance).to.be();
    });
    ...
    it('should have the property teamId (base name: "team-id")', function() {
