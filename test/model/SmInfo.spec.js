...
(function(root, factory) {
  ...
  describe('SmInfo', function() {
    it('should create an instance of SmInfo', function() {
      // uncomment below and update the code to test SmInfo
      //var instane = new akeyless.SmInfo();
      //expect(instance).to.be.a(akeyless.SmInfo);
    });
