...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreatePostgresql();
  });
  ...
  describe('RotatedSecretCreatePostgresql', function() {
    it('should create an instance of RotatedSecretCreatePostgresql', function() {
      // uncomment below and update the code to test RotatedSecretCreatePostgresql
      //var instane = new akeyless.RotatedSecretCreatePostgresql();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreatePostgresql);
    });
