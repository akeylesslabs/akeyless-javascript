...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateRdp();
  });
  ...
  describe('DynamicSecretCreateRdp', function() {
    it('should create an instance of DynamicSecretCreateRdp', function() {
      // uncomment below and update the code to test DynamicSecretCreateRdp
      //var instane = new akeyless.DynamicSecretCreateRdp();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateRdp);
    });
