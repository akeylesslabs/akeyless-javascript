...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateOIDC();
  });
  ...
  describe('AuthMethodUpdateOIDC', function() {
    it('should create an instance of AuthMethodUpdateOIDC', function() {
      // uncomment below and update the code to test AuthMethodUpdateOIDC
      //var instane = new akeyless.AuthMethodUpdateOIDC();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateOIDC);
    });
