...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.StaticSecretDeleteSync();
  });
  ...
  describe('StaticSecretDeleteSync', function() {
    it('should create an instance of StaticSecretDeleteSync', function() {
      // uncomment below and update the code to test StaticSecretDeleteSync
      //var instance = new akeyless.StaticSecretDeleteSync();
      //expect(instance).to.be.a(akeyless.StaticSecretDeleteSync);
    });
