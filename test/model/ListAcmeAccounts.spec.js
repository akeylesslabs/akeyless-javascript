...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ListAcmeAccounts();
  });
  ...
  describe('ListAcmeAccounts', function() {
    it('should create an instance of ListAcmeAccounts', function() {
      // uncomment below and update the code to test ListAcmeAccounts
      //var instane = new akeyless.ListAcmeAccounts();
      //expect(instance).to.be.a(akeyless.ListAcmeAccounts);
    });
