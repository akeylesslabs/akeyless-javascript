...
(function(root, factory) {
  ...
  describe('GetRSAPublic', function() {
    it('should create an instance of GetRSAPublic', function() {
      // uncomment below and update the code to test GetRSAPublic
      //var instane = new akl.GetRSAPublic();
      //expect(instance).to.be.a(akl.GetRSAPublic);
    });
