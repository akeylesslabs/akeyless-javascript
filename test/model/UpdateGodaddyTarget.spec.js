...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateGodaddyTarget();
  });
  ...
  describe('UpdateGodaddyTarget', function() {
    it('should create an instance of UpdateGodaddyTarget', function() {
      // uncomment below and update the code to test UpdateGodaddyTarget
      //var instane = new akeyless.UpdateGodaddyTarget();
      //expect(instance).to.be.a(akeyless.UpdateGodaddyTarget);
    });
