...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateEmail();
  });
  ...
  describe('AuthMethodUpdateEmail', function() {
    it('should create an instance of AuthMethodUpdateEmail', function() {
      // uncomment below and update the code to test AuthMethodUpdateEmail
      //var instane = new akeyless.AuthMethodUpdateEmail();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateEmail);
    });
