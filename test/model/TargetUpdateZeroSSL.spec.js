...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateZeroSSL();
  });
  ...
  describe('TargetUpdateZeroSSL', function() {
    it('should create an instance of TargetUpdateZeroSSL', function() {
      // uncomment below and update the code to test TargetUpdateZeroSSL
      //var instane = new akeyless.TargetUpdateZeroSSL();
      //expect(instance).to.be.a(akeyless.TargetUpdateZeroSSL);
    });
