...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerCassandra();
  });
  ...
  describe('GatewayUpdateProducerCassandra', function() {
    it('should create an instance of GatewayUpdateProducerCassandra', function() {
      // uncomment below and update the code to test GatewayUpdateProducerCassandra
      //var instane = new akeyless.GatewayUpdateProducerCassandra();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerCassandra);
    });
