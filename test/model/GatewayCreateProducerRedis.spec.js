...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerRedis();
  });
  ...
  describe('GatewayCreateProducerRedis', function() {
    it('should create an instance of GatewayCreateProducerRedis', function() {
      // uncomment below and update the code to test GatewayCreateProducerRedis
      //var instane = new akeyless.GatewayCreateProducerRedis();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerRedis);
    });
