...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateGodaddy();
  });
  ...
  describe('TargetCreateGodaddy', function() {
    it('should create an instance of TargetCreateGodaddy', function() {
      // uncomment below and update the code to test TargetCreateGodaddy
      //var instane = new akeyless.TargetCreateGodaddy();
      //expect(instance).to.be.a(akeyless.TargetCreateGodaddy);
    });
