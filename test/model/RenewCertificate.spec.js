...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RenewCertificate();
  });
  ...
  describe('RenewCertificate', function() {
    it('should create an instance of RenewCertificate', function() {
      // uncomment below and update the code to test RenewCertificate
      //var instane = new akeyless.RenewCertificate();
      //expect(instance).to.be.a(akeyless.RenewCertificate);
    });
