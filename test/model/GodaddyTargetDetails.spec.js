...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GodaddyTargetDetails();
  });
  ...
  describe('GodaddyTargetDetails', function() {
    it('should create an instance of GodaddyTargetDetails', function() {
      // uncomment below and update the code to test GodaddyTargetDetails
      //var instane = new akeyless.GodaddyTargetDetails();
      //expect(instance).to.be.a(akeyless.GodaddyTargetDetails);
    });
