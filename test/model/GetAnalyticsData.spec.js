...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GetAnalyticsData();
  });
  ...
  describe('GetAnalyticsData', function() {
    it('should create an instance of GetAnalyticsData', function() {
      // uncomment below and update the code to test GetAnalyticsData
      //var instane = new akeyless.GetAnalyticsData();
      //expect(instance).to.be.a(akeyless.GetAnalyticsData);
    });
