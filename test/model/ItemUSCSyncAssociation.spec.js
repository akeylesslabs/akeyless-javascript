...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ItemUSCSyncAssociation();
  });
  ...
  describe('ItemUSCSyncAssociation', function() {
    it('should create an instance of ItemUSCSyncAssociation', function() {
      // uncomment below and update the code to test ItemUSCSyncAssociation
      //var instance = new akeyless.ItemUSCSyncAssociation();
      //expect(instance).to.be.a(akeyless.ItemUSCSyncAssociation);
    });
