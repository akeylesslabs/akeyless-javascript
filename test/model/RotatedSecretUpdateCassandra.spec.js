...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateCassandra();
  });
  ...
  describe('RotatedSecretUpdateCassandra', function() {
    it('should create an instance of RotatedSecretUpdateCassandra', function() {
      // uncomment below and update the code to test RotatedSecretUpdateCassandra
      //var instane = new akeyless.RotatedSecretUpdateCassandra();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateCassandra);
    });
