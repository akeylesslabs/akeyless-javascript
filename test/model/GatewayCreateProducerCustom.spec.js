...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerCustom();
  });
  ...
  describe('GatewayCreateProducerCustom', function() {
    it('should create an instance of GatewayCreateProducerCustom', function() {
      // uncomment below and update the code to test GatewayCreateProducerCustom
      //var instane = new akeyless.GatewayCreateProducerCustom();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerCustom);
    });
