...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateF5BigIp();
  });
  ...
  describe('TargetCreateF5BigIp', function() {
    it('should create an instance of TargetCreateF5BigIp', function() {
      // uncomment below and update the code to test TargetCreateF5BigIp
      //var instance = new akeyless.TargetCreateF5BigIp();
      //expect(instance).to.be.a(akeyless.TargetCreateF5BigIp);
    });
