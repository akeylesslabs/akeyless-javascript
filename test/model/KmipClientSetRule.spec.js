...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.KmipClientSetRule();
  });
  ...
  describe('KmipClientSetRule', function() {
    it('should create an instance of KmipClientSetRule', function() {
      // uncomment below and update the code to test KmipClientSetRule
      //var instane = new akeyless.KmipClientSetRule();
      //expect(instance).to.be.a(akeyless.KmipClientSetRule);
    });
