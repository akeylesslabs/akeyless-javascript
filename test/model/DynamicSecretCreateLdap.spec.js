...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateLdap();
  });
  ...
  describe('DynamicSecretCreateLdap', function() {
    it('should create an instance of DynamicSecretCreateLdap', function() {
      // uncomment below and update the code to test DynamicSecretCreateLdap
      //var instane = new akeyless.DynamicSecretCreateLdap();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateLdap);
    });
