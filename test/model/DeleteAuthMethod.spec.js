...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.DeleteAuthMethod();
  });
  ...
  describe('DeleteAuthMethod', function() {
    it('should create an instance of DeleteAuthMethod', function() {
      // uncomment below and update the code to test DeleteAuthMethod
      //var instane = new akl.DeleteAuthMethod();
      //expect(instance).to.be.a(akl.DeleteAuthMethod);
    });
