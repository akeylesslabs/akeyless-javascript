...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateSnowflake();
  });
  ...
  describe('RotatedSecretUpdateSnowflake', function() {
    it('should create an instance of RotatedSecretUpdateSnowflake', function() {
      // uncomment below and update the code to test RotatedSecretUpdateSnowflake
      //var instane = new akeyless.RotatedSecretUpdateSnowflake();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateSnowflake);
    });
