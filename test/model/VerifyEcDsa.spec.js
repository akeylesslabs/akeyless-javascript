...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.VerifyEcDsa();
  });
  ...
  describe('VerifyEcDsa', function() {
    it('should create an instance of VerifyEcDsa', function() {
      // uncomment below and update the code to test VerifyEcDsa
      //var instane = new akeyless.VerifyEcDsa();
      //expect(instance).to.be.a(akeyless.VerifyEcDsa);
    });
