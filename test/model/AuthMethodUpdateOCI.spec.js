...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateOCI();
  });
  ...
  describe('AuthMethodUpdateOCI', function() {
    it('should create an instance of AuthMethodUpdateOCI', function() {
      // uncomment below and update the code to test AuthMethodUpdateOCI
      //var instane = new akeyless.AuthMethodUpdateOCI();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateOCI);
    });
    ...
    it('should have the property groupOcid (base name: "group-ocid")', function() {
      // uncomment below and update the code to test the property groupOcid
      //var instane = new akeyless.AuthMethodUpdateOCI();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tenantOcid (base name: "tenant-ocid")', function() {
      // uncomment below and update the code to test the property tenantOcid
      //var instane = new akeyless.AuthMethodUpdateOCI();
      //expect(instance).to.be();
    });
