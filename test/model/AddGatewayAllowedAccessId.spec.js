...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AddGatewayAllowedAccessId();
  });
  ...
  describe('AddGatewayAllowedAccessId', function() {
    it('should create an instance of AddGatewayAllowedAccessId', function() {
      // uncomment below and update the code to test AddGatewayAllowedAccessId
      //var instane = new akeyless.AddGatewayAllowedAccessId();
      //expect(instance).to.be.a(akeyless.AddGatewayAllowedAccessId);
    });
