...
(function(root, factory) {
  ...
  describe('UscGet', function() {
    it('should create an instance of UscGet', function() {
      // uncomment below and update the code to test UscGet
      //var instane = new akeyless.UscGet();
      //expect(instance).to.be.a(akeyless.UscGet);
    });
