...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateApiKey();
  });
  ...
  describe('AuthMethodCreateApiKey', function() {
    it('should create an instance of AuthMethodCreateApiKey', function() {
      // uncomment below and update the code to test AuthMethodCreateApiKey
      //var instane = new akeyless.AuthMethodCreateApiKey();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateApiKey);
    });
