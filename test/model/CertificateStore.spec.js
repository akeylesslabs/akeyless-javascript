...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CertificateStore();
  });
  ...
  describe('CertificateStore', function() {
    it('should create an instance of CertificateStore', function() {
      // uncomment below and update the code to test CertificateStore
      //var instance = new akeyless.CertificateStore();
      //expect(instance).to.be.a(akeyless.CertificateStore);
    });
