...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateOkta();
  });
  ...
  describe('TargetCreateOkta', function() {
    it('should create an instance of TargetCreateOkta', function() {
      // uncomment below and update the code to test TargetCreateOkta
      //var instance = new akeyless.TargetCreateOkta();
      //expect(instance).to.be.a(akeyless.TargetCreateOkta);
    });
