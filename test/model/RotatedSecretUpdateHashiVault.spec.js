...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateHashiVault();
  });
  ...
  describe('RotatedSecretUpdateHashiVault', function() {
    it('should create an instance of RotatedSecretUpdateHashiVault', function() {
      // uncomment below and update the code to test RotatedSecretUpdateHashiVault
      //var instance = new akeyless.RotatedSecretUpdateHashiVault();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateHashiVault);
    });
