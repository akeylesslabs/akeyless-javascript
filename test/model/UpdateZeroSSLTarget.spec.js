...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateZeroSSLTarget();
  });
  ...
  describe('UpdateZeroSSLTarget', function() {
    it('should create an instance of UpdateZeroSSLTarget', function() {
      // uncomment below and update the code to test UpdateZeroSSLTarget
      //var instane = new akeyless.UpdateZeroSSLTarget();
      //expect(instance).to.be.a(akeyless.UpdateZeroSSLTarget);
    });
