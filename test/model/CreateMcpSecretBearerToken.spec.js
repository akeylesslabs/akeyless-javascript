...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateMcpSecretBearerToken();
  });
  ...
  describe('CreateMcpSecretBearerToken', function() {
    it('should create an instance of CreateMcpSecretBearerToken', function() {
      // uncomment below and update the code to test CreateMcpSecretBearerToken
      //var instance = new akeyless.CreateMcpSecretBearerToken();
      //expect(instance).to.be.a(akeyless.CreateMcpSecretBearerToken);
    });
