...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateKeycloak();
  });
  ...
  describe('TargetCreateKeycloak', function() {
    it('should create an instance of TargetCreateKeycloak', function() {
      // uncomment below and update the code to test TargetCreateKeycloak
      //var instance = new akeyless.TargetCreateKeycloak();
      //expect(instance).to.be.a(akeyless.TargetCreateKeycloak);
    });
