...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RawCreds();
  });
  ...
  describe('RawCreds', function() {
    it('should create an instance of RawCreds', function() {
      // uncomment below and update the code to test RawCreds
      //var instane = new akeyless.RawCreds();
      //expect(instance).to.be.a(akeyless.RawCreds);
    });
