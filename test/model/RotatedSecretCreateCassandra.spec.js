...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateCassandra();
  });
  ...
  describe('RotatedSecretCreateCassandra', function() {
    it('should create an instance of RotatedSecretCreateCassandra', function() {
      // uncomment below and update the code to test RotatedSecretCreateCassandra
      //var instane = new akeyless.RotatedSecretCreateCassandra();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateCassandra);
    });
