...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretDeleteSync();
  });
  ...
  describe('RotatedSecretDeleteSync', function() {
    it('should create an instance of RotatedSecretDeleteSync', function() {
      // uncomment below and update the code to test RotatedSecretDeleteSync
      //var instance = new akeyless.RotatedSecretDeleteSync();
      //expect(instance).to.be.a(akeyless.RotatedSecretDeleteSync);
    });
