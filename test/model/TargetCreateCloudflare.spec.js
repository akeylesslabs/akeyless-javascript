...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateCloudflare();
  });
  ...
  describe('TargetCreateCloudflare', function() {
    it('should create an instance of TargetCreateCloudflare', function() {
      // uncomment below and update the code to test TargetCreateCloudflare
      //var instance = new akeyless.TargetCreateCloudflare();
      //expect(instance).to.be.a(akeyless.TargetCreateCloudflare);
    });
