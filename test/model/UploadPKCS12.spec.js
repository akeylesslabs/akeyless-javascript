...
(function(root, factory) {
  ...
  describe('UploadPKCS12', function() {
    it('should create an instance of UploadPKCS12', function() {
      // uncomment below and update the code to test UploadPKCS12
      //var instane = new akl.UploadPKCS12();
      //expect(instance).to.be.a(akl.UploadPKCS12);
    });
