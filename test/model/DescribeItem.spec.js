...
(function(root, factory) {
  ...
  describe('DescribeItem', function() {
    it('should create an instance of DescribeItem', function() {
      // uncomment below and update the code to test DescribeItem
      //var instane = new akl.DescribeItem();
      //expect(instance).to.be.a(akl.DescribeItem);
    });
