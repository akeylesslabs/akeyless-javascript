...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsSyslog();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsSyslog', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsSyslog', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsSyslog
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsSyslog();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsSyslog);
    });
    ...
    it('should have the property formatter (base name: "formatter")', function() {
      // uncomment below and update the code to test the property formatter
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsSyslog();
      //expect(instance).to.be();
    });
    ...
    it('should have the property targetTag (base name: "target-tag")', function() {
