...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateF5BigIpTarget();
  });
  ...
  describe('UpdateF5BigIpTarget', function() {
    it('should create an instance of UpdateF5BigIpTarget', function() {
      // uncomment below and update the code to test UpdateF5BigIpTarget
      //var instance = new akeyless.UpdateF5BigIpTarget();
      //expect(instance).to.be.a(akeyless.UpdateF5BigIpTarget);
    });
