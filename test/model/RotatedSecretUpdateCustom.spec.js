...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateCustom();
  });
  ...
  describe('RotatedSecretUpdateCustom', function() {
    it('should create an instance of RotatedSecretUpdateCustom', function() {
      // uncomment below and update the code to test RotatedSecretUpdateCustom
      //var instane = new akeyless.RotatedSecretUpdateCustom();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateCustom);
    });
