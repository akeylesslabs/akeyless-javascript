...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingSyslog();
  });
  ...
  describe('GatewayUpdateLogForwardingSyslog', function() {
    it('should create an instance of GatewayUpdateLogForwardingSyslog', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingSyslog
      //var instane = new akeyless.GatewayUpdateLogForwardingSyslog();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingSyslog);
    });
