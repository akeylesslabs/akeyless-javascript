...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AccountCustomFieldList();
  });
  ...
  describe('AccountCustomFieldList', function() {
    it('should create an instance of AccountCustomFieldList', function() {
      // uncomment below and update the code to test AccountCustomFieldList
      //var instance = new akeyless.AccountCustomFieldList();
      //expect(instance).to.be.a(akeyless.AccountCustomFieldList);
    });
