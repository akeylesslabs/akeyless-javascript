...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateAwsTarget();
  });
  ...
  describe('CreateAwsTarget', function() {
    it('should create an instance of CreateAwsTarget', function() {
      // uncomment below and update the code to test CreateAwsTarget
      //var instane = new akeyless.CreateAwsTarget();
      //expect(instance).to.be.a(akeyless.CreateAwsTarget);
    });
