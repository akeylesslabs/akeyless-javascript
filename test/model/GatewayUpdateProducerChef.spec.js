...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerChef();
  });
  ...
  describe('GatewayUpdateProducerChef', function() {
    it('should create an instance of GatewayUpdateProducerChef', function() {
      // uncomment below and update the code to test GatewayUpdateProducerChef
      //var instane = new akeyless.GatewayUpdateProducerChef();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerChef);
    });
