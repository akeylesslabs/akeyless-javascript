...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateK8SAuthConfigOutput();
  });
  ...
  describe('GatewayUpdateK8SAuthConfigOutput', function() {
    it('should create an instance of GatewayUpdateK8SAuthConfigOutput', function() {
      // uncomment below and update the code to test GatewayUpdateK8SAuthConfigOutput
      //var instane = new akeyless.GatewayUpdateK8SAuthConfigOutput();
      //expect(instance).to.be.a(akeyless.GatewayUpdateK8SAuthConfigOutput);
    });
