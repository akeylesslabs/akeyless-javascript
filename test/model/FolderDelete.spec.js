...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.FolderDelete();
  });
  ...
  describe('FolderDelete', function() {
    it('should create an instance of FolderDelete', function() {
      // uncomment below and update the code to test FolderDelete
      //var instance = new akeyless.FolderDelete();
      //expect(instance).to.be.a(akeyless.FolderDelete);
    });
