...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingLogstash();
  });
  ...
  describe('GatewayUpdateLogForwardingLogstash', function() {
    it('should create an instance of GatewayUpdateLogForwardingLogstash', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingLogstash
      //var instane = new akeyless.GatewayUpdateLogForwardingLogstash();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingLogstash);
    });
