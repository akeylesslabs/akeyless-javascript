...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateWeb();
  });
  ...
  describe('TargetUpdateWeb', function() {
    it('should create an instance of TargetUpdateWeb', function() {
      // uncomment below and update the code to test TargetUpdateWeb
      //var instane = new akeyless.TargetUpdateWeb();
      //expect(instance).to.be.a(akeyless.TargetUpdateWeb);
    });
