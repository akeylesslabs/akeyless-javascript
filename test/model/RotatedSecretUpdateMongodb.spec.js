...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateMongodb();
  });
  ...
  describe('RotatedSecretUpdateMongodb', function() {
    it('should create an instance of RotatedSecretUpdateMongodb', function() {
      // uncomment below and update the code to test RotatedSecretUpdateMongodb
      //var instane = new akeyless.RotatedSecretUpdateMongodb();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateMongodb);
    });
