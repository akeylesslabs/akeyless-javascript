...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateAwsIam();
  });
  ...
  describe('AuthMethodCreateAwsIam', function() {
    it('should create an instance of AuthMethodCreateAwsIam', function() {
      // uncomment below and update the code to test AuthMethodCreateAwsIam
      //var instane = new akeyless.AuthMethodCreateAwsIam();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateAwsIam);
    });
