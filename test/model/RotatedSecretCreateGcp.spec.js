...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateGcp();
  });
  ...
  describe('RotatedSecretCreateGcp', function() {
    it('should create an instance of RotatedSecretCreateGcp', function() {
      // uncomment below and update the code to test RotatedSecretCreateGcp
      //var instane = new akeyless.RotatedSecretCreateGcp();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateGcp);
    });
    ...
    it('should have the property gcpServiceAccountEmail (base name: "gcp-service-account-email")', function() {
      // uncomment below and update the code to test the property gcpServiceAccountEmail
      //var instane = new akeyless.RotatedSecretCreateGcp();
      //expect(instance).to.be();
    });

    it('should have the property gcpServiceAccountKeyId (base name: "gcp-service-account-key-id")', function() {
      // uncomment below and update the code to test the property gcpServiceAccountKeyId
      //var instane = new akeyless.RotatedSecretCreateGcp();
      //expect(instance).to.be();
    });
