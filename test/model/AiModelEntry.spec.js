...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AiModelEntry();
  });
  ...
  describe('AiModelEntry', function() {
    it('should create an instance of AiModelEntry', function() {
      // uncomment below and update the code to test AiModelEntry
      //var instance = new akeyless.AiModelEntry();
      //expect(instance).to.be.a(akeyless.AiModelEntry);
    });
