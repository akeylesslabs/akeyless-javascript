...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateSsh();
  });
  ...
  describe('RotatedSecretUpdateSsh', function() {
    it('should create an instance of RotatedSecretUpdateSsh', function() {
      // uncomment below and update the code to test RotatedSecretUpdateSsh
      //var instane = new akeyless.RotatedSecretUpdateSsh();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateSsh);
    });
