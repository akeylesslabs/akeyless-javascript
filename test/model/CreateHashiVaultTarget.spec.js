...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateHashiVaultTarget();
  });
  ...
  describe('CreateHashiVaultTarget', function() {
    it('should create an instance of CreateHashiVaultTarget', function() {
      // uncomment below and update the code to test CreateHashiVaultTarget
      //var instane = new akeyless.CreateHashiVaultTarget();
      //expect(instance).to.be.a(akeyless.CreateHashiVaultTarget);
    });
