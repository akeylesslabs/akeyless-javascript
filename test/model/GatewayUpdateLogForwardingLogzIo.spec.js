...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingLogzIo();
  });
  ...
  describe('GatewayUpdateLogForwardingLogzIo', function() {
    it('should create an instance of GatewayUpdateLogForwardingLogzIo', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingLogzIo
      //var instane = new akeyless.GatewayUpdateLogForwardingLogzIo();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingLogzIo);
    });
