...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UscUpdate();
  });
  ...
  describe('UscUpdate', function() {
    it('should create an instance of UscUpdate', function() {
      // uncomment below and update the code to test UscUpdate
      //var instane = new akeyless.UscUpdate();
      //expect(instance).to.be.a(akeyless.UscUpdate);
    });
