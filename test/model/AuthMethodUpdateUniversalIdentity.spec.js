...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateUniversalIdentity();
  });
  ...
  describe('AuthMethodUpdateUniversalIdentity', function() {
    it('should create an instance of AuthMethodUpdateUniversalIdentity', function() {
      // uncomment below and update the code to test AuthMethodUpdateUniversalIdentity
      //var instane = new akeyless.AuthMethodUpdateUniversalIdentity();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateUniversalIdentity);
    });
