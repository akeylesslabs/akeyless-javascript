...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateMysql();
  });
  ...
  describe('RotatedSecretUpdateMysql', function() {
    it('should create an instance of RotatedSecretUpdateMysql', function() {
      // uncomment below and update the code to test RotatedSecretUpdateMysql
      //var instane = new akeyless.RotatedSecretUpdateMysql();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateMysql);
    });
