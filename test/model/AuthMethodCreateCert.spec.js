...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateCert();
  });
  ...
  describe('AuthMethodCreateCert', function() {
    it('should create an instance of AuthMethodCreateCert', function() {
      // uncomment below and update the code to test AuthMethodCreateCert
      //var instane = new akeyless.AuthMethodCreateCert();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateCert);
    });
    ...
    it('should have the property allowedCors (base name: "allowed-cors")', function() {
      // uncomment below and update the code to test the property allowedCors
      //var instane = new akeyless.AuthMethodCreateCert();
      //expect(instance).to.be();
    });
