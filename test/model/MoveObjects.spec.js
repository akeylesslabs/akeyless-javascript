...
(function(root, factory) {
  ...
  describe('MoveObjects', function() {
    it('should create an instance of MoveObjects', function() {
      // uncomment below and update the code to test MoveObjects
      //var instane = new akl.MoveObjects();
      //expect(instance).to.be.a(akl.MoveObjects);
    });

    it('should have the property objectsType (base name: "objects-type")', function() {
      // uncomment below and update the code to test the property objectsType
      //var instane = new akl.MoveObjects();
