...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateGemini();
  });
  ...
  describe('TargetCreateGemini', function() {
    it('should create an instance of TargetCreateGemini', function() {
      // uncomment below and update the code to test TargetCreateGemini
      //var instance = new akeyless.TargetCreateGemini();
      //expect(instance).to.be.a(akeyless.TargetCreateGemini);
    });
