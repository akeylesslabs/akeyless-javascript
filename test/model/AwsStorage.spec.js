...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AwsStorage();
  });
  ...
  describe('AwsStorage', function() {
    it('should create an instance of AwsStorage', function() {
      // uncomment below and update the code to test AwsStorage
      //var instane = new akeyless.AwsStorage();
      //expect(instance).to.be.a(akeyless.AwsStorage);
    });
