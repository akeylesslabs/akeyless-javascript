...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateMongodb();
  });
  ...
  describe('RotatedSecretCreateMongodb', function() {
    it('should create an instance of RotatedSecretCreateMongodb', function() {
      // uncomment below and update the code to test RotatedSecretCreateMongodb
      //var instane = new akeyless.RotatedSecretCreateMongodb();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateMongodb);
    });
