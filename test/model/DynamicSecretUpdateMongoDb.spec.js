...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateMongoDb();
  });
  ...
  describe('DynamicSecretUpdateMongoDb', function() {
    it('should create an instance of DynamicSecretUpdateMongoDb', function() {
      // uncomment below and update the code to test DynamicSecretUpdateMongoDb
      //var instane = new akeyless.DynamicSecretUpdateMongoDb();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateMongoDb);
    });
    ...
    it('should have the property mongodbCustomData (base name: "mongodb-custom-data")', function() {
      // uncomment below and update the code to test the property mongodbCustomData
      //var instane = new akeyless.DynamicSecretUpdateMongoDb();
      //expect(instance).to.be();
    });
