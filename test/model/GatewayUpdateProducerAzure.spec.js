...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerAzure();
  });
  ...
  describe('GatewayUpdateProducerAzure', function() {
    it('should create an instance of GatewayUpdateProducerAzure', function() {
      // uncomment below and update the code to test GatewayUpdateProducerAzure
      //var instane = new akeyless.GatewayUpdateProducerAzure();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerAzure);
    });
