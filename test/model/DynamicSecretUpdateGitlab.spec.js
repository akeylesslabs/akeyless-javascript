...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateGitlab();
  });
  ...
  describe('DynamicSecretUpdateGitlab', function() {
    it('should create an instance of DynamicSecretUpdateGitlab', function() {
      // uncomment below and update the code to test DynamicSecretUpdateGitlab
      //var instane = new akeyless.DynamicSecretUpdateGitlab();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateGitlab);
    });
