...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingSumologic();
  });
  ...
  describe('GatewayUpdateLogForwardingSumologic', function() {
    it('should create an instance of GatewayUpdateLogForwardingSumologic', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingSumologic
      //var instane = new akeyless.GatewayUpdateLogForwardingSumologic();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingSumologic);
    });
