...
(function(root, factory) {
  ...
  describe('ClientData', function() {
    it('should create an instance of ClientData', function() {
      ...
      //var instane = new akl.ClientData();
      //expect(instance).to.be.a(akl.ClientData);
    });

    it('should have the property clientCertificateData (base name: "clientCertificateData")', function() {
      // uncomment below and update the code to test the property clientCertificateData
      //var instane = new akl.ClientData();
      //expect(instance).to.be();
    });

    it('should have the property clientKeyData (base name: "clientKeyData")', function() {
