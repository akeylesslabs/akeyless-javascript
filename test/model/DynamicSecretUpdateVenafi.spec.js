...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateVenafi();
  });
  ...
  describe('DynamicSecretUpdateVenafi', function() {
    it('should create an instance of DynamicSecretUpdateVenafi', function() {
      // uncomment below and update the code to test DynamicSecretUpdateVenafi
      //var instane = new akeyless.DynamicSecretUpdateVenafi();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateVenafi);
    });
