...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAuthMethodUniversalIdentity();
  });
  ...
  describe('UpdateAuthMethodUniversalIdentity', function() {
    it('should create an instance of UpdateAuthMethodUniversalIdentity', function() {
      // uncomment below and update the code to test UpdateAuthMethodUniversalIdentity
      //var instane = new akeyless.UpdateAuthMethodUniversalIdentity();
      //expect(instance).to.be.a(akeyless.UpdateAuthMethodUniversalIdentity);
    });
