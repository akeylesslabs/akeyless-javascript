...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateGcpTarget();
  });
  ...
  describe('UpdateGcpTarget', function() {
    it('should create an instance of UpdateGcpTarget', function() {
      // uncomment below and update the code to test UpdateGcpTarget
      //var instane = new akeyless.UpdateGcpTarget();
      //expect(instance).to.be.a(akeyless.UpdateGcpTarget);
    });
