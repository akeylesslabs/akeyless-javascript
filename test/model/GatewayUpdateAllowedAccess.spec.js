...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateAllowedAccess();
  });
  ...
  describe('GatewayUpdateAllowedAccess', function() {
    it('should create an instance of GatewayUpdateAllowedAccess', function() {
      // uncomment below and update the code to test GatewayUpdateAllowedAccess
      //var instane = new akeyless.GatewayUpdateAllowedAccess();
      //expect(instance).to.be.a(akeyless.GatewayUpdateAllowedAccess);
    });
