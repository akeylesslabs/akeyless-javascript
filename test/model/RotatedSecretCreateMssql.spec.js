...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateMssql();
  });
  ...
  describe('RotatedSecretCreateMssql', function() {
    it('should create an instance of RotatedSecretCreateMssql', function() {
      // uncomment below and update the code to test RotatedSecretCreateMssql
      //var instane = new akeyless.RotatedSecretCreateMssql();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateMssql);
    });
