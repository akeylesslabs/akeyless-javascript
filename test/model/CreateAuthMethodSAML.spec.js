...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.CreateAuthMethodSAML();
  });
  ...
  describe('CreateAuthMethodSAML', function() {
    it('should create an instance of CreateAuthMethodSAML', function() {
      // uncomment below and update the code to test CreateAuthMethodSAML
      //var instane = new akl.CreateAuthMethodSAML();
      //expect(instance).to.be.a(akl.CreateAuthMethodSAML);
    });
