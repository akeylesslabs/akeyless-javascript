...
(function(root, factory) {
  ...
  describe('SraInfo', function() {
    it('should create an instance of SraInfo', function() {
      // uncomment below and update the code to test SraInfo
      //var instane = new akeyless.SraInfo();
      //expect(instance).to.be.a(akeyless.SraInfo);
    });
