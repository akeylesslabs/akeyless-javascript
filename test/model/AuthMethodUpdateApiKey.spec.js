...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateApiKey();
  });
  ...
  describe('AuthMethodUpdateApiKey', function() {
    it('should create an instance of AuthMethodUpdateApiKey', function() {
      // uncomment below and update the code to test AuthMethodUpdateApiKey
      //var instane = new akeyless.AuthMethodUpdateApiKey();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateApiKey);
    });
