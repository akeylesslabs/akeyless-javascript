...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAuthMethodSAML();
  });
  ...
  describe('UpdateAuthMethodSAML', function() {
    it('should create an instance of UpdateAuthMethodSAML', function() {
      // uncomment below and update the code to test UpdateAuthMethodSAML
      //var instane = new akeyless.UpdateAuthMethodSAML();
      //expect(instance).to.be.a(akeyless.UpdateAuthMethodSAML);
    });
