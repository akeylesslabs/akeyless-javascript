...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateHashiVault();
  });
  ...
  describe('TargetCreateHashiVault', function() {
    it('should create an instance of TargetCreateHashiVault', function() {
      // uncomment below and update the code to test TargetCreateHashiVault
      //var instane = new akeyless.TargetCreateHashiVault();
      //expect(instance).to.be.a(akeyless.TargetCreateHashiVault);
    });
