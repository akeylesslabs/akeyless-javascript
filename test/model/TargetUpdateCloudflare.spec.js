...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateCloudflare();
  });
  ...
  describe('TargetUpdateCloudflare', function() {
    it('should create an instance of TargetUpdateCloudflare', function() {
      // uncomment below and update the code to test TargetUpdateCloudflare
      //var instance = new akeyless.TargetUpdateCloudflare();
      //expect(instance).to.be.a(akeyless.TargetUpdateCloudflare);
    });

    it('should have the property accountId (base name: "account-id")', function() {
      // uncomment below and update the code to test the property accountId
      //var instance = new akeyless.TargetUpdateCloudflare();
      //expect(instance).to.be();
    });

    it('should have the property apiToken (base name: "api-token")', function() {
