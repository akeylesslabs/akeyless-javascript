...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.EncryptGPG();
  });
  ...
  describe('EncryptGPG', function() {
    it('should create an instance of EncryptGPG', function() {
      // uncomment below and update the code to test EncryptGPG
      //var instane = new akeyless.EncryptGPG();
      //expect(instance).to.be.a(akeyless.EncryptGPG);
    });
