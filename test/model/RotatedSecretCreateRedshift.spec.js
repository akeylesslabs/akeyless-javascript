...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateRedshift();
  });
  ...
  describe('RotatedSecretCreateRedshift', function() {
    it('should create an instance of RotatedSecretCreateRedshift', function() {
      // uncomment below and update the code to test RotatedSecretCreateRedshift
      //var instane = new akeyless.RotatedSecretCreateRedshift();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateRedshift);
    });
