...
(function(root, factory) {
  ...
  describe('Unconfigure', function() {
    it('should create an instance of Unconfigure', function() {
      // uncomment below and update the code to test Unconfigure
      //var instane = new akl.Unconfigure();
      //expect(instance).to.be.a(akl.Unconfigure);
    });
