...
(function(root, factory) {
  ...
  describe('DeleteRoles', function() {
    it('should create an instance of DeleteRoles', function() {
      // uncomment below and update the code to test DeleteRoles
      //var instane = new akl.DeleteRoles();
      //expect(instance).to.be.a(akl.DeleteRoles);
    });
