...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.SignEcDsa();
  });
  ...
  describe('SignEcDsa', function() {
    it('should create an instance of SignEcDsa', function() {
      // uncomment below and update the code to test SignEcDsa
      //var instane = new akeyless.SignEcDsa();
      //expect(instance).to.be.a(akeyless.SignEcDsa);
    });
