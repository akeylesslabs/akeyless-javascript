...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateOidcApp();
  });
  ...
  describe('CreateOidcApp', function() {
    it('should create an instance of CreateOidcApp', function() {
      // uncomment below and update the code to test CreateOidcApp
      //var instane = new akeyless.CreateOidcApp();
      //expect(instance).to.be.a(akeyless.CreateOidcApp);
    });
