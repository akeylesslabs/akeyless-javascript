...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateOpenAI();
  });
  ...
  describe('DynamicSecretUpdateOpenAI', function() {
    it('should create an instance of DynamicSecretUpdateOpenAI', function() {
      // uncomment below and update the code to test DynamicSecretUpdateOpenAI
      //var instance = new akeyless.DynamicSecretUpdateOpenAI();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateOpenAI);
    });
