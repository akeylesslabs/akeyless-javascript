...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AccountCustomFieldCreate();
  });
  ...
  describe('AccountCustomFieldCreate', function() {
    it('should create an instance of AccountCustomFieldCreate', function() {
      // uncomment below and update the code to test AccountCustomFieldCreate
      //var instance = new akeyless.AccountCustomFieldCreate();
      //expect(instance).to.be.a(akeyless.AccountCustomFieldCreate);
    });
    ...
    it('should have the property objectType (base name: "object-type")', function() {
