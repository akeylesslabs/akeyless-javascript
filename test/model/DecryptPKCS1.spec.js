...
(function(root, factory) {
  ...
  describe('DecryptPKCS1', function() {
    it('should create an instance of DecryptPKCS1', function() {
      // uncomment below and update the code to test DecryptPKCS1
      //var instane = new akl.DecryptPKCS1();
      //expect(instance).to.be.a(akl.DecryptPKCS1);
    });
