...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerSnowflake();
  });
  ...
  describe('GatewayCreateProducerSnowflake', function() {
    it('should create an instance of GatewayCreateProducerSnowflake', function() {
      // uncomment below and update the code to test GatewayCreateProducerSnowflake
      //var instane = new akeyless.GatewayCreateProducerSnowflake();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerSnowflake);
    });
