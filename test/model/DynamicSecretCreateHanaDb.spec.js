...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateHanaDb();
  });
  ...
  describe('DynamicSecretCreateHanaDb', function() {
    it('should create an instance of DynamicSecretCreateHanaDb', function() {
      // uncomment below and update the code to test DynamicSecretCreateHanaDb
      //var instane = new akeyless.DynamicSecretCreateHanaDb();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateHanaDb);
    });
