...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CertificateDiscovery();
  });
  ...
  describe('CertificateDiscovery', function() {
    it('should create an instance of CertificateDiscovery', function() {
      // uncomment below and update the code to test CertificateDiscovery
      //var instance = new akeyless.CertificateDiscovery();
      //expect(instance).to.be.a(akeyless.CertificateDiscovery);
    });
    ...
    it('should have the property portRanges (base name: "port-ranges")', function() {
