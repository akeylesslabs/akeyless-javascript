...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateAuthMethodOIDC();
  });
  ...
  describe('CreateAuthMethodOIDC', function() {
    it('should create an instance of CreateAuthMethodOIDC', function() {
      // uncomment below and update the code to test CreateAuthMethodOIDC
      //var instane = new akeyless.CreateAuthMethodOIDC();
      //expect(instance).to.be.a(akeyless.CreateAuthMethodOIDC);
    });
