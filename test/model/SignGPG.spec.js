...
(function(root, factory) {
  ...
  describe('SignGPG', function() {
    it('should create an instance of SignGPG', function() {
      // uncomment below and update the code to test SignGPG
      //var instane = new akeyless.SignGPG();
      //expect(instance).to.be.a(akeyless.SignGPG);
    });
