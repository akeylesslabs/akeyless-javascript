...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateManagedKey();
  });
  ...
  describe('UpdateManagedKey', function() {
    it('should create an instance of UpdateManagedKey', function() {
      // uncomment below and update the code to test UpdateManagedKey
      //var instane = new akeyless.UpdateManagedKey();
      //expect(instance).to.be.a(akeyless.UpdateManagedKey);
    });
    ...
    it('should have the property updateUrl (base name: "update-url")', function() {
      // uncomment below and update the code to test the property updateUrl
      //var instane = new akeyless.UpdateManagedKey();
      //expect(instance).to.be();
    });
