...
(function(root, factory) {
  ...
  describe('UpdateOutput', function() {
    it('should create an instance of UpdateOutput', function() {
      // uncomment below and update the code to test UpdateOutput
      //var instane = new akl.UpdateOutput();
      //expect(instance).to.be.a(akl.UpdateOutput);
    });
