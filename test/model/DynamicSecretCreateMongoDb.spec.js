...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateMongoDb();
  });
  ...
  describe('DynamicSecretCreateMongoDb', function() {
    it('should create an instance of DynamicSecretCreateMongoDb', function() {
      // uncomment below and update the code to test DynamicSecretCreateMongoDb
      //var instane = new akeyless.DynamicSecretCreateMongoDb();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateMongoDb);
    });
