...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.GetPKICertificate();
  });
  ...
  describe('GetPKICertificate', function() {
    it('should create an instance of GetPKICertificate', function() {
      // uncomment below and update the code to test GetPKICertificate
      //var instane = new akl.GetPKICertificate();
      //expect(instance).to.be.a(akl.GetPKICertificate);
    });
