...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UscCreate();
  });
  ...
  describe('UscCreate', function() {
    it('should create an instance of UscCreate', function() {
      // uncomment below and update the code to test UscCreate
      //var instane = new akeyless.UscCreate();
      //expect(instance).to.be.a(akeyless.UscCreate);
    });
