...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreatePostgreSql();
  });
  ...
  describe('DynamicSecretCreatePostgreSql', function() {
    it('should create an instance of DynamicSecretCreatePostgreSql', function() {
      // uncomment below and update the code to test DynamicSecretCreatePostgreSql
      //var instane = new akeyless.DynamicSecretCreatePostgreSql();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreatePostgreSql);
    });
