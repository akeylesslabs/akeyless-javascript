...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateOIDC();
  });
  ...
  describe('AuthMethodCreateOIDC', function() {
    it('should create an instance of AuthMethodCreateOIDC', function() {
      // uncomment below and update the code to test AuthMethodCreateOIDC
      //var instane = new akeyless.AuthMethodCreateOIDC();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateOIDC);
    });
    ...
    it('should have the property requiredScopes (base name: "required-scopes")', function() {
      // uncomment below and update the code to test the property requiredScopes
      //var instane = new akeyless.AuthMethodCreateOIDC();
      //expect(instance).to.be();
    });

    it('should have the property requiredScopesPrefix (base name: "required-scopes-prefix")', function() {
      // uncomment below and update the code to test the property requiredScopesPrefix
      //var instane = new akeyless.AuthMethodCreateOIDC();
      //expect(instance).to.be();
    });
