...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateK8SAuthConfigOutput();
  });
  ...
  describe('GatewayCreateK8SAuthConfigOutput', function() {
    it('should create an instance of GatewayCreateK8SAuthConfigOutput', function() {
      // uncomment below and update the code to test GatewayCreateK8SAuthConfigOutput
      //var instane = new akeyless.GatewayCreateK8SAuthConfigOutput();
      //expect(instance).to.be.a(akeyless.GatewayCreateK8SAuthConfigOutput);
    });
