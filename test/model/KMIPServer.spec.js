...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.KMIPServer();
  });
  ...
  describe('KMIPServer', function() {
    it('should create an instance of KMIPServer', function() {
      // uncomment below and update the code to test KMIPServer
      //var instane = new akeyless.KMIPServer();
      //expect(instance).to.be.a(akeyless.KMIPServer);
    });
