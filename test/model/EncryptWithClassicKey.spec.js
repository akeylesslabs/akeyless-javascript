...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.EncryptWithClassicKey();
  });
  ...
  describe('EncryptWithClassicKey', function() {
    it('should create an instance of EncryptWithClassicKey', function() {
      // uncomment below and update the code to test EncryptWithClassicKey
      //var instane = new akeyless.EncryptWithClassicKey();
      //expect(instance).to.be.a(akeyless.EncryptWithClassicKey);
    });
