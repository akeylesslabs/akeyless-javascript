...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateAzure();
  });
  ...
  describe('TargetCreateAzure', function() {
    it('should create an instance of TargetCreateAzure', function() {
      // uncomment below and update the code to test TargetCreateAzure
      //var instane = new akeyless.TargetCreateAzure();
      //expect(instance).to.be.a(akeyless.TargetCreateAzure);
    });
