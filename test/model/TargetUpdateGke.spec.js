...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGke();
  });
  ...
  describe('TargetUpdateGke', function() {
    it('should create an instance of TargetUpdateGke', function() {
      // uncomment below and update the code to test TargetUpdateGke
      //var instane = new akeyless.TargetUpdateGke();
      //expect(instance).to.be.a(akeyless.TargetUpdateGke);
    });
