...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateAzure();
  });
  ...
  describe('RotatedSecretCreateAzure', function() {
    it('should create an instance of RotatedSecretCreateAzure', function() {
      // uncomment below and update the code to test RotatedSecretCreateAzure
      //var instane = new akeyless.RotatedSecretCreateAzure();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateAzure);
    });
    ...
    it('should have the property applicationId (base name: "application-id")', function() {
    ...
    it('should have the property storageAccountKeyName (base name: "storage-account-key-name")', function() {
      // uncomment below and update the code to test the property storageAccountKeyName
      //var instane = new akeyless.RotatedSecretCreateAzure();
      //expect(instance).to.be();
    });
