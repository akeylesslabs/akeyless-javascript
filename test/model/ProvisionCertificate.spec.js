...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ProvisionCertificate();
  });
  ...
  describe('ProvisionCertificate', function() {
    it('should create an instance of ProvisionCertificate', function() {
      // uncomment below and update the code to test ProvisionCertificate
      //var instane = new akeyless.ProvisionCertificate();
      //expect(instance).to.be.a(akeyless.ProvisionCertificate);
    });
