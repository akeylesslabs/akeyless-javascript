...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateGodaddyTarget();
  });
  ...
  describe('CreateGodaddyTarget', function() {
    it('should create an instance of CreateGodaddyTarget', function() {
      // uncomment below and update the code to test CreateGodaddyTarget
      //var instane = new akeyless.CreateGodaddyTarget();
      //expect(instance).to.be.a(akeyless.CreateGodaddyTarget);
    });
