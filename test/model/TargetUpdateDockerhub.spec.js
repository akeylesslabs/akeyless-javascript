...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateDockerhub();
  });
  ...
  describe('TargetUpdateDockerhub', function() {
    it('should create an instance of TargetUpdateDockerhub', function() {
      // uncomment below and update the code to test TargetUpdateDockerhub
      //var instane = new akeyless.TargetUpdateDockerhub();
      //expect(instance).to.be.a(akeyless.TargetUpdateDockerhub);
    });
