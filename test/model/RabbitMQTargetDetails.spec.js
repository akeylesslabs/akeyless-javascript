...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RabbitMQTargetDetails();
  });
  ...
  describe('RabbitMQTargetDetails', function() {
    it('should create an instance of RabbitMQTargetDetails', function() {
      // uncomment below and update the code to test RabbitMQTargetDetails
      //var instane = new akeyless.RabbitMQTargetDetails();
      //expect(instance).to.be.a(akeyless.RabbitMQTargetDetails);
    });
