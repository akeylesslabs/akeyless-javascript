...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateAws();
  });
  ...
  describe('RotatedSecretCreateAws', function() {
    it('should create an instance of RotatedSecretCreateAws', function() {
      // uncomment below and update the code to test RotatedSecretCreateAws
      //var instane = new akeyless.RotatedSecretCreateAws();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateAws);
    });
    ...
    it('should have the property graceRotation (base name: "grace-rotation")', function() {
      // uncomment below and update the code to test the property graceRotation
      //var instane = new akeyless.RotatedSecretCreateAws();
      //expect(instance).to.be();
    });
