...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateHanaDb();
  });
  ...
  describe('DynamicSecretUpdateHanaDb', function() {
    it('should create an instance of DynamicSecretUpdateHanaDb', function() {
      // uncomment below and update the code to test DynamicSecretUpdateHanaDb
      //var instane = new akeyless.DynamicSecretUpdateHanaDb();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateHanaDb);
    });
