...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DeleteTarget();
  });
  ...
  describe('DeleteTarget', function() {
    it('should create an instance of DeleteTarget', function() {
      // uncomment below and update the code to test DeleteTarget
      //var instane = new akeyless.DeleteTarget();
      //expect(instance).to.be.a(akeyless.DeleteTarget);
    });
