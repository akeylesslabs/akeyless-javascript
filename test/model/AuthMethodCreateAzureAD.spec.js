...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateAzureAD();
  });
  ...
  describe('AuthMethodCreateAzureAD', function() {
    it('should create an instance of AuthMethodCreateAzureAD', function() {
      // uncomment below and update the code to test AuthMethodCreateAzureAD
      //var instane = new akeyless.AuthMethodCreateAzureAD();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateAzureAD);
    });
