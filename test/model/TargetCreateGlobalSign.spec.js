...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateGlobalSign();
  });
  ...
  describe('TargetCreateGlobalSign', function() {
    it('should create an instance of TargetCreateGlobalSign', function() {
      // uncomment below and update the code to test TargetCreateGlobalSign
      //var instane = new akeyless.TargetCreateGlobalSign();
      //expect(instance).to.be.a(akeyless.TargetCreateGlobalSign);
    });
