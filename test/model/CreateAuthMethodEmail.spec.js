...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateAuthMethodEmail();
  });
  ...
  describe('CreateAuthMethodEmail', function() {
    it('should create an instance of CreateAuthMethodEmail', function() {
      // uncomment below and update the code to test CreateAuthMethodEmail
      //var instane = new akeyless.CreateAuthMethodEmail();
      //expect(instance).to.be.a(akeyless.CreateAuthMethodEmail);
    });
