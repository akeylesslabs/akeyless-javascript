...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateWindowsTarget();
  });
  ...
  describe('UpdateWindowsTarget', function() {
    it('should create an instance of UpdateWindowsTarget', function() {
      // uncomment below and update the code to test UpdateWindowsTarget
      //var instane = new akeyless.UpdateWindowsTarget();
      //expect(instance).to.be.a(akeyless.UpdateWindowsTarget);
    });
    ...
    it('should have the property rdpPort (base name: "rdp-port")', function() {
      // uncomment below and update the code to test the property rdpPort
      //var instane = new akeyless.UpdateWindowsTarget();
      //expect(instance).to.be();
    });
