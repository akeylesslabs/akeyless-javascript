...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateAliCloud();
  });
  ...
  describe('AuthMethodUpdateAliCloud', function() {
    it('should create an instance of AuthMethodUpdateAliCloud', function() {
      // uncomment below and update the code to test AuthMethodUpdateAliCloud
      //var instance = new akeyless.AuthMethodUpdateAliCloud();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateAliCloud);
    });
