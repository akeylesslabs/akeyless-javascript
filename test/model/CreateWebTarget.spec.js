...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateWebTarget();
  });
  ...
  describe('CreateWebTarget', function() {
    it('should create an instance of CreateWebTarget', function() {
      // uncomment below and update the code to test CreateWebTarget
      //var instane = new akeyless.CreateWebTarget();
      //expect(instance).to.be.a(akeyless.CreateWebTarget);
    });
