...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateSplunk();
  });
  ...
  describe('RotatedSecretCreateSplunk', function() {
    it('should create an instance of RotatedSecretCreateSplunk', function() {
      // uncomment below and update the code to test RotatedSecretCreateSplunk
      //var instance = new akeyless.RotatedSecretCreateSplunk();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateSplunk);
    });
    ...
    it('should have the property expirationDate (base name: "expiration-date")', function() {
      // uncomment below and update the code to test the property expirationDate
      //var instance = new akeyless.RotatedSecretCreateSplunk();
      //expect(instance).to.be();
    });

    it('should have the property hecToken (base name: "hec-token")', function() {
      // uncomment below and update the code to test the property hecToken
      //var instance = new akeyless.RotatedSecretCreateSplunk();
      //expect(instance).to.be();
    });

    it('should have the property hecTokenName (base name: "hec-token-name")', function() {
      // uncomment below and update the code to test the property hecTokenName
      //var instance = new akeyless.RotatedSecretCreateSplunk();
      //expect(instance).to.be();
    });
    ...
    it('should have the property splunkToken (base name: "splunk-token")', function() {
