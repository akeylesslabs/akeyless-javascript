...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingGoogleChronicle();
  });
  ...
  describe('GatewayUpdateLogForwardingGoogleChronicle', function() {
    it('should create an instance of GatewayUpdateLogForwardingGoogleChronicle', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingGoogleChronicle
      //var instane = new akeyless.GatewayUpdateLogForwardingGoogleChronicle();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingGoogleChronicle);
    });
