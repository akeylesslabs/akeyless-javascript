...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.EventAction();
  });
  ...
  describe('EventAction', function() {
    it('should create an instance of EventAction', function() {
      ...
      //var instane = new akeyless.EventAction();
      //expect(instance).to.be.a(akeyless.EventAction);
    });
    ...
    it('should have the property eventId (base name: "event-id")', function() {
