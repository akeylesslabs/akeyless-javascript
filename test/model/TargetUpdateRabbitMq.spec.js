...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateRabbitMq();
  });
  ...
  describe('TargetUpdateRabbitMq', function() {
    it('should create an instance of TargetUpdateRabbitMq', function() {
      // uncomment below and update the code to test TargetUpdateRabbitMq
      //var instane = new akeyless.TargetUpdateRabbitMq();
      //expect(instance).to.be.a(akeyless.TargetUpdateRabbitMq);
    });
