...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AiInsightsConfigPart();
  });
  ...
  describe('AiInsightsConfigPart', function() {
    it('should create an instance of AiInsightsConfigPart', function() {
      // uncomment below and update the code to test AiInsightsConfigPart
      //var instance = new akeyless.AiInsightsConfigPart();
      //expect(instance).to.be.a(akeyless.AiInsightsConfigPart);
    });
