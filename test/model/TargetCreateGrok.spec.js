...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateGrok();
  });
  ...
  describe('TargetCreateGrok', function() {
    it('should create an instance of TargetCreateGrok', function() {
      // uncomment below and update the code to test TargetCreateGrok
      //var instance = new akeyless.TargetCreateGrok();
      //expect(instance).to.be.a(akeyless.TargetCreateGrok);
    });
