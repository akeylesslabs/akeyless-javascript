...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateRabbitMQTarget();
  });
  ...
  describe('UpdateRabbitMQTarget', function() {
    it('should create an instance of UpdateRabbitMQTarget', function() {
      // uncomment below and update the code to test UpdateRabbitMQTarget
      //var instane = new akeyless.UpdateRabbitMQTarget();
      //expect(instance).to.be.a(akeyless.UpdateRabbitMQTarget);
    });
    ...
    it('should have the property rabbitmqServerPassword (base name: "rabbitmq-server-password")', function() {
    ...
    it('should have the property rabbitmqServerUser (base name: "rabbitmq-server-user")', function() {
