...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateSSHTarget();
  });
  ...
  describe('CreateSSHTarget', function() {
    it('should create an instance of CreateSSHTarget', function() {
      // uncomment below and update the code to test CreateSSHTarget
      //var instane = new akeyless.CreateSSHTarget();
      //expect(instance).to.be.a(akeyless.CreateSSHTarget);
    });
