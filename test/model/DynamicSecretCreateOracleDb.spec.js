...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateOracleDb();
  });
  ...
  describe('DynamicSecretCreateOracleDb', function() {
    it('should create an instance of DynamicSecretCreateOracleDb', function() {
      // uncomment below and update the code to test DynamicSecretCreateOracleDb
      //var instane = new akeyless.DynamicSecretCreateOracleDb();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateOracleDb);
    });
