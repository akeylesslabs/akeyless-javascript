...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateAzure();
  });
  ...
  describe('RotatedSecretUpdateAzure', function() {
    it('should create an instance of RotatedSecretUpdateAzure', function() {
      // uncomment below and update the code to test RotatedSecretUpdateAzure
      //var instane = new akeyless.RotatedSecretUpdateAzure();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateAzure);
    });
