...
(function(root, factory) {
  ...
  describe('K8SAuth', function() {
    it('should create an instance of K8SAuth', function() {
      // uncomment below and update the code to test K8SAuth
      //var instane = new akeyless.K8SAuth();
      //expect(instance).to.be.a(akeyless.K8SAuth);
    });
