...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.SecretSyncOutput();
  });
  ...
  describe('SecretSyncOutput', function() {
    it('should create an instance of SecretSyncOutput', function() {
      // uncomment below and update the code to test SecretSyncOutput
      //var instance = new akeyless.SecretSyncOutput();
      //expect(instance).to.be.a(akeyless.SecretSyncOutput);
    });
