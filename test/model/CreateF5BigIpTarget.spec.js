...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateF5BigIpTarget();
  });
  ...
  describe('CreateF5BigIpTarget', function() {
    it('should create an instance of CreateF5BigIpTarget', function() {
      // uncomment below and update the code to test CreateF5BigIpTarget
      //var instance = new akeyless.CreateF5BigIpTarget();
      //expect(instance).to.be.a(akeyless.CreateF5BigIpTarget);
    });
