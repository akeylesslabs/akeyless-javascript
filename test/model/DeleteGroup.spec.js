...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DeleteGroup();
  });
  ...
  describe('DeleteGroup', function() {
    it('should create an instance of DeleteGroup', function() {
      // uncomment below and update the code to test DeleteGroup
      //var instane = new akeyless.DeleteGroup();
      //expect(instance).to.be.a(akeyless.DeleteGroup);
    });
