...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RuleAssigner();
  });
  ...
  describe('RuleAssigner', function() {
    it('should create an instance of RuleAssigner', function() {
      // uncomment below and update the code to test RuleAssigner
      //var instane = new akeyless.RuleAssigner();
      //expect(instance).to.be.a(akeyless.RuleAssigner);
    });
