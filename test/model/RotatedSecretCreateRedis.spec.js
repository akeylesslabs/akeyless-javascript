...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateRedis();
  });
  ...
  describe('RotatedSecretCreateRedis', function() {
    it('should create an instance of RotatedSecretCreateRedis', function() {
      // uncomment below and update the code to test RotatedSecretCreateRedis
      //var instane = new akeyless.RotatedSecretCreateRedis();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateRedis);
    });
