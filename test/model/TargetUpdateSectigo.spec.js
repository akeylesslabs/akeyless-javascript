...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateSectigo();
  });
  ...
  describe('TargetUpdateSectigo', function() {
    it('should create an instance of TargetUpdateSectigo', function() {
      // uncomment below and update the code to test TargetUpdateSectigo
      //var instane = new akeyless.TargetUpdateSectigo();
      //expect(instance).to.be.a(akeyless.TargetUpdateSectigo);
    });
