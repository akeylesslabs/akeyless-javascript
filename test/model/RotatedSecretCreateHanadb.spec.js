...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateHanadb();
  });
  ...
  describe('RotatedSecretCreateHanadb', function() {
    it('should create an instance of RotatedSecretCreateHanadb', function() {
      // uncomment below and update the code to test RotatedSecretCreateHanadb
      //var instane = new akeyless.RotatedSecretCreateHanadb();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateHanadb);
    });
