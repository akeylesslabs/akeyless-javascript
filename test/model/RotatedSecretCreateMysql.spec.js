...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateMysql();
  });
  ...
  describe('RotatedSecretCreateMysql', function() {
    it('should create an instance of RotatedSecretCreateMysql', function() {
      // uncomment below and update the code to test RotatedSecretCreateMysql
      //var instane = new akeyless.RotatedSecretCreateMysql();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateMysql);
    });
