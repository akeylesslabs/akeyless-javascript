...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.OIDCAccessRules();
  });
  ...
  describe('OIDCAccessRules', function() {
    it('should create an instance of OIDCAccessRules', function() {
      // uncomment below and update the code to test OIDCAccessRules
      //var instane = new akeyless.OIDCAccessRules();
      //expect(instance).to.be.a(akeyless.OIDCAccessRules);
    });
