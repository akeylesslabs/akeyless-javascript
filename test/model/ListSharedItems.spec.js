...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ListSharedItems();
  });
  ...
  describe('ListSharedItems', function() {
    it('should create an instance of ListSharedItems', function() {
      // uncomment below and update the code to test ListSharedItems
      //var instane = new akeyless.ListSharedItems();
      //expect(instance).to.be.a(akeyless.ListSharedItems);
    });
