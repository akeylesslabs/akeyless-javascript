...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateSSHTarget();
  });
  ...
  describe('UpdateSSHTarget', function() {
    it('should create an instance of UpdateSSHTarget', function() {
      // uncomment below and update the code to test UpdateSSHTarget
      //var instane = new akeyless.UpdateSSHTarget();
      //expect(instance).to.be.a(akeyless.UpdateSSHTarget);
    });
