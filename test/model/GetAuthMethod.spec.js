...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.GetAuthMethod();
  });
  ...
  describe('GetAuthMethod', function() {
    it('should create an instance of GetAuthMethod', function() {
      // uncomment below and update the code to test GetAuthMethod
      //var instane = new akl.GetAuthMethod();
      //expect(instance).to.be.a(akl.GetAuthMethod);
    });
