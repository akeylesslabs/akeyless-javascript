...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingAwsS3();
  });
  ...
  describe('GatewayUpdateLogForwardingAwsS3', function() {
    it('should create an instance of GatewayUpdateLogForwardingAwsS3', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingAwsS3
      //var instane = new akeyless.GatewayUpdateLogForwardingAwsS3();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingAwsS3);
    });
