...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAzureTarget();
  });
  ...
  describe('UpdateAzureTarget', function() {
    it('should create an instance of UpdateAzureTarget', function() {
      // uncomment below and update the code to test UpdateAzureTarget
      //var instane = new akeyless.UpdateAzureTarget();
      //expect(instance).to.be.a(akeyless.UpdateAzureTarget);
    });
