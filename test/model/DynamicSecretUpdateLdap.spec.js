...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateLdap();
  });
  ...
  describe('DynamicSecretUpdateLdap', function() {
    it('should create an instance of DynamicSecretUpdateLdap', function() {
      // uncomment below and update the code to test DynamicSecretUpdateLdap
      //var instane = new akeyless.DynamicSecretUpdateLdap();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateLdap);
    });
