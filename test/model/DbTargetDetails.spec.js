...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DbTargetDetails();
  });
  ...
  describe('DbTargetDetails', function() {
    it('should create an instance of DbTargetDetails', function() {
      // uncomment below and update the code to test DbTargetDetails
      //var instane = new akeyless.DbTargetDetails();
      //expect(instance).to.be.a(akeyless.DbTargetDetails);
    });
