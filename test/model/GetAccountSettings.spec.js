...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GetAccountSettings();
  });
  ...
  describe('GetAccountSettings', function() {
    it('should create an instance of GetAccountSettings', function() {
      // uncomment below and update the code to test GetAccountSettings
      //var instane = new akeyless.GetAccountSettings();
      //expect(instance).to.be.a(akeyless.GetAccountSettings);
    });
