...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateOracledb();
  });
  ...
  describe('RotatedSecretUpdateOracledb', function() {
    it('should create an instance of RotatedSecretUpdateOracledb', function() {
      // uncomment below and update the code to test RotatedSecretUpdateOracledb
      //var instane = new akeyless.RotatedSecretUpdateOracledb();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateOracledb);
    });
