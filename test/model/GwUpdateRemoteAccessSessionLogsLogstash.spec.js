...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsLogstash();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsLogstash', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsLogstash', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsLogstash
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsLogstash();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsLogstash);
    });
