...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateArtifactory();
  });
  ...
  describe('TargetUpdateArtifactory', function() {
    it('should create an instance of TargetUpdateArtifactory', function() {
      // uncomment below and update the code to test TargetUpdateArtifactory
      //var instane = new akeyless.TargetUpdateArtifactory();
      //expect(instance).to.be.a(akeyless.TargetUpdateArtifactory);
    });
