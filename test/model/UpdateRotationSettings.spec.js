...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateRotationSettings();
  });
  ...
  describe('UpdateRotationSettings', function() {
    it('should create an instance of UpdateRotationSettings', function() {
      // uncomment below and update the code to test UpdateRotationSettings
      //var instane = new akeyless.UpdateRotationSettings();
      //expect(instance).to.be.a(akeyless.UpdateRotationSettings);
    });
