...
(function(root, factory) {
  ...
  describe('EncryptPKCS1', function() {
    it('should create an instance of EncryptPKCS1', function() {
      // uncomment below and update the code to test EncryptPKCS1
      //var instane = new akl.EncryptPKCS1();
      //expect(instance).to.be.a(akl.EncryptPKCS1);
    });
