...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretSync();
  });
  ...
  describe('RotatedSecretSync', function() {
    it('should create an instance of RotatedSecretSync', function() {
      // uncomment below and update the code to test RotatedSecretSync
      //var instance = new akeyless.RotatedSecretSync();
      //expect(instance).to.be.a(akeyless.RotatedSecretSync);
    });
