...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RequestAccess();
  });
  ...
  describe('RequestAccess', function() {
    it('should create an instance of RequestAccess', function() {
      // uncomment below and update the code to test RequestAccess
      //var instane = new akeyless.RequestAccess();
      //expect(instance).to.be.a(akeyless.RequestAccess);
    });
