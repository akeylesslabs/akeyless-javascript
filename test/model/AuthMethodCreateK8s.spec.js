...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateK8s();
  });
  ...
  describe('AuthMethodCreateK8s', function() {
    it('should create an instance of AuthMethodCreateK8s', function() {
      // uncomment below and update the code to test AuthMethodCreateK8s
      //var instane = new akeyless.AuthMethodCreateK8s();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateK8s);
    });
