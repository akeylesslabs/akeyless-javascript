...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateChef();
  });
  ...
  describe('DynamicSecretCreateChef', function() {
    it('should create an instance of DynamicSecretCreateChef', function() {
      // uncomment below and update the code to test DynamicSecretCreateChef
      //var instane = new akeyless.DynamicSecretCreateChef();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateChef);
    });
