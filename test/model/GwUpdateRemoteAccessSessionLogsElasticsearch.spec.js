...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsElasticsearch();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsElasticsearch', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsElasticsearch', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsElasticsearch
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsElasticsearch();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsElasticsearch);
    });
