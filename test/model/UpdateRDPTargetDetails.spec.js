...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateRDPTargetDetails();
  });
  ...
  describe('UpdateRDPTargetDetails', function() {
    it('should create an instance of UpdateRDPTargetDetails', function() {
      // uncomment below and update the code to test UpdateRDPTargetDetails
      //var instane = new akeyless.UpdateRDPTargetDetails();
      //expect(instance).to.be.a(akeyless.UpdateRDPTargetDetails);
    });
