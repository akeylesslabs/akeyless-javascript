...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateCustomDns();
  });
  ...
  describe('TargetUpdateCustomDns', function() {
    it('should create an instance of TargetUpdateCustomDns', function() {
      // uncomment below and update the code to test TargetUpdateCustomDns
      //var instance = new akeyless.TargetUpdateCustomDns();
      //expect(instance).to.be.a(akeyless.TargetUpdateCustomDns);
    });
    ...
    it('should have the property dnsParameter (base name: "dns-parameter")', function() {
      // uncomment below and update the code to test the property dnsParameter
      //var instance = new akeyless.TargetUpdateCustomDns();
      //expect(instance).to.be();
    });
