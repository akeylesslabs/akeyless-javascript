...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsSumologic();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsSumologic', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsSumologic', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsSumologic
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsSumologic();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsSumologic);
    });
    ...
    it('should have the property sumologicTags (base name: "sumologic-tags")', function() {
