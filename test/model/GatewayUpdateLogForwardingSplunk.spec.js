...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingSplunk();
  });
  ...
  describe('GatewayUpdateLogForwardingSplunk', function() {
    it('should create an instance of GatewayUpdateLogForwardingSplunk', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingSplunk
      //var instane = new akeyless.GatewayUpdateLogForwardingSplunk();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingSplunk);
    });
