...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UnlockItem();
  });
  ...
  describe('UnlockItem', function() {
    it('should create an instance of UnlockItem', function() {
      // uncomment below and update the code to test UnlockItem
      //var instance = new akeyless.UnlockItem();
      //expect(instance).to.be.a(akeyless.UnlockItem);
    });
