...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayDeleteK8SAuthConfigOutput();
  });
  ...
  describe('GatewayDeleteK8SAuthConfigOutput', function() {
    it('should create an instance of GatewayDeleteK8SAuthConfigOutput', function() {
      // uncomment below and update the code to test GatewayDeleteK8SAuthConfigOutput
      //var instane = new akeyless.GatewayDeleteK8SAuthConfigOutput();
      //expect(instance).to.be.a(akeyless.GatewayDeleteK8SAuthConfigOutput);
    });
