...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerRedis();
  });
  ...
  describe('GatewayUpdateProducerRedis', function() {
    it('should create an instance of GatewayUpdateProducerRedis', function() {
      // uncomment below and update the code to test GatewayUpdateProducerRedis
      //var instane = new akeyless.GatewayUpdateProducerRedis();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerRedis);
    });
