...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateSnowflake();
  });
  ...
  describe('DynamicSecretCreateSnowflake', function() {
    it('should create an instance of DynamicSecretCreateSnowflake', function() {
      // uncomment below and update the code to test DynamicSecretCreateSnowflake
      //var instane = new akeyless.DynamicSecretCreateSnowflake();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateSnowflake);
    });
