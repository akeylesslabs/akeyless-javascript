...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AssocTargetItem();
  });
  ...
  describe('AssocTargetItem', function() {
    it('should create an instance of AssocTargetItem', function() {
      // uncomment below and update the code to test AssocTargetItem
      //var instane = new akeyless.AssocTargetItem();
      //expect(instance).to.be.a(akeyless.AssocTargetItem);
    });
