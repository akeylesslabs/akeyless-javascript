...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DecryptGPG();
  });
  ...
  describe('DecryptGPG', function() {
    it('should create an instance of DecryptGPG', function() {
      // uncomment below and update the code to test DecryptGPG
      //var instane = new akeyless.DecryptGPG();
      //expect(instance).to.be.a(akeyless.DecryptGPG);
    });
