...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateOCI();
  });
  ...
  describe('AuthMethodCreateOCI', function() {
    it('should create an instance of AuthMethodCreateOCI', function() {
      // uncomment below and update the code to test AuthMethodCreateOCI
      //var instane = new akeyless.AuthMethodCreateOCI();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateOCI);
    });
