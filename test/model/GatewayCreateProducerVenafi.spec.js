...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerVenafi();
  });
  ...
  describe('GatewayCreateProducerVenafi', function() {
    it('should create an instance of GatewayCreateProducerVenafi', function() {
      // uncomment below and update the code to test GatewayCreateProducerVenafi
      //var instane = new akeyless.GatewayCreateProducerVenafi();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerVenafi);
    });
