...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateArtifactory();
  });
  ...
  describe('DynamicSecretCreateArtifactory', function() {
    it('should create an instance of DynamicSecretCreateArtifactory', function() {
      // uncomment below and update the code to test DynamicSecretCreateArtifactory
      //var instane = new akeyless.DynamicSecretCreateArtifactory();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateArtifactory);
    });
