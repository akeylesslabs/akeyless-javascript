...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateGcp();
  });
  ...
  describe('AuthMethodCreateGcp', function() {
    it('should create an instance of AuthMethodCreateGcp', function() {
      // uncomment below and update the code to test AuthMethodCreateGcp
      //var instane = new akeyless.AuthMethodCreateGcp();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateGcp);
    });
