...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateOkta();
  });
  ...
  describe('TargetUpdateOkta', function() {
    it('should create an instance of TargetUpdateOkta', function() {
      // uncomment below and update the code to test TargetUpdateOkta
      //var instance = new akeyless.TargetUpdateOkta();
      //expect(instance).to.be.a(akeyless.TargetUpdateOkta);
    });
