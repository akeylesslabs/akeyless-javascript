...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateLdap();
  });
  ...
  describe('TargetUpdateLdap', function() {
    it('should create an instance of TargetUpdateLdap', function() {
      // uncomment below and update the code to test TargetUpdateLdap
      //var instane = new akeyless.TargetUpdateLdap();
      //expect(instance).to.be.a(akeyless.TargetUpdateLdap);
    });
