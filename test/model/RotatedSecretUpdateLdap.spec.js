...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateLdap();
  });
  ...
  describe('RotatedSecretUpdateLdap', function() {
    it('should create an instance of RotatedSecretUpdateLdap', function() {
      // uncomment below and update the code to test RotatedSecretUpdateLdap
      //var instane = new akeyless.RotatedSecretUpdateLdap();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateLdap);
    });
