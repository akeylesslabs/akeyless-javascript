...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.FolderDeleteSync();
  });
  ...
  describe('FolderDeleteSync', function() {
    it('should create an instance of FolderDeleteSync', function() {
      // uncomment below and update the code to test FolderDeleteSync
      //var instance = new akeyless.FolderDeleteSync();
      //expect(instance).to.be.a(akeyless.FolderDeleteSync);
    });
    ...
    it('should have the property deleteFromUsc (base name: "delete-from-usc")', function() {
      // uncomment below and update the code to test the property deleteFromUsc
      //var instance = new akeyless.FolderDeleteSync();
      //expect(instance).to.be();
    });
