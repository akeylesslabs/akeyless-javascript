...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.GetSecretValue();
  });
  ...
  describe('GetSecretValue', function() {
    it('should create an instance of GetSecretValue', function() {
      // uncomment below and update the code to test GetSecretValue
      //var instane = new akl.GetSecretValue();
      //expect(instance).to.be.a(akl.GetSecretValue);
    });
