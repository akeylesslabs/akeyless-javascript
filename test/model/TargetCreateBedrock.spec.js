...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateBedrock();
  });
  ...
  describe('TargetCreateBedrock', function() {
    it('should create an instance of TargetCreateBedrock', function() {
      // uncomment below and update the code to test TargetCreateBedrock
      //var instance = new akeyless.TargetCreateBedrock();
      //expect(instance).to.be.a(akeyless.TargetCreateBedrock);
    });
