...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAuthMethodLDAP();
  });
  ...
  describe('UpdateAuthMethodLDAP', function() {
    it('should create an instance of UpdateAuthMethodLDAP', function() {
      // uncomment below and update the code to test UpdateAuthMethodLDAP
      //var instane = new akeyless.UpdateAuthMethodLDAP();
      //expect(instance).to.be.a(akeyless.UpdateAuthMethodLDAP);
    });
