...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DeleteGatewayAllowedAccessId();
  });
  ...
  describe('DeleteGatewayAllowedAccessId', function() {
    it('should create an instance of DeleteGatewayAllowedAccessId', function() {
      // uncomment below and update the code to test DeleteGatewayAllowedAccessId
      //var instane = new akeyless.DeleteGatewayAllowedAccessId();
      //expect(instance).to.be.a(akeyless.DeleteGatewayAllowedAccessId);
    });
