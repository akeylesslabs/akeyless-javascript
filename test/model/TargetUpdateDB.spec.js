...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateDB();
  });
  ...
  describe('TargetUpdateDB', function() {
    it('should create an instance of TargetUpdateDB', function() {
      // uncomment below and update the code to test TargetUpdateDB
      //var instane = new akeyless.TargetUpdateDB();
      //expect(instance).to.be.a(akeyless.TargetUpdateDB);
    });
