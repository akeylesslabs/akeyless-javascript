...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerNativeK8S();
  });
  ...
  describe('GatewayUpdateProducerNativeK8S', function() {
    it('should create an instance of GatewayUpdateProducerNativeK8S', function() {
      // uncomment below and update the code to test GatewayUpdateProducerNativeK8S
      //var instane = new akeyless.GatewayUpdateProducerNativeK8S();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerNativeK8S);
    });
