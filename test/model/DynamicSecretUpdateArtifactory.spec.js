...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateArtifactory();
  });
  ...
  describe('DynamicSecretUpdateArtifactory', function() {
    it('should create an instance of DynamicSecretUpdateArtifactory', function() {
      // uncomment below and update the code to test DynamicSecretUpdateArtifactory
      //var instane = new akeyless.DynamicSecretUpdateArtifactory();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateArtifactory);
    });
