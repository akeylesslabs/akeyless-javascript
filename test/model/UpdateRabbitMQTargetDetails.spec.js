...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateRabbitMQTargetDetails();
  });
  ...
  describe('UpdateRabbitMQTargetDetails', function() {
    it('should create an instance of UpdateRabbitMQTargetDetails', function() {
      // uncomment below and update the code to test UpdateRabbitMQTargetDetails
      //var instane = new akeyless.UpdateRabbitMQTargetDetails();
      //expect(instance).to.be.a(akeyless.UpdateRabbitMQTargetDetails);
    });
