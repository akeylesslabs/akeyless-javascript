...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateOpenAI();
  });
  ...
  describe('TargetUpdateOpenAI', function() {
    it('should create an instance of TargetUpdateOpenAI', function() {
      // uncomment below and update the code to test TargetUpdateOpenAI
      //var instance = new akeyless.TargetUpdateOpenAI();
      //expect(instance).to.be.a(akeyless.TargetUpdateOpenAI);
    });
    ...
    it('should have the property openaiUrl (base name: "openai-url")', function() {
      // uncomment below and update the code to test the property openaiUrl
      //var instance = new akeyless.TargetUpdateOpenAI();
      //expect(instance).to.be();
    });
