...
(function(root, factory) {
  ...
  describe('UscList', function() {
    it('should create an instance of UscList', function() {
      // uncomment below and update the code to test UscList
      //var instane = new akeyless.UscList();
      //expect(instance).to.be.a(akeyless.UscList);
    });
