...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateDockerhub();
  });
  ...
  describe('DynamicSecretUpdateDockerhub', function() {
    it('should create an instance of DynamicSecretUpdateDockerhub', function() {
      // uncomment below and update the code to test DynamicSecretUpdateDockerhub
      //var instane = new akeyless.DynamicSecretUpdateDockerhub();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateDockerhub);
    });
