...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.ListAuthMethods();
  });
  ...
  describe('ListAuthMethods', function() {
    it('should create an instance of ListAuthMethods', function() {
      // uncomment below and update the code to test ListAuthMethods
      //var instane = new akl.ListAuthMethods();
      //expect(instance).to.be.a(akl.ListAuthMethods);
    });
