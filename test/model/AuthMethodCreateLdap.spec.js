...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateLdap();
  });
  ...
  describe('AuthMethodCreateLdap', function() {
    it('should create an instance of AuthMethodCreateLdap', function() {
      // uncomment below and update the code to test AuthMethodCreateLdap
      //var instane = new akeyless.AuthMethodCreateLdap();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateLdap);
    });
