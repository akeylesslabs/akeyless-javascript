...
(function(root, factory) {
  ...
  describe('DeleteItems', function() {
    it('should create an instance of DeleteItems', function() {
      // uncomment below and update the code to test DeleteItems
      //var instane = new akl.DeleteItems();
      //expect(instance).to.be.a(akl.DeleteItems);
    });
