...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateGlobalSignAtlasTarget();
  });
  ...
  describe('UpdateGlobalSignAtlasTarget', function() {
    it('should create an instance of UpdateGlobalSignAtlasTarget', function() {
      // uncomment below and update the code to test UpdateGlobalSignAtlasTarget
      //var instane = new akeyless.UpdateGlobalSignAtlasTarget();
      //expect(instance).to.be.a(akeyless.UpdateGlobalSignAtlasTarget);
    });
