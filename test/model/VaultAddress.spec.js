...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.VaultAddress();
  });
  ...
  describe('VaultAddress', function() {
    it('should create an instance of VaultAddress', function() {
      // uncomment below and update the code to test VaultAddress
      //var instance = new akeyless.VaultAddress();
      //expect(instance).to.be.a(akeyless.VaultAddress);
    });
