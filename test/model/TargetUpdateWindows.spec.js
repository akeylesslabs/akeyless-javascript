...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateWindows();
  });
  ...
  describe('TargetUpdateWindows', function() {
    it('should create an instance of TargetUpdateWindows', function() {
      // uncomment below and update the code to test TargetUpdateWindows
      //var instane = new akeyless.TargetUpdateWindows();
      //expect(instance).to.be.a(akeyless.TargetUpdateWindows);
    });
