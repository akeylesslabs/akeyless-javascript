...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateSsh();
  });
  ...
  describe('RotatedSecretCreateSsh', function() {
    it('should create an instance of RotatedSecretCreateSsh', function() {
      // uncomment below and update the code to test RotatedSecretCreateSsh
      //var instane = new akeyless.RotatedSecretCreateSsh();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateSsh);
    });
    ...
    it('should have the property rotatorCustomCmd (base name: "rotator-custom-cmd")', function() {
      // uncomment below and update the code to test the property rotatorCustomCmd
      //var instane = new akeyless.RotatedSecretCreateSsh();
      //expect(instance).to.be();
    });
    ...
    it('should have the property secureAccessSshUser (base name: "secure-access-ssh-user")', function() {
      // uncomment below and update the code to test the property secureAccessSshUser
      //var instane = new akeyless.RotatedSecretCreateSsh();
      //expect(instance).to.be();
    });
