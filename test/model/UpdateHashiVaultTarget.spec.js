...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateHashiVaultTarget();
  });
  ...
  describe('UpdateHashiVaultTarget', function() {
    it('should create an instance of UpdateHashiVaultTarget', function() {
      // uncomment below and update the code to test UpdateHashiVaultTarget
      //var instane = new akeyless.UpdateHashiVaultTarget();
      //expect(instance).to.be.a(akeyless.UpdateHashiVaultTarget);
    });
