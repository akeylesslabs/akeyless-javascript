...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateRabbitMQTarget();
  });
  ...
  describe('CreateRabbitMQTarget', function() {
    it('should create an instance of CreateRabbitMQTarget', function() {
      // uncomment below and update the code to test CreateRabbitMQTarget
      //var instane = new akeyless.CreateRabbitMQTarget();
      //expect(instance).to.be.a(akeyless.CreateRabbitMQTarget);
    });
