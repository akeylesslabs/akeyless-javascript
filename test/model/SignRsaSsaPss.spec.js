...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.SignRsaSsaPss();
  });
  ...
  describe('SignRsaSsaPss', function() {
    it('should create an instance of SignRsaSsaPss', function() {
      // uncomment below and update the code to test SignRsaSsaPss
      //var instane = new akeyless.SignRsaSsaPss();
      //expect(instance).to.be.a(akeyless.SignRsaSsaPss);
    });
