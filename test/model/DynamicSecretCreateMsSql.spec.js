...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateMsSql();
  });
  ...
  describe('DynamicSecretCreateMsSql', function() {
    it('should create an instance of DynamicSecretCreateMsSql', function() {
      // uncomment below and update the code to test DynamicSecretCreateMsSql
      //var instane = new akeyless.DynamicSecretCreateMsSql();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateMsSql);
    });
