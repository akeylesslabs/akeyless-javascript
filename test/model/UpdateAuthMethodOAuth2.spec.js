...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAuthMethodOAuth2();
  });
  ...
  describe('UpdateAuthMethodOAuth2', function() {
    it('should create an instance of UpdateAuthMethodOAuth2', function() {
      // uncomment below and update the code to test UpdateAuthMethodOAuth2
      //var instane = new akeyless.UpdateAuthMethodOAuth2();
      //expect(instance).to.be.a(akeyless.UpdateAuthMethodOAuth2);
    });
