...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.FolderCreate();
  });
  ...
  describe('FolderCreate', function() {
    it('should create an instance of FolderCreate', function() {
      // uncomment below and update the code to test FolderCreate
      //var instance = new akeyless.FolderCreate();
      //expect(instance).to.be.a(akeyless.FolderCreate);
    });
