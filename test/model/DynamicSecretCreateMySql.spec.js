...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateMySql();
  });
  ...
  describe('DynamicSecretCreateMySql', function() {
    it('should create an instance of DynamicSecretCreateMySql', function() {
      // uncomment below and update the code to test DynamicSecretCreateMySql
      //var instane = new akeyless.DynamicSecretCreateMySql();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateMySql);
    });
