...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretGetValue();
  });
  ...
  describe('DynamicSecretGetValue', function() {
    it('should create an instance of DynamicSecretGetValue', function() {
      // uncomment below and update the code to test DynamicSecretGetValue
      //var instane = new akeyless.DynamicSecretGetValue();
      //expect(instance).to.be.a(akeyless.DynamicSecretGetValue);
    });
