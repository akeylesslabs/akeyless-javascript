...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateLdap();
  });
  ...
  describe('AuthMethodUpdateLdap', function() {
    it('should create an instance of AuthMethodUpdateLdap', function() {
      // uncomment below and update the code to test AuthMethodUpdateLdap
      //var instane = new akeyless.AuthMethodUpdateLdap();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateLdap);
    });
    ...
    it('should have the property publicKeyData (base name: "public-key-data")', function() {
