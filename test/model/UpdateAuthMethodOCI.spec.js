...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAuthMethodOCI();
  });
  ...
  describe('UpdateAuthMethodOCI', function() {
    it('should create an instance of UpdateAuthMethodOCI', function() {
      // uncomment below and update the code to test UpdateAuthMethodOCI
      //var instane = new akeyless.UpdateAuthMethodOCI();
      //expect(instance).to.be.a(akeyless.UpdateAuthMethodOCI);
    });
