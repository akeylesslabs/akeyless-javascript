...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.PoliciesList();
  });
  ...
  describe('PoliciesList', function() {
    it('should create an instance of PoliciesList', function() {
      // uncomment below and update the code to test PoliciesList
      //var instance = new akeyless.PoliciesList();
      //expect(instance).to.be.a(akeyless.PoliciesList);
    });
