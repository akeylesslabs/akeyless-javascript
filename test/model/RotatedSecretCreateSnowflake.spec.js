...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateSnowflake();
  });
  ...
  describe('RotatedSecretCreateSnowflake', function() {
    it('should create an instance of RotatedSecretCreateSnowflake', function() {
      // uncomment below and update the code to test RotatedSecretCreateSnowflake
      //var instane = new akeyless.RotatedSecretCreateSnowflake();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateSnowflake);
    });
