...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateGitlabTarget();
  });
  ...
  describe('UpdateGitlabTarget', function() {
    it('should create an instance of UpdateGitlabTarget', function() {
      // uncomment below and update the code to test UpdateGitlabTarget
      //var instane = new akeyless.UpdateGitlabTarget();
      //expect(instance).to.be.a(akeyless.UpdateGitlabTarget);
    });
