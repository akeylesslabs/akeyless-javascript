...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerRedshift();
  });
  ...
  describe('GatewayCreateProducerRedshift', function() {
    it('should create an instance of GatewayCreateProducerRedshift', function() {
      // uncomment below and update the code to test GatewayCreateProducerRedshift
      //var instane = new akeyless.GatewayCreateProducerRedshift();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerRedshift);
    });
