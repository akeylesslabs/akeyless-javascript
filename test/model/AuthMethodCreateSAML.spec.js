...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateSAML();
  });
  ...
  describe('AuthMethodCreateSAML', function() {
    it('should create an instance of AuthMethodCreateSAML', function() {
      // uncomment below and update the code to test AuthMethodCreateSAML
      //var instane = new akeyless.AuthMethodCreateSAML();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateSAML);
    });
