...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateVenafi();
  });
  ...
  describe('DynamicSecretCreateVenafi', function() {
    it('should create an instance of DynamicSecretCreateVenafi', function() {
      // uncomment below and update the code to test DynamicSecretCreateVenafi
      //var instane = new akeyless.DynamicSecretCreateVenafi();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateVenafi);
    });
