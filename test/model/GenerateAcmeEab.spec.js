...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GenerateAcmeEab();
  });
  ...
  describe('GenerateAcmeEab', function() {
    it('should create an instance of GenerateAcmeEab', function() {
      // uncomment below and update the code to test GenerateAcmeEab
      //var instane = new akeyless.GenerateAcmeEab();
      //expect(instance).to.be.a(akeyless.GenerateAcmeEab);
    });
