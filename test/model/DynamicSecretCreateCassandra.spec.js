...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateCassandra();
  });
  ...
  describe('DynamicSecretCreateCassandra', function() {
    it('should create an instance of DynamicSecretCreateCassandra', function() {
      // uncomment below and update the code to test DynamicSecretCreateCassandra
      //var instane = new akeyless.DynamicSecretCreateCassandra();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateCassandra);
    });
