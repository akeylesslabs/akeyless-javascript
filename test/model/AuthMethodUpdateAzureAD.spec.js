...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateAzureAD();
  });
  ...
  describe('AuthMethodUpdateAzureAD', function() {
    it('should create an instance of AuthMethodUpdateAzureAD', function() {
      // uncomment below and update the code to test AuthMethodUpdateAzureAD
      //var instane = new akeyless.AuthMethodUpdateAzureAD();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateAzureAD);
    });
