...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateF5BigIp();
  });
  ...
  describe('TargetUpdateF5BigIp', function() {
    it('should create an instance of TargetUpdateF5BigIp', function() {
      // uncomment below and update the code to test TargetUpdateF5BigIp
      //var instance = new akeyless.TargetUpdateF5BigIp();
      //expect(instance).to.be.a(akeyless.TargetUpdateF5BigIp);
    });
