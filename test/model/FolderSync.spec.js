...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.FolderSync();
  });
  ...
  describe('FolderSync', function() {
    it('should create an instance of FolderSync', function() {
      // uncomment below and update the code to test FolderSync
      //var instance = new akeyless.FolderSync();
      //expect(instance).to.be.a(akeyless.FolderSync);
    });
    ...
    it('should have the property deleteRemote (base name: "delete-remote")', function() {
      // uncomment below and update the code to test the property deleteRemote
      //var instance = new akeyless.FolderSync();
      //expect(instance).to.be();
    });

    it('should have the property engineName (base name: "engine-name")', function() {
      // uncomment below and update the code to test the property engineName
      //var instance = new akeyless.FolderSync();
      //expect(instance).to.be();
    });
