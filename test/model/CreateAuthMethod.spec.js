...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.CreateAuthMethod();
  });
  ...
  describe('CreateAuthMethod', function() {
    it('should create an instance of CreateAuthMethod', function() {
      // uncomment below and update the code to test CreateAuthMethod
      //var instane = new akl.CreateAuthMethod();
      //expect(instance).to.be.a(akl.CreateAuthMethod);
    });
