...
(function(root, factory) {
  ...
  describe('VerifyPKCS1', function() {
    it('should create an instance of VerifyPKCS1', function() {
      // uncomment below and update the code to test VerifyPKCS1
      //var instane = new akl.VerifyPKCS1();
      //expect(instance).to.be.a(akl.VerifyPKCS1);
    });
