...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ListTargets();
  });
  ...
  describe('ListTargets', function() {
    it('should create an instance of ListTargets', function() {
      // uncomment below and update the code to test ListTargets
      //var instane = new akeyless.ListTargets();
      //expect(instance).to.be.a(akeyless.ListTargets);
    });
