...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGemini();
  });
  ...
  describe('TargetUpdateGemini', function() {
    it('should create an instance of TargetUpdateGemini', function() {
      // uncomment below and update the code to test TargetUpdateGemini
      //var instance = new akeyless.TargetUpdateGemini();
      //expect(instance).to.be.a(akeyless.TargetUpdateGemini);
    });
    ...
    it('should have the property geminiUrl (base name: "gemini-url")', function() {
      // uncomment below and update the code to test the property geminiUrl
      //var instance = new akeyless.TargetUpdateGemini();
      //expect(instance).to.be();
    });
