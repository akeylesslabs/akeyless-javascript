...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingAzureAnalytics();
  });
  ...
  describe('GatewayUpdateLogForwardingAzureAnalytics', function() {
    it('should create an instance of GatewayUpdateLogForwardingAzureAnalytics', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingAzureAnalytics
      //var instane = new akeyless.GatewayUpdateLogForwardingAzureAnalytics();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingAzureAnalytics);
    });
