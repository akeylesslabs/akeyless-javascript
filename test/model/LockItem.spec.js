...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.LockItem();
  });
  ...
  describe('LockItem', function() {
    it('should create an instance of LockItem', function() {
      // uncomment below and update the code to test LockItem
      //var instance = new akeyless.LockItem();
      //expect(instance).to.be.a(akeyless.LockItem);
    });
