...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateOracleDb();
  });
  ...
  describe('DynamicSecretUpdateOracleDb', function() {
    it('should create an instance of DynamicSecretUpdateOracleDb', function() {
      // uncomment below and update the code to test DynamicSecretUpdateOracleDb
      //var instane = new akeyless.DynamicSecretUpdateOracleDb();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateOracleDb);
    });
    ...
    it('should have the property oracleRevocationStatements (base name: "oracle-revocation-statements")', function() {
      // uncomment below and update the code to test the property oracleRevocationStatements
      //var instane = new akeyless.DynamicSecretUpdateOracleDb();
      //expect(instance).to.be();
    });
