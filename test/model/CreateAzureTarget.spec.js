...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateAzureTarget();
  });
  ...
  describe('CreateAzureTarget', function() {
    it('should create an instance of CreateAzureTarget', function() {
      // uncomment below and update the code to test CreateAzureTarget
      //var instane = new akeyless.CreateAzureTarget();
      //expect(instance).to.be.a(akeyless.CreateAzureTarget);
    });
