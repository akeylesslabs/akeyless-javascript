...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.LockTarget();
  });
  ...
  describe('LockTarget', function() {
    it('should create an instance of LockTarget', function() {
      // uncomment below and update the code to test LockTarget
      //var instance = new akeyless.LockTarget();
      //expect(instance).to.be.a(akeyless.LockTarget);
    });
    ...
    it('should have the property lockTtl (base name: "lock-ttl")', function() {
