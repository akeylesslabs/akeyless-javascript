...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.FolderSyncAll();
  });
  ...
  describe('FolderSyncAll', function() {
    it('should create an instance of FolderSyncAll', function() {
      // uncomment below and update the code to test FolderSyncAll
      //var instance = new akeyless.FolderSyncAll();
      //expect(instance).to.be.a(akeyless.FolderSyncAll);
    });
