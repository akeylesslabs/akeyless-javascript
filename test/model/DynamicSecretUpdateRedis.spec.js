...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateRedis();
  });
  ...
  describe('DynamicSecretUpdateRedis', function() {
    it('should create an instance of DynamicSecretUpdateRedis', function() {
      // uncomment below and update the code to test DynamicSecretUpdateRedis
      //var instane = new akeyless.DynamicSecretUpdateRedis();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateRedis);
    });
