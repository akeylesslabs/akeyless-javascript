...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerSnowflake();
  });
  ...
  describe('GatewayUpdateProducerSnowflake', function() {
    it('should create an instance of GatewayUpdateProducerSnowflake', function() {
      // uncomment below and update the code to test GatewayUpdateProducerSnowflake
      //var instane = new akeyless.GatewayUpdateProducerSnowflake();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerSnowflake);
    });
