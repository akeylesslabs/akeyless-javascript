...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateAnthropic();
  });
  ...
  describe('TargetUpdateAnthropic', function() {
    it('should create an instance of TargetUpdateAnthropic', function() {
      // uncomment below and update the code to test TargetUpdateAnthropic
      //var instance = new akeyless.TargetUpdateAnthropic();
      //expect(instance).to.be.a(akeyless.TargetUpdateAnthropic);
    });

    it('should have the property anthropicUrl (base name: "anthropic-url")', function() {
      // uncomment below and update the code to test the property anthropicUrl
      //var instance = new akeyless.TargetUpdateAnthropic();
