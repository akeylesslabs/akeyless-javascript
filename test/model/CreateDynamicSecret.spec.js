...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.CreateDynamicSecret();
  });
  ...
  describe('CreateDynamicSecret', function() {
    it('should create an instance of CreateDynamicSecret', function() {
      // uncomment below and update the code to test CreateDynamicSecret
      //var instane = new akl.CreateDynamicSecret();
      //expect(instance).to.be.a(akl.CreateDynamicSecret);
    });
