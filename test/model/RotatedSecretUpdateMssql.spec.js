...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateMssql();
  });
  ...
  describe('RotatedSecretUpdateMssql', function() {
    it('should create an instance of RotatedSecretUpdateMssql', function() {
      // uncomment below and update the code to test RotatedSecretUpdateMssql
      //var instane = new akeyless.RotatedSecretUpdateMssql();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateMssql);
    });
