...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GetGroup();
  });
  ...
  describe('GetGroup', function() {
    it('should create an instance of GetGroup', function() {
      // uncomment below and update the code to test GetGroup
      //var instane = new akeyless.GetGroup();
      //expect(instance).to.be.a(akeyless.GetGroup);
    });
