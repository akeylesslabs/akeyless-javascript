...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateAuthMethodOCI();
  });
  ...
  describe('CreateAuthMethodOCI', function() {
    it('should create an instance of CreateAuthMethodOCI', function() {
      // uncomment below and update the code to test CreateAuthMethodOCI
      //var instane = new akeyless.CreateAuthMethodOCI();
      //expect(instance).to.be.a(akeyless.CreateAuthMethodOCI);
    });
