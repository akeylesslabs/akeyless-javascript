...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateDBTargetDetails();
  });
  ...
  describe('UpdateDBTargetDetails', function() {
    it('should create an instance of UpdateDBTargetDetails', function() {
      // uncomment below and update the code to test UpdateDBTargetDetails
      //var instane = new akeyless.UpdateDBTargetDetails();
      //expect(instance).to.be.a(akeyless.UpdateDBTargetDetails);
    });
