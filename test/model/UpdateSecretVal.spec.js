...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.UpdateSecretVal();
  });
  ...
  describe('UpdateSecretVal', function() {
    it('should create an instance of UpdateSecretVal', function() {
      // uncomment below and update the code to test UpdateSecretVal
      //var instane = new akl.UpdateSecretVal();
      //expect(instance).to.be.a(akl.UpdateSecretVal);
    });
