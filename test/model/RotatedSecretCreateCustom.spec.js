...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateCustom();
  });
  ...
  describe('RotatedSecretCreateCustom', function() {
    it('should create an instance of RotatedSecretCreateCustom', function() {
      // uncomment below and update the code to test RotatedSecretCreateCustom
      //var instane = new akeyless.RotatedSecretCreateCustom();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateCustom);
    });
    ...
    it('should have the property customPayload (base name: "custom-payload")', function() {
