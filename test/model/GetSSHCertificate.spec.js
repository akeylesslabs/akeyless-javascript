...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.GetSSHCertificate();
  });
  ...
  describe('GetSSHCertificate', function() {
    it('should create an instance of GetSSHCertificate', function() {
      // uncomment below and update the code to test GetSSHCertificate
      //var instane = new akl.GetSSHCertificate();
      //expect(instance).to.be.a(akl.GetSSHCertificate);
    });
    ...
    it('should have the property certUsername (base name: "cert-username")', function() {
      // uncomment below and update the code to test the property certUsername
      //var instane = new akl.GetSSHCertificate();
      //expect(instance).to.be();
    });
