...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AzurePayload();
  });
  ...
  describe('AzurePayload', function() {
    it('should create an instance of AzurePayload', function() {
      // uncomment below and update the code to test AzurePayload
      //var instane = new akeyless.AzurePayload();
      //expect(instance).to.be.a(akeyless.AzurePayload);
    });
