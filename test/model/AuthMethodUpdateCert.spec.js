...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodUpdateCert();
  });
  ...
  describe('AuthMethodUpdateCert', function() {
    it('should create an instance of AuthMethodUpdateCert', function() {
      // uncomment below and update the code to test AuthMethodUpdateCert
      //var instane = new akeyless.AuthMethodUpdateCert();
      //expect(instance).to.be.a(akeyless.AuthMethodUpdateCert);
    });
