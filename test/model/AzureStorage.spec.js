...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AzureStorage();
  });
  ...
  describe('AzureStorage', function() {
    it('should create an instance of AzureStorage', function() {
      // uncomment below and update the code to test AzureStorage
      //var instane = new akeyless.AzureStorage();
      //expect(instance).to.be.a(akeyless.AzureStorage);
    });
    ...
    it('should have the property storageContainerName (base name: "storage_container_name")', function() {
      // uncomment below and update the code to test the property storageContainerName
      //var instane = new akeyless.AzureStorage();
      //expect(instance).to.be();
    });
