...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateGke();
  });
  ...
  describe('DynamicSecretUpdateGke', function() {
    it('should create an instance of DynamicSecretUpdateGke', function() {
      // uncomment below and update the code to test DynamicSecretUpdateGke
      //var instane = new akeyless.DynamicSecretUpdateGke();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateGke);
    });
