...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateAws();
  });
  ...
  describe('DynamicSecretUpdateAws', function() {
    it('should create an instance of DynamicSecretUpdateAws', function() {
      // uncomment below and update the code to test DynamicSecretUpdateAws
      //var instane = new akeyless.DynamicSecretUpdateAws();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateAws);
    });
