...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AccountCustomField();
  });
  ...
  describe('AccountCustomField', function() {
    it('should create an instance of AccountCustomField', function() {
      // uncomment below and update the code to test AccountCustomField
      //var instance = new akeyless.AccountCustomField();
      //expect(instance).to.be.a(akeyless.AccountCustomField);
    });
