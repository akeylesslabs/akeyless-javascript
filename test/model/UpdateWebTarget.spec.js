...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateWebTarget();
  });
  ...
  describe('UpdateWebTarget', function() {
    it('should create an instance of UpdateWebTarget', function() {
      // uncomment below and update the code to test UpdateWebTarget
      //var instane = new akeyless.UpdateWebTarget();
      //expect(instance).to.be.a(akeyless.UpdateWebTarget);
    });
