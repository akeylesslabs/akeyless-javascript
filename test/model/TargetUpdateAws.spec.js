...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateAws();
  });
  ...
  describe('TargetUpdateAws', function() {
    it('should create an instance of TargetUpdateAws', function() {
      // uncomment below and update the code to test TargetUpdateAws
      //var instane = new akeyless.TargetUpdateAws();
      //expect(instance).to.be.a(akeyless.TargetUpdateAws);
    });
