...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerEks();
  });
  ...
  describe('GatewayCreateProducerEks', function() {
    it('should create an instance of GatewayCreateProducerEks', function() {
      // uncomment below and update the code to test GatewayCreateProducerEks
      //var instane = new akeyless.GatewayCreateProducerEks();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerEks);
    });
