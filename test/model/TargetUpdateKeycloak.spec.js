...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateKeycloak();
  });
  ...
  describe('TargetUpdateKeycloak', function() {
    it('should create an instance of TargetUpdateKeycloak', function() {
      // uncomment below and update the code to test TargetUpdateKeycloak
      //var instance = new akeyless.TargetUpdateKeycloak();
      //expect(instance).to.be.a(akeyless.TargetUpdateKeycloak);
    });
