...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateAws();
  });
  ...
  describe('DynamicSecretCreateAws', function() {
    it('should create an instance of DynamicSecretCreateAws', function() {
      // uncomment below and update the code to test DynamicSecretCreateAws
      //var instane = new akeyless.DynamicSecretCreateAws();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateAws);
    });
