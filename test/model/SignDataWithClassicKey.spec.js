...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.SignDataWithClassicKey();
  });
  ...
  describe('SignDataWithClassicKey', function() {
    it('should create an instance of SignDataWithClassicKey', function() {
      // uncomment below and update the code to test SignDataWithClassicKey
      //var instane = new akeyless.SignDataWithClassicKey();
      //expect(instance).to.be.a(akeyless.SignDataWithClassicKey);
    });
