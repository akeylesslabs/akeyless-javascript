...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateHanadb();
  });
  ...
  describe('RotatedSecretUpdateHanadb', function() {
    it('should create an instance of RotatedSecretUpdateHanadb', function() {
      // uncomment below and update the code to test RotatedSecretUpdateHanadb
      //var instane = new akeyless.RotatedSecretUpdateHanadb();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateHanadb);
    });
