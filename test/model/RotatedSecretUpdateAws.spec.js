...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateAws();
  });
  ...
  describe('RotatedSecretUpdateAws', function() {
    it('should create an instance of RotatedSecretUpdateAws', function() {
      // uncomment below and update the code to test RotatedSecretUpdateAws
      //var instane = new akeyless.RotatedSecretUpdateAws();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateAws);
    });
