...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateAerospike();
  });
  ...
  describe('RotatedSecretUpdateAerospike', function() {
    it('should create an instance of RotatedSecretUpdateAerospike', function() {
      // uncomment below and update the code to test RotatedSecretUpdateAerospike
      //var instance = new akeyless.RotatedSecretUpdateAerospike();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateAerospike);
    });
