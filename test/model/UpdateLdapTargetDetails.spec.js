...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateLdapTargetDetails();
  });
  ...
  describe('UpdateLdapTargetDetails', function() {
    it('should create an instance of UpdateLdapTargetDetails', function() {
      // uncomment below and update the code to test UpdateLdapTargetDetails
      //var instane = new akeyless.UpdateLdapTargetDetails();
      //expect(instance).to.be.a(akeyless.UpdateLdapTargetDetails);
    });
