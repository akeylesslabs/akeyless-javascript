...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerAws();
  });
  ...
  describe('GatewayCreateProducerAws', function() {
    it('should create an instance of GatewayCreateProducerAws', function() {
      // uncomment below and update the code to test GatewayCreateProducerAws
      //var instane = new akeyless.GatewayCreateProducerAws();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerAws);
    });
    ...
    it('should have the property accessSecretKey (base name: "access-secret-key")', function() {
      // uncomment below and update the code to test the property accessSecretKey
      //var instane = new akeyless.GatewayCreateProducerAws();
      //expect(instance).to.be();
    });
