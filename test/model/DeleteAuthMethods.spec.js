...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.DeleteAuthMethods();
  });
  ...
  describe('DeleteAuthMethods', function() {
    it('should create an instance of DeleteAuthMethods', function() {
      // uncomment below and update the code to test DeleteAuthMethods
      //var instane = new akl.DeleteAuthMethods();
      //expect(instance).to.be.a(akl.DeleteAuthMethods);
    });
