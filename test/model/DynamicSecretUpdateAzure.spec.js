...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateAzure();
  });
  ...
  describe('DynamicSecretUpdateAzure', function() {
    it('should create an instance of DynamicSecretUpdateAzure', function() {
      // uncomment below and update the code to test DynamicSecretUpdateAzure
      //var instane = new akeyless.DynamicSecretUpdateAzure();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateAzure);
    });
