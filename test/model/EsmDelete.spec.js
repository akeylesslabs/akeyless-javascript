...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.EsmDelete();
  });
  ...
  describe('EsmDelete', function() {
    it('should create an instance of EsmDelete', function() {
      // uncomment below and update the code to test EsmDelete
      //var instane = new akeyless.EsmDelete();
      //expect(instance).to.be.a(akeyless.EsmDelete);
    });
