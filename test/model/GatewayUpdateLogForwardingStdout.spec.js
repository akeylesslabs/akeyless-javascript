...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateLogForwardingStdout();
  });
  ...
  describe('GatewayUpdateLogForwardingStdout', function() {
    it('should create an instance of GatewayUpdateLogForwardingStdout', function() {
      // uncomment below and update the code to test GatewayUpdateLogForwardingStdout
      //var instane = new akeyless.GatewayUpdateLogForwardingStdout();
      //expect(instance).to.be.a(akeyless.GatewayUpdateLogForwardingStdout);
    });
