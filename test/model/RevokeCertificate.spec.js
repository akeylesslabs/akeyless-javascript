...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RevokeCertificate();
  });
  ...
  describe('RevokeCertificate', function() {
    it('should create an instance of RevokeCertificate', function() {
      // uncomment below and update the code to test RevokeCertificate
      //var instane = new akeyless.RevokeCertificate();
      //expect(instance).to.be.a(akeyless.RevokeCertificate);
    });
    ...
    it('should have the property serialNumber (base name: "serial-number")', function() {
