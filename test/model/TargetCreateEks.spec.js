...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateEks();
  });
  ...
  describe('TargetCreateEks', function() {
    it('should create an instance of TargetCreateEks', function() {
      // uncomment below and update the code to test TargetCreateEks
      //var instane = new akeyless.TargetCreateEks();
      //expect(instance).to.be.a(akeyless.TargetCreateEks);
    });
