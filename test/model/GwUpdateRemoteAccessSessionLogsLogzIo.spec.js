...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsLogzIo();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsLogzIo', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsLogzIo', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsLogzIo
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsLogzIo();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsLogzIo);
    });
    ...
    it('should have the property logzIoToken (base name: "logz-io-token")', function() {
      // uncomment below and update the code to test the property logzIoToken
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsLogzIo();
      //expect(instance).to.be();
    });
