...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdatePostgresql();
  });
  ...
  describe('RotatedSecretUpdatePostgresql', function() {
    it('should create an instance of RotatedSecretUpdatePostgresql', function() {
      // uncomment below and update the code to test RotatedSecretUpdatePostgresql
      //var instane = new akeyless.RotatedSecretUpdatePostgresql();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdatePostgresql);
    });
