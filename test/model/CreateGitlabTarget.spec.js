...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateGitlabTarget();
  });
  ...
  describe('CreateGitlabTarget', function() {
    it('should create an instance of CreateGitlabTarget', function() {
      // uncomment below and update the code to test CreateGitlabTarget
      //var instane = new akeyless.CreateGitlabTarget();
      //expect(instance).to.be.a(akeyless.CreateGitlabTarget);
    });
