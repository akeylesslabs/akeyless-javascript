...
(function(root, factory) {
  ...
  describe('SetItemState', function() {
    it('should create an instance of SetItemState', function() {
      // uncomment below and update the code to test SetItemState
      //var instane = new akl.SetItemState();
      //expect(instance).to.be.a(akl.SetItemState);
    });

    it('should have the property desiredState (base name: "desired-state")', function() {
