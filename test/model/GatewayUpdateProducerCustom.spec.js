...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerCustom();
  });
  ...
  describe('GatewayUpdateProducerCustom', function() {
    it('should create an instance of GatewayUpdateProducerCustom', function() {
      // uncomment below and update the code to test GatewayUpdateProducerCustom
      //var instane = new akeyless.GatewayUpdateProducerCustom();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerCustom);
    });
