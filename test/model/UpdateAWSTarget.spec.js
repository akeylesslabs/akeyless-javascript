...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateAWSTarget();
  });
  ...
  describe('UpdateAWSTarget', function() {
    it('should create an instance of UpdateAWSTarget', function() {
      // uncomment below and update the code to test UpdateAWSTarget
      //var instane = new akeyless.UpdateAWSTarget();
      //expect(instance).to.be.a(akeyless.UpdateAWSTarget);
    });
