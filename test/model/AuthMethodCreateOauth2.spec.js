...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateOauth2();
  });
  ...
  describe('AuthMethodCreateOauth2', function() {
    it('should create an instance of AuthMethodCreateOauth2', function() {
      // uncomment below and update the code to test AuthMethodCreateOauth2
      //var instane = new akeyless.AuthMethodCreateOauth2();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateOauth2);
    });
