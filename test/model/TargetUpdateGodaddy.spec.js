...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGodaddy();
  });
  ...
  describe('TargetUpdateGodaddy', function() {
    it('should create an instance of TargetUpdateGodaddy', function() {
      // uncomment below and update the code to test TargetUpdateGodaddy
      //var instane = new akeyless.TargetUpdateGodaddy();
      //expect(instance).to.be.a(akeyless.TargetUpdateGodaddy);
    });
