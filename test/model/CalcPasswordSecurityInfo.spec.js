...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CalcPasswordSecurityInfo();
  });
  ...
  describe('CalcPasswordSecurityInfo', function() {
    it('should create an instance of CalcPasswordSecurityInfo', function() {
      // uncomment below and update the code to test CalcPasswordSecurityInfo
      //var instance = new akeyless.CalcPasswordSecurityInfo();
      //expect(instance).to.be.a(akeyless.CalcPasswordSecurityInfo);
    });
