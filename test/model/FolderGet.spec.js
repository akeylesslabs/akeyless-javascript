...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.FolderGet();
  });
  ...
  describe('FolderGet', function() {
    it('should create an instance of FolderGet', function() {
      // uncomment below and update the code to test FolderGet
      //var instance = new akeyless.FolderGet();
      //expect(instance).to.be.a(akeyless.FolderGet);
    });
