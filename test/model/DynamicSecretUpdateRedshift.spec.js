...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateRedshift();
  });
  ...
  describe('DynamicSecretUpdateRedshift', function() {
    it('should create an instance of DynamicSecretUpdateRedshift', function() {
      // uncomment below and update the code to test DynamicSecretUpdateRedshift
      //var instane = new akeyless.DynamicSecretUpdateRedshift();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateRedshift);
    });
