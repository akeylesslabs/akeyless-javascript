...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateAllowedAccess();
  });
  ...
  describe('GatewayCreateAllowedAccess', function() {
    it('should create an instance of GatewayCreateAllowedAccess', function() {
      // uncomment below and update the code to test GatewayCreateAllowedAccess
      //var instane = new akeyless.GatewayCreateAllowedAccess();
      //expect(instance).to.be.a(akeyless.GatewayCreateAllowedAccess);
    });
