...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateGoogleWorkspace();
  });
  ...
  describe('DynamicSecretUpdateGoogleWorkspace', function() {
    it('should create an instance of DynamicSecretUpdateGoogleWorkspace', function() {
      // uncomment below and update the code to test DynamicSecretUpdateGoogleWorkspace
      //var instane = new akeyless.DynamicSecretUpdateGoogleWorkspace();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateGoogleWorkspace);
    });
