...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateSsh();
  });
  ...
  describe('TargetCreateSsh', function() {
    it('should create an instance of TargetCreateSsh', function() {
      // uncomment below and update the code to test TargetCreateSsh
      //var instane = new akeyless.TargetCreateSsh();
      //expect(instance).to.be.a(akeyless.TargetCreateSsh);
    });
