...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretCreateCustom();
  });
  ...
  describe('DynamicSecretCreateCustom', function() {
    it('should create an instance of DynamicSecretCreateCustom', function() {
      // uncomment below and update the code to test DynamicSecretCreateCustom
      //var instane = new akeyless.DynamicSecretCreateCustom();
      //expect(instance).to.be.a(akeyless.DynamicSecretCreateCustom);
    });
