...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateAnthropic();
  });
  ...
  describe('TargetCreateAnthropic', function() {
    it('should create an instance of TargetCreateAnthropic', function() {
      // uncomment below and update the code to test TargetCreateAnthropic
      //var instance = new akeyless.TargetCreateAnthropic();
      //expect(instance).to.be.a(akeyless.TargetCreateAnthropic);
    });
