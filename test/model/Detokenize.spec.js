...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.Detokenize();
  });
  ...
  describe('Detokenize', function() {
    it('should create an instance of Detokenize', function() {
      // uncomment below and update the code to test Detokenize
      //var instane = new akeyless.Detokenize();
      //expect(instance).to.be.a(akeyless.Detokenize);
    });
