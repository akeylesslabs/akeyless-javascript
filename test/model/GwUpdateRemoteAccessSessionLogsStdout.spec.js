...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsStdout();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsStdout', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsStdout', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsStdout
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsStdout();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsStdout);
    });
