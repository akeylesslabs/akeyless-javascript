...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateBedrock();
  });
  ...
  describe('TargetUpdateBedrock', function() {
    it('should create an instance of TargetUpdateBedrock', function() {
      // uncomment below and update the code to test TargetUpdateBedrock
      //var instance = new akeyless.TargetUpdateBedrock();
      //expect(instance).to.be.a(akeyless.TargetUpdateBedrock);
    });
    ...
    it('should have the property bedrockUrl (base name: "bedrock-url")', function() {
      // uncomment below and update the code to test the property bedrockUrl
      //var instance = new akeyless.TargetUpdateBedrock();
      //expect(instance).to.be();
    });
