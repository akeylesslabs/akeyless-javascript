...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateProducerMySQL();
  });
  ...
  describe('GatewayUpdateProducerMySQL', function() {
    it('should create an instance of GatewayUpdateProducerMySQL', function() {
      // uncomment below and update the code to test GatewayUpdateProducerMySQL
      //var instane = new akeyless.GatewayUpdateProducerMySQL();
      //expect(instance).to.be.a(akeyless.GatewayUpdateProducerMySQL);
    });
