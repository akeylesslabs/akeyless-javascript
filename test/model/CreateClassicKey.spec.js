...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateClassicKey();
  });
  ...
  describe('CreateClassicKey', function() {
    it('should create an instance of CreateClassicKey', function() {
      // uncomment below and update the code to test CreateClassicKey
      //var instane = new akeyless.CreateClassicKey();
      //expect(instance).to.be.a(akeyless.CreateClassicKey);
    });
