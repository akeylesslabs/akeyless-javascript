...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ListGroups();
  });
  ...
  describe('ListGroups', function() {
    it('should create an instance of ListGroups', function() {
      // uncomment below and update the code to test ListGroups
      //var instane = new akeyless.ListGroups();
      //expect(instance).to.be.a(akeyless.ListGroups);
    });
