...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.LdapConfigPart();
  });
  ...
  describe('LdapConfigPart', function() {
    it('should create an instance of LdapConfigPart', function() {
      // uncomment below and update the code to test LdapConfigPart
      //var instane = new akeyless.LdapConfigPart();
      //expect(instance).to.be.a(akeyless.LdapConfigPart);
    });
