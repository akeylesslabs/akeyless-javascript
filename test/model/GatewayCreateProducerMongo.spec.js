...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayCreateProducerMongo();
  });
  ...
  describe('GatewayCreateProducerMongo', function() {
    it('should create an instance of GatewayCreateProducerMongo', function() {
      // uncomment below and update the code to test GatewayCreateProducerMongo
      //var instane = new akeyless.GatewayCreateProducerMongo();
      //expect(instance).to.be.a(akeyless.GatewayCreateProducerMongo);
    });
