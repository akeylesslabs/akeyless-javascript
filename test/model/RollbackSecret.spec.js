...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.RollbackSecret();
  });
  ...
  describe('RollbackSecret', function() {
    it('should create an instance of RollbackSecret', function() {
      // uncomment below and update the code to test RollbackSecret
      //var instane = new akl.RollbackSecret();
      //expect(instance).to.be.a(akl.RollbackSecret);
    });
    ...
    it('should have the property oldVersion (base name: "old-version")', function() {
      // uncomment below and update the code to test the property oldVersion
      //var instane = new akl.RollbackSecret();
      //expect(instance).to.be();
    });
