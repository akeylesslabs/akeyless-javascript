...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GatewayUpdateItem();
  });
  ...
  describe('GatewayUpdateItem', function() {
    it('should create an instance of GatewayUpdateItem', function() {
      // uncomment below and update the code to test GatewayUpdateItem
      //var instane = new akeyless.GatewayUpdateItem();
      //expect(instance).to.be.a(akeyless.GatewayUpdateItem);
    });
    ...
    it('should have the property rotatorCredsType (base name: "rotator-creds-type")', function() {
