...
(function(root, factory) {
  ...
  describe('SetRoleRule', function() {
    it('should create an instance of SetRoleRule', function() {
      // uncomment below and update the code to test SetRoleRule
      //var instane = new akl.SetRoleRule();
      //expect(instance).to.be.a(akl.SetRoleRule);
    });
    ...
    it('should have the property ruleType (base name: "rule-type")', function() {
