...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateOpenAI();
  });
  ...
  describe('TargetCreateOpenAI', function() {
    it('should create an instance of TargetCreateOpenAI', function() {
      // uncomment below and update the code to test TargetCreateOpenAI
      //var instance = new akeyless.TargetCreateOpenAI();
      //expect(instance).to.be.a(akeyless.TargetCreateOpenAI);
    });
