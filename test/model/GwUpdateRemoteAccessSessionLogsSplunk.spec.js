...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.GwUpdateRemoteAccessSessionLogsSplunk();
  });
  ...
  describe('GwUpdateRemoteAccessSessionLogsSplunk', function() {
    it('should create an instance of GwUpdateRemoteAccessSessionLogsSplunk', function() {
      // uncomment below and update the code to test GwUpdateRemoteAccessSessionLogsSplunk
      //var instane = new akeyless.GwUpdateRemoteAccessSessionLogsSplunk();
      //expect(instance).to.be.a(akeyless.GwUpdateRemoteAccessSessionLogsSplunk);
    });
    ...
    it('should have the property sourceType (base name: "source-type")', function() {
    ...
    it('should have the property splunkUrl (base name: "splunk-url")', function() {
