...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.ListGateways();
  });
  ...
  describe('ListGateways', function() {
    it('should create an instance of ListGateways', function() {
      // uncomment below and update the code to test ListGateways
      //var instane = new akeyless.ListGateways();
      //expect(instance).to.be.a(akeyless.ListGateways);
    });
