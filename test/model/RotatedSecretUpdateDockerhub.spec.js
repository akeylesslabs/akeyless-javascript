...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateDockerhub();
  });
  ...
  describe('RotatedSecretUpdateDockerhub', function() {
    it('should create an instance of RotatedSecretUpdateDockerhub', function() {
      // uncomment below and update the code to test RotatedSecretUpdateDockerhub
      //var instane = new akeyless.RotatedSecretUpdateDockerhub();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateDockerhub);
    });
