...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateSplunk();
  });
  ...
  describe('RotatedSecretUpdateSplunk', function() {
    it('should create an instance of RotatedSecretUpdateSplunk', function() {
      // uncomment below and update the code to test RotatedSecretUpdateSplunk
      //var instance = new akeyless.RotatedSecretUpdateSplunk();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateSplunk);
    });
