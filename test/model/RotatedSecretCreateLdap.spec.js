...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretCreateLdap();
  });
  ...
  describe('RotatedSecretCreateLdap', function() {
    it('should create an instance of RotatedSecretCreateLdap', function() {
      // uncomment below and update the code to test RotatedSecretCreateLdap
      //var instane = new akeyless.RotatedSecretCreateLdap();
      //expect(instance).to.be.a(akeyless.RotatedSecretCreateLdap);
    });
    ...
    it('should have the property hostProvider (base name: "host-provider")', function() {
      // uncomment below and update the code to test the property hostProvider
      //var instane = new akeyless.RotatedSecretCreateLdap();
      //expect(instance).to.be();
    });
