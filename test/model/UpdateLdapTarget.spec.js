...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateLdapTarget();
  });
  ...
  describe('UpdateLdapTarget', function() {
    it('should create an instance of UpdateLdapTarget', function() {
      // uncomment below and update the code to test UpdateLdapTarget
      //var instane = new akeyless.UpdateLdapTarget();
      //expect(instance).to.be.a(akeyless.UpdateLdapTarget);
    });
