...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.DynamicSecretUpdateEks();
  });
  ...
  describe('DynamicSecretUpdateEks', function() {
    it('should create an instance of DynamicSecretUpdateEks', function() {
      // uncomment below and update the code to test DynamicSecretUpdateEks
      //var instane = new akeyless.DynamicSecretUpdateEks();
      //expect(instance).to.be.a(akeyless.DynamicSecretUpdateEks);
    });
