...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.AuthMethodCreateKerberos();
  });
  ...
  describe('AuthMethodCreateKerberos', function() {
    it('should create an instance of AuthMethodCreateKerberos', function() {
      // uncomment below and update the code to test AuthMethodCreateKerberos
      //var instane = new akeyless.AuthMethodCreateKerberos();
      //expect(instance).to.be.a(akeyless.AuthMethodCreateKerberos);
    });
