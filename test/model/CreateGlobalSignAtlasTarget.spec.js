...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.CreateGlobalSignAtlasTarget();
  });
  ...
  describe('CreateGlobalSignAtlasTarget', function() {
    it('should create an instance of CreateGlobalSignAtlasTarget', function() {
      // uncomment below and update the code to test CreateGlobalSignAtlasTarget
      //var instane = new akeyless.CreateGlobalSignAtlasTarget();
      //expect(instance).to.be.a(akeyless.CreateGlobalSignAtlasTarget);
    });
