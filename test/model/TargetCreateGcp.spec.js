...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateGcp();
  });
  ...
  describe('TargetCreateGcp', function() {
    it('should create an instance of TargetCreateGcp', function() {
      // uncomment below and update the code to test TargetCreateGcp
      //var instane = new akeyless.TargetCreateGcp();
      //expect(instance).to.be.a(akeyless.TargetCreateGcp);
    });
