...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateWeb();
  });
  ...
  describe('TargetCreateWeb', function() {
    it('should create an instance of TargetCreateWeb', function() {
      // uncomment below and update the code to test TargetCreateWeb
      //var instane = new akeyless.TargetCreateWeb();
      //expect(instance).to.be.a(akeyless.TargetCreateWeb);
    });
