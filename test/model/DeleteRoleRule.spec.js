...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akl.DeleteRoleRule();
  });
  ...
  describe('DeleteRoleRule', function() {
    it('should create an instance of DeleteRoleRule', function() {
      // uncomment below and update the code to test DeleteRoleRule
      //var instane = new akl.DeleteRoleRule();
      //expect(instance).to.be.a(akl.DeleteRoleRule);
    });
