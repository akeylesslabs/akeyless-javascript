...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGcp();
  });
  ...
  describe('TargetUpdateGcp', function() {
    it('should create an instance of TargetUpdateGcp', function() {
      // uncomment below and update the code to test TargetUpdateGcp
      //var instane = new akeyless.TargetUpdateGcp();
      //expect(instance).to.be.a(akeyless.TargetUpdateGcp);
    });
