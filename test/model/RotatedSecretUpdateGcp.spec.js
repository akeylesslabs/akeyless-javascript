...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.RotatedSecretUpdateGcp();
  });
  ...
  describe('RotatedSecretUpdateGcp', function() {
    it('should create an instance of RotatedSecretUpdateGcp', function() {
      // uncomment below and update the code to test RotatedSecretUpdateGcp
      //var instane = new akeyless.RotatedSecretUpdateGcp();
      //expect(instance).to.be.a(akeyless.RotatedSecretUpdateGcp);
    });
