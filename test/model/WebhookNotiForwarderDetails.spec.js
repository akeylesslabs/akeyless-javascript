...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.WebhookNotiForwarderDetails();
  });
  ...
  describe('WebhookNotiForwarderDetails', function() {
    it('should create an instance of WebhookNotiForwarderDetails', function() {
      // uncomment below and update the code to test WebhookNotiForwarderDetails
      //var instance = new akeyless.WebhookNotiForwarderDetails();
      //expect(instance).to.be.a(akeyless.WebhookNotiForwarderDetails);
    });
