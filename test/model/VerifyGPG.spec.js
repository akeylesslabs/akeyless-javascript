...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.VerifyGPG();
  });
  ...
  describe('VerifyGPG', function() {
    it('should create an instance of VerifyGPG', function() {
      // uncomment below and update the code to test VerifyGPG
      //var instane = new akeyless.VerifyGPG();
      //expect(instance).to.be.a(akeyless.VerifyGPG);
    });
