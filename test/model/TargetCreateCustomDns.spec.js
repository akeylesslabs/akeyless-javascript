...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateCustomDns();
  });
  ...
  describe('TargetCreateCustomDns', function() {
    it('should create an instance of TargetCreateCustomDns', function() {
      // uncomment below and update the code to test TargetCreateCustomDns
      //var instance = new akeyless.TargetCreateCustomDns();
      //expect(instance).to.be.a(akeyless.TargetCreateCustomDns);
    });
