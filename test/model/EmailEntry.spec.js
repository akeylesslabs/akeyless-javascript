...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.EmailEntry();
  });
  ...
  describe('EmailEntry', function() {
    it('should create an instance of EmailEntry', function() {
      // uncomment below and update the code to test EmailEntry
      //var instane = new akeyless.EmailEntry();
      //expect(instance).to.be.a(akeyless.EmailEntry);
    });
