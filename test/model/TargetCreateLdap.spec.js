...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetCreateLdap();
  });
  ...
  describe('TargetCreateLdap', function() {
    it('should create an instance of TargetCreateLdap', function() {
      // uncomment below and update the code to test TargetCreateLdap
      //var instane = new akeyless.TargetCreateLdap();
      //expect(instance).to.be.a(akeyless.TargetCreateLdap);
    });
