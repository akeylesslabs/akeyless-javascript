...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.UpdateRotatedSecret();
  });
  ...
  describe('UpdateRotatedSecret', function() {
    it('should create an instance of UpdateRotatedSecret', function() {
      // uncomment below and update the code to test UpdateRotatedSecret
      //var instane = new akeyless.UpdateRotatedSecret();
      //expect(instance).to.be.a(akeyless.UpdateRotatedSecret);
    });
