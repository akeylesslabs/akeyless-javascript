...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.TargetUpdateGlobalSign();
  });
  ...
  describe('TargetUpdateGlobalSign', function() {
    it('should create an instance of TargetUpdateGlobalSign', function() {
      // uncomment below and update the code to test TargetUpdateGlobalSign
      //var instane = new akeyless.TargetUpdateGlobalSign();
      //expect(instance).to.be.a(akeyless.TargetUpdateGlobalSign);
    });
