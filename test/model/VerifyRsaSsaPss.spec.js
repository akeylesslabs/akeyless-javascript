...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new akeyless.VerifyRsaSsaPss();
  });
  ...
  describe('VerifyRsaSsaPss', function() {
    it('should create an instance of VerifyRsaSsaPss', function() {
      // uncomment below and update the code to test VerifyRsaSsaPss
      //var instane = new akeyless.VerifyRsaSsaPss();
      //expect(instance).to.be.a(akeyless.VerifyRsaSsaPss);
    });
