...
(function(root, factory) {
  ...
  describe('ReverseRBAC', function() {
    it('should create an instance of ReverseRBAC', function() {
      // uncomment below and update the code to test ReverseRBAC
      //var instane = new akl.ReverseRBAC();
      //expect(instance).to.be.a(akl.ReverseRBAC);
    });
