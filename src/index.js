...
* <pre>
* var akl = require('index'); // See note below*.
* var xxxSvc = new akl.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new akl.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new akl.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new akl.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
