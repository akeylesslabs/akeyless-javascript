...
class DynamicSecretUpdateGithub {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateGithub</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateGithub</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateGithub.RequiredProperties) {
 ...
 */
DynamicSecretUpdateGithub.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateGithub.prototype['enable-ai-quorum'] = undefined;
 ...
 */
DynamicSecretUpdateGithub.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretUpdateGithub.prototype['item-custom-fields'] = undefined;
 ...
 */
DynamicSecretUpdateGithub.prototype['skip-dry-run'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretUpdateGithub.prototype['token-ttl'] = '60m';
