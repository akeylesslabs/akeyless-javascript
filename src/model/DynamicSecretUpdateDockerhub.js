 ...
 */
DynamicSecretUpdateDockerhub.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretUpdateDockerhub.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateDockerhub.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretUpdateDockerhub.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretUpdateDockerhub.prototype['output-rule'] = undefined;
