...
class CreateDockerhubTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDockerhubTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDockerhubTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDockerhubTarget.RequiredProperties) {
...
CreateDockerhubTarget.RequiredProperties = ["name"];
 ...
 */
CreateDockerhubTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateDockerhubTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateDockerhubTarget.prototype['rotate-on-unlock'] = undefined;
