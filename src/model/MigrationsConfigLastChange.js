...
class MigrationsConfigLastChange {
    ...
    /**
     * Validates the JSON data with respect to <code>MigrationsConfigLastChange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MigrationsConfigLastChange</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['changed_migrations'])) {
            throw new Error("Expected the field `changed_migrations` to be an array in the JSON data but got " + data['changed_migrations']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['created_migrations'])) {
            throw new Error("Expected the field `created_migrations` to be an array in the JSON data but got " + data['created_migrations']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['deleted_migrations'])) {
            throw new Error("Expected the field `deleted_migrations` to be an array in the JSON data but got " + data['deleted_migrations']);
        }
