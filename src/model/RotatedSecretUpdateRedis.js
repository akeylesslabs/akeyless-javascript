...
class RotatedSecretUpdateRedis {
    /**
     * Constructs a new <code>RotatedSecretUpdateRedis</code>.
     * @alias module:model/RotatedSecretUpdateRedis
     * @param name {String} Rotated secret name
     */
    constructor(name) { 
        
        RotatedSecretUpdateRedis.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretUpdateRedis</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretUpdateRedis} obj Optional instance to populate.
     * @return {module:model/RotatedSecretUpdateRedis} The populated <code>RotatedSecretUpdateRedis</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretUpdateRedis();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretUpdateRedis</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretUpdateRedis</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretUpdateRedis.RequiredProperties) {
...
RotatedSecretUpdateRedis.RequiredProperties = ["name"];

/**
 * List of the new tags that will be attached to this item
 * @member {Array.<String>} add-tag
 */
RotatedSecretUpdateRedis.prototype['add-tag'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['delete_protection'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretUpdateRedis.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretUpdateRedis.prototype['input-rule'] = undefined;
 ...
 * @default false
 */
RotatedSecretUpdateRedis.prototype['json'] = false;
 ...
 */
RotatedSecretUpdateRedis.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretUpdateRedis.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretUpdateRedis.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretUpdateRedis.prototype['name'] = undefined;

/**
 * New item name
 * @member {String} new-name
 */
RotatedSecretUpdateRedis.prototype['new-name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretUpdateRedis.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretUpdateRedis.prototype['password-length'] = undefined;

/**
 * List of the existent tags that will be removed from this item
 * @member {Array.<String>} rm-tag
 */
RotatedSecretUpdateRedis.prototype['rm-tag'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretUpdateRedis.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretUpdateRedis.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretUpdateRedis.prototype['rotated-username'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['skip_dry_run'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
RotatedSecretUpdateRedis.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretUpdateRedis.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretUpdateRedis.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretUpdateRedis.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretUpdateRedis;
