...
class CreateWindowsTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWindowsTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWindowsTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWindowsTarget.RequiredProperties) {
...
CreateWindowsTarget.RequiredProperties = ["hostname", "name", "password", "username"];
 ...
 * @default 'credentials'
 */
CreateWindowsTarget.prototype['connection-type'] = 'credentials';
 ...
 */
CreateWindowsTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateWindowsTarget.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
CreateWindowsTarget.prototype['max-versions'] = undefined;
 ...
 */
CreateWindowsTarget.prototype['parent-target-name'] = undefined;
 ...
 * @default 'dummy_value'
 */
CreateWindowsTarget.prototype['password'] = 'dummy_value';
 ...
 */
CreateWindowsTarget.prototype['rotate-on-unlock'] = undefined;
 ...
 * @default 'dummy_value'
 */
CreateWindowsTarget.prototype['username'] = 'dummy_value';
