...
class LastStatusInfo {
    ...
    /**
     * Validates the JSON data with respect to <code>LastStatusInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LastStatusInfo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `migrations_status`
        if (data['migrations_status']) { // data not null
          MigrationStatus.validateJSON(data['migrations_status']);
        }
