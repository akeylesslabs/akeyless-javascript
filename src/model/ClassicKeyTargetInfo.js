...
class ClassicKeyTargetInfo {
    ...
    /**
     * Validates the JSON data with respect to <code>ClassicKeyTargetInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClassicKeyTargetInfo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `external_kms_id`
        if (data['external_kms_id']) { // data not null
          ExternalKMSKeyId.validateJSON(data['external_kms_id']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['key_purpose'])) {
            throw new Error("Expected the field `key_purpose` to be an array in the JSON data but got " + data['key_purpose']);
        }
        // validate the optional field `key_status`
        if (data['key_status']) { // data not null
          ClassicKeyStatusInfo.validateJSON(data['key_status']);
        }
        // ensure the json data is a string
        if (data['target_assoc_id'] && !(typeof data['target_assoc_id'] === 'string' || data['target_assoc_id'] instanceof String)) {
            throw new Error("Expected the field `target_assoc_id` to be a primitive type in the JSON string but got " + data['target_assoc_id']);
        }
        // ensure the json data is a string
