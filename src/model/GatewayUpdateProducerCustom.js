...
class GatewayUpdateProducerCustom {
    /**
     * Constructs a new <code>GatewayUpdateProducerCustom</code>.
     ...
     * @alias module:model/GatewayUpdateProducerCustom
    ...
    constructor(createSyncUrl, name, revokeSyncUrl) { 
        ...
        GatewayUpdateProducerCustom.initialize(this, createSyncUrl, name, revokeSyncUrl);
    }
    ...
    /**
     * Constructs a <code>GatewayUpdateProducerCustom</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GatewayUpdateProducerCustom} obj Optional instance to populate.
     * @return {module:model/GatewayUpdateProducerCustom} The populated <code>GatewayUpdateProducerCustom</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayUpdateProducerCustom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayUpdateProducerCustom</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayUpdateProducerCustom.RequiredProperties) {
...
GatewayUpdateProducerCustom.RequiredProperties = ["create-sync-url", "name", "revoke-sync-url"];

/**
 * Define rotation interval in days
 * @member {Number} admin-rotation-interval-days
 */
GatewayUpdateProducerCustom.prototype['admin-rotation-interval-days'] = undefined;

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
GatewayUpdateProducerCustom.prototype['ara-enabled'] = undefined;
 ...
 */
GatewayUpdateProducerCustom.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
GatewayUpdateProducerCustom.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
GatewayUpdateProducerCustom.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
GatewayUpdateProducerCustom.prototype['name'] = undefined;

/**
 * Dynamic secret name
 * @member {String} new-name
 */
GatewayUpdateProducerCustom.prototype['new-name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
GatewayUpdateProducerCustom.prototype['output-rule'] = undefined;

/**
 * Secret payload to be sent with each create/revoke webhook request
 * @member {String} payload
 */
GatewayUpdateProducerCustom.prototype['payload'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key-name
 */
GatewayUpdateProducerCustom.prototype['producer-encryption-key-name'] = undefined;
 ...
 */
GatewayUpdateProducerCustom.prototype['revoke-sync-url'] = undefined;
 ...
 */
GatewayUpdateProducerCustom.prototype['skip_dry_run'] = undefined;
 ...
 * @default 60
 */
GatewayUpdateProducerCustom.prototype['timeout-sec'] = 60;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
GatewayUpdateProducerCustom.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
GatewayUpdateProducerCustom.prototype['uid-token'] = undefined;
 ...
 * @default '60m'
 */
GatewayUpdateProducerCustom.prototype['user-ttl'] = '60m';
...
export default GatewayUpdateProducerCustom;
