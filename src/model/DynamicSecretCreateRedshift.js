...
class DynamicSecretCreateRedshift {
    /**
     * Constructs a new <code>DynamicSecretCreateRedshift</code>.
     * dynamicSecretCreateRedshift is a command that creates redshift dynamic secret
     * @alias module:model/DynamicSecretCreateRedshift
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretCreateRedshift.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretCreateRedshift</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretCreateRedshift} obj Optional instance to populate.
     * @return {module:model/DynamicSecretCreateRedshift} The populated <code>DynamicSecretCreateRedshift</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretCreateRedshift();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateRedshift</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateRedshift</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateRedshift.RequiredProperties) {
...
DynamicSecretCreateRedshift.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateRedshift.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretCreateRedshift.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretCreateRedshift.prototype['description'] = undefined;
 ...
 */
DynamicSecretCreateRedshift.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateRedshift.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateRedshift.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreateRedshift.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateRedshift.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretCreateRedshift.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretCreateRedshift.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
DynamicSecretCreateRedshift.prototype['password-length'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key
 */
DynamicSecretCreateRedshift.prototype['producer-encryption-key'] = undefined;

/**
 * Redshift DB Name
 * @member {String} redshift-db-name
 */
DynamicSecretCreateRedshift.prototype['redshift-db-name'] = undefined;
 ...
 * @default '127.0.0.1'
 */
DynamicSecretCreateRedshift.prototype['redshift-host'] = '127.0.0.1';

/**
 * Redshift Password
 * @member {String} redshift-password
 */
DynamicSecretCreateRedshift.prototype['redshift-password'] = undefined;
 ...
 * @default '5439'
 */
DynamicSecretCreateRedshift.prototype['redshift-port'] = '5439';

/**
 * Redshift Username
 * @member {String} redshift-username
 */
DynamicSecretCreateRedshift.prototype['redshift-username'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
DynamicSecretCreateRedshift.prototype['secure-access-enable'] = undefined;

/**
 * Target DB servers for connections (In case of Linked Target association, host(s) will inherit Linked Target hosts)
 * @member {Array.<String>} secure-access-host
 */
DynamicSecretCreateRedshift.prototype['secure-access-host'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
DynamicSecretCreateRedshift.prototype['skip_dry_run'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateRedshift.prototype['ssl'] = false;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretCreateRedshift.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretCreateRedshift.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretCreateRedshift.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretCreateRedshift.prototype['uid-token'] = undefined;
 ...
 */
DynamicSecretCreateRedshift.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretCreateRedshift.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretCreateRedshift.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretCreateRedshift.prototype['use-special-characters'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretCreateRedshift.prototype['user-ttl'] = '60m';
...
export default DynamicSecretCreateRedshift;
