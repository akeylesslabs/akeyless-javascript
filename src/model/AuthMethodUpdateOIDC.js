...
class AuthMethodUpdateOIDC {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodUpdateOIDC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodUpdateOIDC</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodUpdateOIDC.RequiredProperties) {
...
AuthMethodUpdateOIDC.RequiredProperties = ["name", "unique-identifier"];
 ...
 */
AuthMethodUpdateOIDC.prototype['allowed-client-type'] = undefined;
 ...
 */
AuthMethodUpdateOIDC.prototype['expiration-event-in'] = undefined;
 ...
 */
AuthMethodUpdateOIDC.prototype['gateway-url'] = undefined;
