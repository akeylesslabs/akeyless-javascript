...
class UpdateDockerhubTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDockerhubTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDockerhubTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateDockerhubTarget.RequiredProperties) {
...
UpdateDockerhubTarget.RequiredProperties = ["name"];
 ...
 */
UpdateDockerhubTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
UpdateDockerhubTarget.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
UpdateDockerhubTarget.prototype['max-versions'] = undefined;
 ...
 */
UpdateDockerhubTarget.prototype['rotate-on-unlock'] = undefined;
