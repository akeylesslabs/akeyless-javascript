...
class ReverseRBACClient {
    ...
    /**
     * Validates the JSON data with respect to <code>ReverseRBACClient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReverseRBACClient</code>.
     */
    static validateJSON(data) {
        if (data['assocs']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['assocs'])) {
                throw new Error("Expected the field `assocs` to be an array in the JSON data but got " + data['assocs']);
            }
            // validate the optional field `assocs` (array)
            for (const item of data['assocs']) {
