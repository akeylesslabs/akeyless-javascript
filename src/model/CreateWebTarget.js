...
class CreateWebTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateWebTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateWebTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateWebTarget.RequiredProperties) {
...
CreateWebTarget.RequiredProperties = ["name"];
 ...
 */
CreateWebTarget.prototype['description'] = undefined;
 ...
 */
CreateWebTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateWebTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateWebTarget.prototype['rotate-on-unlock'] = undefined;
