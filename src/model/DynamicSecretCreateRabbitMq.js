...
/**
 * The DynamicSecretCreateRabbitMq model module.
 * @module model/DynamicSecretCreateRabbitMq
 * @version 5.0.37
 */
class DynamicSecretCreateRabbitMq {
    /**
     * Constructs a new <code>DynamicSecretCreateRabbitMq</code>.
     * dynamicSecretCreateRabbitMq is a command that creates rabbitmq dynamic secret
     * @alias module:model/DynamicSecretCreateRabbitMq
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretCreateRabbitMq.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretCreateRabbitMq</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretCreateRabbitMq} obj Optional instance to populate.
     * @return {module:model/DynamicSecretCreateRabbitMq} The populated <code>DynamicSecretCreateRabbitMq</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretCreateRabbitMq();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateRabbitMq</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateRabbitMq</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateRabbitMq.RequiredProperties) {
...
DynamicSecretCreateRabbitMq.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateRabbitMq.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretCreateRabbitMq.prototype['description'] = undefined;
 ...
 */
DynamicSecretCreateRabbitMq.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateRabbitMq.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateRabbitMq.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreateRabbitMq.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateRabbitMq.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretCreateRabbitMq.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretCreateRabbitMq.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
DynamicSecretCreateRabbitMq.prototype['password-length'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key-name
 */
DynamicSecretCreateRabbitMq.prototype['producer-encryption-key-name'] = undefined;

/**
 * RabbitMQ Admin password
 * @member {String} rabbitmq-admin-pwd
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-admin-pwd'] = undefined;

/**
 * RabbitMQ Admin User
 * @member {String} rabbitmq-admin-user
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-admin-user'] = undefined;

/**
 * Server URI
 * @member {String} rabbitmq-server-uri
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-server-uri'] = undefined;

/**
 * User configuration permission
 * @member {String} rabbitmq-user-conf-permission
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-user-conf-permission'] = undefined;

/**
 * User read permission
 * @member {String} rabbitmq-user-read-permission
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-user-read-permission'] = undefined;

/**
 * User Tags
 * @member {String} rabbitmq-user-tags
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-user-tags'] = undefined;

/**
 * User Virtual Host
 * @member {String} rabbitmq-user-vhost
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-user-vhost'] = undefined;

/**
 * User write permission
 * @member {String} rabbitmq-user-write-permission
 */
DynamicSecretCreateRabbitMq.prototype['rabbitmq-user-write-permission'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
DynamicSecretCreateRabbitMq.prototype['secure-access-enable'] = undefined;

/**
 * Destination URL to inject secrets
 * @member {String} secure-access-url
 */
DynamicSecretCreateRabbitMq.prototype['secure-access-url'] = undefined;
 ...
 * @default true
 */
DynamicSecretCreateRabbitMq.prototype['secure-access-web'] = true;
 ...
 * @default false
 */
DynamicSecretCreateRabbitMq.prototype['secure-access-web-browsing'] = false;
 ...
 * @default false
 */
DynamicSecretCreateRabbitMq.prototype['secure-access-web-proxy'] = false;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
DynamicSecretCreateRabbitMq.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretCreateRabbitMq.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretCreateRabbitMq.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretCreateRabbitMq.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretCreateRabbitMq.prototype['uid-token'] = undefined;
 ...
 */
DynamicSecretCreateRabbitMq.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretCreateRabbitMq.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretCreateRabbitMq.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretCreateRabbitMq.prototype['use-special-characters'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretCreateRabbitMq.prototype['user-ttl'] = '60m';
...
export default DynamicSecretCreateRabbitMq;
