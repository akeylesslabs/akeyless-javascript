...
class GatewayCreateProducerCustom {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayCreateProducerCustom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayCreateProducerCustom</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayCreateProducerCustom.RequiredProperties) {
...
GatewayCreateProducerCustom.RequiredProperties = ["create-sync-url", "name", "revoke-sync-url"];

/**
 * Define rotation interval in days
 * @member {Number} admin-rotation-interval-days
 */
GatewayCreateProducerCustom.prototype['admin-rotation-interval-days'] = undefined;

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
GatewayCreateProducerCustom.prototype['ara-enabled'] = undefined;
 ...
 * @default false
 */
GatewayCreateProducerCustom.prototype['enable-admin-rotation'] = false;
 ...
 */
GatewayCreateProducerCustom.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayCreateProducerCustom.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
GatewayCreateProducerCustom.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
GatewayCreateProducerCustom.prototype['item-custom-fields'] = undefined;
 ...
 */
GatewayCreateProducerCustom.prototype['output-rule'] = undefined;
