...
class RotatedSecretCreateOracledb {
    /**
     * Constructs a new <code>RotatedSecretCreateOracledb</code>.
    ...
    constructor(name, rotatorType, targetName) { 
        ...
        RotatedSecretCreateOracledb.initialize(this, name, rotatorType, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreateOracledb</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreateOracledb} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreateOracledb} The populated <code>RotatedSecretCreateOracledb</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretCreateOracledb();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreateOracledb</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreateOracledb</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreateOracledb.RequiredProperties) {
...
RotatedSecretCreateOracledb.RequiredProperties = ["name", "rotator-type", "target-name"];
 ...
 */
RotatedSecretCreateOracledb.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['authentication-credentials'] = 'use-user-creds';

/**
 * @member {String} auto-rotate
 */
RotatedSecretCreateOracledb.prototype['auto-rotate'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['description'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreateOracledb.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreateOracledb.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretCreateOracledb.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreateOracledb.prototype['json'] = false;

/**
 * @member {String} key
 */
RotatedSecretCreateOracledb.prototype['key'] = undefined;

/**
 * Lock this secret for read/update while an SRA session is active
 * @member {String} lock-during-sra-session
 */
RotatedSecretCreateOracledb.prototype['lock-during-sra-session'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretCreateOracledb.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreateOracledb.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretCreateOracledb.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretCreateOracledb.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreateOracledb.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreateOracledb.prototype['password-length'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['rotate-after-disconnect'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreateOracledb.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretCreateOracledb.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretCreateOracledb.prototype['rotated-username'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretCreateOracledb.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretCreateOracledb.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretCreateOracledb.prototype['rotation-interval'] = undefined;

/**
 * The rotator type. options: [target/password]
 * @member {String} rotator-type
 */
RotatedSecretCreateOracledb.prototype['rotator-type'] = undefined;

/**
 * The DB name (relevant only for DB Dynamic-Secret)
 * @member {String} secure-access-db-name
 */
RotatedSecretCreateOracledb.prototype['secure-access-db-name'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
RotatedSecretCreateOracledb.prototype['secure-access-enable'] = undefined;

/**
 * Target servers for connections (In case of Linked Target association, host(s) will inherit Linked Target hosts - Relevant only for Dynamic Secrets/producers)
 * @member {Array.<String>} secure-access-host
 */
RotatedSecretCreateOracledb.prototype['secure-access-host'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreateOracledb.prototype['secure-access-web'] = false;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretCreateOracledb.prototype['skip_dry_run'] = undefined;
 ...
 * @member {String} token
 */
RotatedSecretCreateOracledb.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreateOracledb.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreateOracledb.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreateOracledb.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreateOracledb;
