...
class SectigoTargetDetails {
    ...
    /**
     * Validates the JSON data with respect to <code>SectigoTargetDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SectigoTargetDetails</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['customer_uri'] && !(typeof data['customer_uri'] === 'string' || data['customer_uri'] instanceof String)) {
            throw new Error("Expected the field `customer_uri` to be a primitive type in the JSON string but got " + data['customer_uri']);
        }
        // ensure the json data is a string
        if (data['external_requester'] && !(typeof data['external_requester'] === 'string' || data['external_requester'] instanceof String)) {
            throw new Error("Expected the field `external_requester` to be a primitive type in the JSON string but got " + data['external_requester']);
        }
        // ensure the json data is a string
