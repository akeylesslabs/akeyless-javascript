...
class UniversalIdentityDetails {
    ...
    /**
     * Validates the JSON data with respect to <code>UniversalIdentityDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniversalIdentityDetails</code>.
     */
    static validateJSON(data) {
        // validate the optional field `root`
        if (data['root']) { // data not null
          UIDTokenDetails.validateJSON(data['root']);
        }
