...
class UscGetSecretOutput {
    ...
    /**
     * Validates the JSON data with respect to <code>UscGetSecretOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
 ...
 * @member {String} id
 */
UscGetSecretOutput.prototype['id'] = undefined;
 ...
 */
UscGetSecretOutput.prototype['version_id'] = undefined;

/**
 * @member {Array.<String>} version_ids
 */
UscGetSecretOutput.prototype['version_ids'] = undefined;

/**
 * @member {Array.<String>} warnings
 */
UscGetSecretOutput.prototype['warnings'] = undefined;
