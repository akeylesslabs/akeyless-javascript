...
class AuthMethodCreateEmail {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodCreateEmail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodCreateEmail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodCreateEmail.RequiredProperties) {
...
AuthMethodCreateEmail.RequiredProperties = ["email", "name"];
 ...
 */
AuthMethodCreateEmail.prototype['allowed-client-type'] = undefined;
 ...
 */
AuthMethodCreateEmail.prototype['enable-mfa'] = undefined;

/**
 * How many days before the expiration of the auth method would you like to be notified.
 * @member {Array.<String>} expiration-event-in
 */
AuthMethodCreateEmail.prototype['expiration-event-in'] = undefined;
 ...
 * @default 'email'
 */
AuthMethodCreateEmail.prototype['mfa-type'] = 'email';
