...
class TargetCreatePing {
    ...
    /**
     * Validates the JSON data with respect to <code>TargetCreatePing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetCreatePing</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetCreatePing.RequiredProperties) {
...
TargetCreatePing.RequiredProperties = ["name"];
 ...
 */
TargetCreatePing.prototype['delete_protection'] = undefined;
 ...
 */
TargetCreatePing.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetCreatePing.prototype['lock-ttl'] = undefined;
 ...
 */
TargetCreatePing.prototype['rotate-on-unlock'] = undefined;
