...
class GatewayCreateProducerCertificateAutomation {
     ...
     * @param venafiZone {String} Venafi Zone
     */
    constructor(name, venafiZone) { 
        
        GatewayCreateProducerCertificateAutomation.initialize(this, name, venafiZone);
    }
     ...
     */
    static initialize(obj, name, venafiZone) { 
        obj['name'] = name;
        obj['venafi-zone'] = venafiZone;
    }
