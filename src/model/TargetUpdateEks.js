...
class TargetUpdateEks {
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateEks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateEks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateEks.RequiredProperties) {
...
TargetUpdateEks.RequiredProperties = ["eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-secret-access-key", "name"];

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
TargetUpdateEks.prototype['delete_protection'] = undefined;
 ...
 */
TargetUpdateEks.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetUpdateEks.prototype['lock-ttl'] = undefined;
 ...
 */
TargetUpdateEks.prototype['rotate-on-unlock'] = undefined;
