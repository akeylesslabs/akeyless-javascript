...
class DynamicSecretUpdateGitlab {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateGitlab</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateGitlab</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateGitlab.RequiredProperties) {
...
DynamicSecretUpdateGitlab.RequiredProperties = ["gitlab-access-type", "gitlab-token-scopes", "name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretUpdateGitlab.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretUpdateGitlab.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateGitlab.prototype['enable-ai-quorum'] = undefined;
 ...
 */
DynamicSecretUpdateGitlab.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretUpdateGitlab.prototype['output-rule'] = undefined;

/**
 * If set, dry-run will be skipped [true/false]
 * @member {Boolean} skip-dry-run
 */
DynamicSecretUpdateGitlab.prototype['skip-dry-run'] = undefined;
...
export default DynamicSecretUpdateGitlab;
