...
class DynamicSecretCreateMySql {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateMySql</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateMySql</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateMySql.RequiredProperties) {
...
DynamicSecretCreateMySql.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateMySql.prototype['ara-enabled'] = undefined;

/**
 * Customize how temporary usernames are generated using go template
 * @member {String} custom-username-template
 */
DynamicSecretCreateMySql.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateMySql.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateMySql.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreateMySql.prototype['item-custom-fields'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['output-rule'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['secure-access-certificate-issuer'] = undefined;

/**
 * The DB name (relevant only for DB Dynamic-Secret)
 * @member {String} secure-access-db-name
 */
DynamicSecretCreateMySql.prototype['secure-access-db-name'] = undefined;

/**
 * The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds
 * @member {Number} secure-access-delay
 */
DynamicSecretCreateMySql.prototype['secure-access-delay'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['skip_dry_run'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretCreateMySql.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretCreateMySql.prototype['use-special-characters'] = undefined;
