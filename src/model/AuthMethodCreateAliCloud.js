...
/**
 * The AuthMethodCreateAliCloud model module.
 * @module model/AuthMethodCreateAliCloud
 * @version 5.0.35
 */
class AuthMethodCreateAliCloud {
    /**
     * Constructs a new <code>AuthMethodCreateAliCloud</code>.
     * authMethodCreateAliCloud is a command that creates a new Auth Method that will be able to authenticate using AliCloud credentials.
     * @alias module:model/AuthMethodCreateAliCloud
     * @param name {String} Auth Method name
     */
    constructor(name) { 
        
        AuthMethodCreateAliCloud.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>AuthMethodCreateAliCloud</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthMethodCreateAliCloud} obj Optional instance to populate.
     * @return {module:model/AuthMethodCreateAliCloud} The populated <code>AuthMethodCreateAliCloud</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthMethodCreateAliCloud();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodCreateAliCloud</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodCreateAliCloud</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodCreateAliCloud.RequiredProperties) {
...
AuthMethodCreateAliCloud.RequiredProperties = ["name"];
 ...
 * @default 0
 */
AuthMethodCreateAliCloud.prototype['access-expires'] = 0;
 ...
 */
AuthMethodCreateAliCloud.prototype['allowed-client-type'] = undefined;

/**
 * Subclaims to include in audit logs, e.g \"--audit-logs-claims email --audit-logs-claims username\"
 * @member {Array.<String>} audit-logs-claims
 */
AuthMethodCreateAliCloud.prototype['audit-logs-claims'] = undefined;

/**
 * A list of AliCloud account-IDs that the access is restricted to
 * @member {Array.<String>} bound-account-id
 */
AuthMethodCreateAliCloud.prototype['bound-account-id'] = undefined;

/**
 * A list of full arns that the access is restricted to
 * @member {Array.<String>} bound-arn
 */
AuthMethodCreateAliCloud.prototype['bound-arn'] = undefined;

/**
 * A CIDR whitelist with the IPs that the access is restricted to
 * @member {Array.<String>} bound-ips
 */
AuthMethodCreateAliCloud.prototype['bound-ips'] = undefined;

/**
 * A list of full resource ids that the access is restricted to
 * @member {Array.<String>} bound-resource-id
 */
AuthMethodCreateAliCloud.prototype['bound-resource-id'] = undefined;

/**
 * A list of full role ids that the access is restricted to
 * @member {Array.<String>} bound-role-id
 */
AuthMethodCreateAliCloud.prototype['bound-role-id'] = undefined;

/**
 * A list of full role-name that the access is restricted to
 * @member {Array.<String>} bound-role-name
 */
AuthMethodCreateAliCloud.prototype['bound-role-name'] = undefined;

/**
 * A list of full user ids that the access is restricted to
 * @member {Array.<String>} bound-user-id
 */
AuthMethodCreateAliCloud.prototype['bound-user-id'] = undefined;

/**
 * A list of full user-name that the access is restricted to
 * @member {Array.<String>} bound-user-name
 */
AuthMethodCreateAliCloud.prototype['bound-user-name'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
AuthMethodCreateAliCloud.prototype['delete_protection'] = undefined;

/**
 * Auth Method description
 * @member {String} description
 */
AuthMethodCreateAliCloud.prototype['description'] = undefined;

/**
 * How many days before the expiration of the auth method would you like to be notified.
 * @member {Array.<String>} expiration-event-in
 */
AuthMethodCreateAliCloud.prototype['expiration-event-in'] = undefined;

/**
 * if true: enforce role-association must include sub claims
 * @member {Boolean} force-sub-claims
 */
AuthMethodCreateAliCloud.prototype['force-sub-claims'] = undefined;

/**
 * A CIDR whitelist with the GW IPs that the access is restricted to
 * @member {Array.<String>} gw-bound-ips
 */
AuthMethodCreateAliCloud.prototype['gw-bound-ips'] = undefined;
 ...
 * @default false
 */
AuthMethodCreateAliCloud.prototype['json'] = false;
 ...
 * @default 0
 */
AuthMethodCreateAliCloud.prototype['jwt-ttl'] = 0;

/**
 * Auth Method name
 * @member {String} name
 */
AuthMethodCreateAliCloud.prototype['name'] = undefined;

/**
 * Choose the relevant product type for the auth method [sm, sra, pm, dp, ca, ara]
 * @member {Array.<String>} product-type
 */
AuthMethodCreateAliCloud.prototype['product-type'] = undefined;
 ...
 */
AuthMethodCreateAliCloud.prototype['sts-url'] = 'https://sts.aliyuncs.com';

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
AuthMethodCreateAliCloud.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
AuthMethodCreateAliCloud.prototype['uid-token'] = undefined;
 ...
 */
AuthMethodCreateAliCloud.prototype['unique-identifier'] = undefined;
...
export default AuthMethodCreateAliCloud;
