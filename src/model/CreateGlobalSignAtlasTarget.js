...
class CreateGlobalSignAtlasTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGlobalSignAtlasTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGlobalSignAtlasTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGlobalSignAtlasTarget.RequiredProperties) {
...
CreateGlobalSignAtlasTarget.RequiredProperties = ["api-key", "api-secret", "name"];
 ...
 */
CreateGlobalSignAtlasTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateGlobalSignAtlasTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateGlobalSignAtlasTarget.prototype['rotate-on-unlock'] = undefined;
