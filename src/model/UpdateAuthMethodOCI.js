...
class UpdateAuthMethodOCI {
    ...
    constructor(groupOcid, name, tenantOcid) { 
        ...
        UpdateAuthMethodOCI.initialize(this, groupOcid, name, tenantOcid);
    }
    ...
    /**
     * Constructs a <code>UpdateAuthMethodOCI</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAuthMethodOCI} obj Optional instance to populate.
     * @return {module:model/UpdateAuthMethodOCI} The populated <code>UpdateAuthMethodOCI</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAuthMethodOCI();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAuthMethodOCI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAuthMethodOCI</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAuthMethodOCI.RequiredProperties) {
...
UpdateAuthMethodOCI.RequiredProperties = ["group-ocid", "name", "tenant-ocid"];
 ...
 */
UpdateAuthMethodOCI.prototype['bound-ips'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
UpdateAuthMethodOCI.prototype['delete_protection'] = undefined;

/**
 * Auth Method description
 * @member {String} description
 */
UpdateAuthMethodOCI.prototype['description'] = undefined;

/**
 * How many days before the expiration of the auth method would you like to be notified.
 * @member {Array.<String>} expiration-event-in
 */
UpdateAuthMethodOCI.prototype['expiration-event-in'] = undefined;

/**
 * if true: enforce role-association must include sub claims
 * @member {Boolean} force-sub-claims
 */
UpdateAuthMethodOCI.prototype['force-sub-claims'] = undefined;

/**
 * A list of required groups ocids
 * @member {Array.<String>} group-ocid
 */
UpdateAuthMethodOCI.prototype['group-ocid'] = undefined;

/**
 * A CIDR whitelist with the GW IPs that the access is restricted to
 * @member {Array.<String>} gw-bound-ips
 */
UpdateAuthMethodOCI.prototype['gw-bound-ips'] = undefined;
 ...
 * @default false
 */
UpdateAuthMethodOCI.prototype['json'] = false;
 ...
 * @default 0
 */
UpdateAuthMethodOCI.prototype['jwt-ttl'] = 0;

/**
 * Auth Method name
 * @member {String} name
 */
UpdateAuthMethodOCI.prototype['name'] = undefined;
 ...
 */
UpdateAuthMethodOCI.prototype['tenant-ocid'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
UpdateAuthMethodOCI.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
UpdateAuthMethodOCI.prototype['uid-token'] = undefined;
...
export default UpdateAuthMethodOCI;
