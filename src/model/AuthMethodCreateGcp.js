...
class AuthMethodCreateGcp {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodCreateGcp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodCreateGcp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodCreateGcp.RequiredProperties) {
...
AuthMethodCreateGcp.RequiredProperties = ["audience", "name", "type"];
 ...
 */
AuthMethodCreateGcp.prototype['allowed-client-type'] = undefined;
 ...
 */
AuthMethodCreateGcp.prototype['expiration-event-in'] = undefined;
