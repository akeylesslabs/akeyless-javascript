...
class TargetUpdateAws {
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateAws</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateAws</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateAws.RequiredProperties) {
...
TargetUpdateAws.RequiredProperties = ["access-key", "access-key-id", "name"];
 ...
 */
TargetUpdateAws.prototype['generate-external-id'] = undefined;
 ...
 */
TargetUpdateAws.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetUpdateAws.prototype['lock-ttl'] = undefined;
 ...
 */
TargetUpdateAws.prototype['role-arn'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
TargetUpdateAws.prototype['rotate-on-unlock'] = undefined;
