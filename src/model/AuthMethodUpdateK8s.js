...
class AuthMethodUpdateK8s {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodUpdateK8s</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodUpdateK8s</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodUpdateK8s.RequiredProperties) {
...
AuthMethodUpdateK8s.RequiredProperties = ["name"];
 ...
 */
AuthMethodUpdateK8s.prototype['allowed-client-type'] = undefined;
 ...
 */
AuthMethodUpdateK8s.prototype['delete_protection'] = undefined;
 ...
 */
AuthMethodUpdateK8s.prototype['expiration-event-in'] = undefined;
