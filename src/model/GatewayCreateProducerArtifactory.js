 ...
 */
GatewayCreateProducerArtifactory.prototype['ara-enabled'] = undefined;
 ...
 */
GatewayCreateProducerArtifactory.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayCreateProducerArtifactory.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
GatewayCreateProducerArtifactory.prototype['input-rule'] = undefined;
 ...
 */
GatewayCreateProducerArtifactory.prototype['output-rule'] = undefined;
 ...
 */
GatewayCreateProducerArtifactory.prototype['skip_dry_run'] = undefined;
