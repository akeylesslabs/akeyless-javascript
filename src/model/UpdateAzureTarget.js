...
class UpdateAzureTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAzureTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAzureTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAzureTarget.RequiredProperties) {
...
UpdateAzureTarget.RequiredProperties = ["name"];
 ...
 * @default 'AzureCloud'
 */
UpdateAzureTarget.prototype['azure-cloud'] = 'AzureCloud';
 ...
 * @default 'credentials'
 */
UpdateAzureTarget.prototype['connection-type'] = 'credentials';
 ...
 */
UpdateAzureTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
UpdateAzureTarget.prototype['lock-ttl'] = undefined;
 ...
 */
UpdateAzureTarget.prototype['rotate-on-unlock'] = undefined;
