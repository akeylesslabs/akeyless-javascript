...
class AuthMethodUpdateOauth2 {
    ...
    constructor(name, uniqueIdentifier) { 
        ...
        AuthMethodUpdateOauth2.initialize(this, name, uniqueIdentifier);
    }
    ...
    /**
     * Constructs a <code>AuthMethodUpdateOauth2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthMethodUpdateOauth2} obj Optional instance to populate.
     * @return {module:model/AuthMethodUpdateOauth2} The populated <code>AuthMethodUpdateOauth2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthMethodUpdateOauth2();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodUpdateOauth2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodUpdateOauth2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodUpdateOauth2.RequiredProperties) {
...
AuthMethodUpdateOauth2.RequiredProperties = ["name", "unique-identifier"];
 ...
 * @default 0
 */
AuthMethodUpdateOauth2.prototype['access-expires'] = 0;
 ...
 */
AuthMethodUpdateOauth2.prototype['allowed-client-type'] = undefined;

/**
 * The audience in the JWT
 * @member {String} audience
 */
AuthMethodUpdateOauth2.prototype['audience'] = undefined;

/**
 * Subclaims to include in audit logs, e.g \"--audit-logs-claims email --audit-logs-claims username\"
 * @member {Array.<String>} audit-logs-claims
 */
AuthMethodUpdateOauth2.prototype['audit-logs-claims'] = undefined;

/**
 * The clients ids that the access is restricted to
 * @member {Array.<String>} bound-client-ids
 */
AuthMethodUpdateOauth2.prototype['bound-client-ids'] = undefined;

/**
 * A CIDR whitelist with the IPs that the access is restricted to
 * @member {Array.<String>} bound-ips
 */
AuthMethodUpdateOauth2.prototype['bound-ips'] = undefined;

/**
 * CertificateFile Path to a file that contain the certificate in a PEM format.
 * @member {String} cert
 */
AuthMethodUpdateOauth2.prototype['cert'] = undefined;
 ...
 */
AuthMethodUpdateOauth2.prototype['description'] = undefined;

/**
 * How many days before the expiration of the auth method would you like to be notified.
 * @member {Array.<String>} expiration-event-in
 */
AuthMethodUpdateOauth2.prototype['expiration-event-in'] = undefined;

/**
 * if true: enforce role-association must include sub claims
 * @member {Boolean} force-sub-claims
 */
AuthMethodUpdateOauth2.prototype['force-sub-claims'] = undefined;
 ...
 */
AuthMethodUpdateOauth2.prototype['gateway-url'] = undefined;

/**
 * A CIDR whitelist with the GW IPs that the access is restricted to
 * @member {Array.<String>} gw-bound-ips
 */
AuthMethodUpdateOauth2.prototype['gw-bound-ips'] = undefined;

/**
 * Issuer URL
 * @member {String} issuer
 */
AuthMethodUpdateOauth2.prototype['issuer'] = undefined;
 ...
 * @default false
 */
AuthMethodUpdateOauth2.prototype['json'] = false;
 ...
 */
AuthMethodUpdateOauth2.prototype['jwks-json-data'] = undefined;

/**
 * The URL to the JSON Web Key Set (JWKS) that containing the public keys that should be used to verify any JSON Web Token (JWT) issued by the authorization server.
 * @member {String} jwks-uri
 */
AuthMethodUpdateOauth2.prototype['jwks-uri'] = undefined;
 ...
 * @default 0
 */
AuthMethodUpdateOauth2.prototype['jwt-ttl'] = 0;

/**
 * Auth Method name
 * @member {String} name
 */
AuthMethodUpdateOauth2.prototype['name'] = undefined;
 ...
 */
AuthMethodUpdateOauth2.prototype['subclaims-delimiters'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
AuthMethodUpdateOauth2.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
AuthMethodUpdateOauth2.prototype['uid-token'] = undefined;

/**
 * A unique identifier (ID) value should be configured for OAuth2, LDAP and SAML authentication method types and is usually a value such as the email, username, or upn for example. Whenever a user logs in with a token, these authentication types issue a \"sub claim\" that contains details uniquely identifying that user. This sub claim includes a key containing the ID value that you configured, and is used to distinguish between different users from within the same organization.
 * @member {String} unique-identifier
 */
AuthMethodUpdateOauth2.prototype['unique-identifier'] = undefined;
...
export default AuthMethodUpdateOauth2;
