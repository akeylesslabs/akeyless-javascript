...
class DecryptPKCS1 {
    ...
    /**
     * Validates the JSON data with respect to <code>DecryptPKCS1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecryptPKCS1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DecryptPKCS1.RequiredProperties) {
...
DecryptPKCS1.RequiredProperties = ["ciphertext", "key-name"];
