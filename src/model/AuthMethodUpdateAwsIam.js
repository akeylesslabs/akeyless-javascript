...
class AuthMethodUpdateAwsIam {
    /**
     * Constructs a new <code>AuthMethodUpdateAwsIam</code>.
     ...
     * @alias module:model/AuthMethodUpdateAwsIam
    ...
    constructor(boundAwsAccountId, name) { 
        ...
        AuthMethodUpdateAwsIam.initialize(this, boundAwsAccountId, name);
    }
    ...
    /**
     * Constructs a <code>AuthMethodUpdateAwsIam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthMethodUpdateAwsIam} obj Optional instance to populate.
     * @return {module:model/AuthMethodUpdateAwsIam} The populated <code>AuthMethodUpdateAwsIam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthMethodUpdateAwsIam();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodUpdateAwsIam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodUpdateAwsIam</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodUpdateAwsIam.RequiredProperties) {
...
AuthMethodUpdateAwsIam.RequiredProperties = ["bound-aws-account-id", "name"];
 ...
 */
AuthMethodUpdateAwsIam.prototype['description'] = undefined;

/**
 * How many days before the expiration of the auth method would you like to be notified.
 * @member {Array.<String>} expiration-event-in
 */
AuthMethodUpdateAwsIam.prototype['expiration-event-in'] = undefined;

/**
 * if true: enforce role-association must include sub claims
 * @member {Boolean} force-sub-claims
 */
AuthMethodUpdateAwsIam.prototype['force-sub-claims'] = undefined;

/**
 * A CIDR whitelist with the GW IPs that the access is restricted to
 * @member {Array.<String>} gw-bound-ips
 */
AuthMethodUpdateAwsIam.prototype['gw-bound-ips'] = undefined;
 ...
 * @default false
 */
AuthMethodUpdateAwsIam.prototype['json'] = false;
 ...
 * @default 0
 */
AuthMethodUpdateAwsIam.prototype['jwt-ttl'] = 0;

/**
 * Auth Method name
 * @member {String} name
 */
AuthMethodUpdateAwsIam.prototype['name'] = undefined;
 ...
 */
AuthMethodUpdateAwsIam.prototype['sts-url'] = 'https://sts.amazonaws.com';

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
AuthMethodUpdateAwsIam.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
AuthMethodUpdateAwsIam.prototype['uid-token'] = undefined;
 ...
 */
AuthMethodUpdateAwsIam.prototype['unique-identifier'] = undefined;
...
export default AuthMethodUpdateAwsIam;
