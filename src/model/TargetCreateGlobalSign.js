...
class TargetCreateGlobalSign {
    ...
    /**
     * Validates the JSON data with respect to <code>TargetCreateGlobalSign</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetCreateGlobalSign</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetCreateGlobalSign.RequiredProperties) {
...
TargetCreateGlobalSign.RequiredProperties = ["contact-email", "contact-first-name", "contact-last-name", "contact-phone", "name", "password", "profile-id", "username"];
 ...
 */
TargetCreateGlobalSign.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetCreateGlobalSign.prototype['lock-ttl'] = undefined;
 ...
 */
TargetCreateGlobalSign.prototype['rotate-on-unlock'] = undefined;
