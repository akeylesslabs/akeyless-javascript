...
class CreateSSHTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSSHTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSSHTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSSHTarget.RequiredProperties) {
...
CreateSSHTarget.RequiredProperties = ["name"];
 ...
 */
CreateSSHTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateSSHTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateSSHTarget.prototype['rotate-on-unlock'] = undefined;
