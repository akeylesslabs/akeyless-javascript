...
class KMIPClientUpdateResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>KMIPClientUpdateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KMIPClientUpdateResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `client`
        if (data['client']) { // data not null
          KMIPClient.validateJSON(data['client']);
        }
