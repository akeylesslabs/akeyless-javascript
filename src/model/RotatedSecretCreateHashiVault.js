...
class RotatedSecretCreateHashiVault {
    /**
     * Constructs a new <code>RotatedSecretCreateHashiVault</code>.
     * @alias module:model/RotatedSecretCreateHashiVault
     * @param name {String} Rotated secret name
     * @param targetName {String} The target name to associate
     */
    constructor(name, targetName) { 
        
        RotatedSecretCreateHashiVault.initialize(this, name, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreateHashiVault</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreateHashiVault} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreateHashiVault} The populated <code>RotatedSecretCreateHashiVault</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretCreateHashiVault();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreateHashiVault</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreateHashiVault</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreateHashiVault.RequiredProperties) {
...
RotatedSecretCreateHashiVault.RequiredProperties = ["name", "target-name"];
 ...
 */
RotatedSecretCreateHashiVault.prototype['ara-enabled'] = undefined;

/**
 * @member {String} auto-rotate
 */
RotatedSecretCreateHashiVault.prototype['auto-rotate'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
RotatedSecretCreateHashiVault.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
RotatedSecretCreateHashiVault.prototype['description'] = undefined;
 ...
 */
RotatedSecretCreateHashiVault.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreateHashiVault.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreateHashiVault.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretCreateHashiVault.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreateHashiVault.prototype['json'] = false;

/**
 * @member {String} key
 */
RotatedSecretCreateHashiVault.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretCreateHashiVault.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreateHashiVault.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretCreateHashiVault.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretCreateHashiVault.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreateHashiVault.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreateHashiVault.prototype['password-length'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreateHashiVault.prototype['rotate-on-unlock'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretCreateHashiVault.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretCreateHashiVault.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretCreateHashiVault.prototype['rotation-interval'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretCreateHashiVault.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
RotatedSecretCreateHashiVault.prototype['tags'] = undefined;

/**
 * The target name to associate
 * @member {String} target-name
 */
RotatedSecretCreateHashiVault.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
RotatedSecretCreateHashiVault.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreateHashiVault.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreateHashiVault.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreateHashiVault.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreateHashiVault.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreateHashiVault.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreateHashiVault;
