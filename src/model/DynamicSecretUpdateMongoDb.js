...
class DynamicSecretUpdateMongoDb {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateMongoDb</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateMongoDb</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateMongoDb.RequiredProperties) {
...
DynamicSecretUpdateMongoDb.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretUpdateMongoDb.prototype['ara-enabled'] = undefined;

/**
 * Customize how temporary usernames are generated using go template
 * @member {String} custom-username-template
 */
DynamicSecretUpdateMongoDb.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateMongoDb.prototype['enable-ai-quorum'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['mongodb-scopes'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['secure-access-certificate-issuer'] = undefined;

/**
 * The DB name (relevant only for DB Dynamic-Secret)
 * @member {String} secure-access-db-name
 */
DynamicSecretUpdateMongoDb.prototype['secure-access-db-name'] = undefined;

/**
 * The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds
 * @member {Number} secure-access-delay
 */
DynamicSecretUpdateMongoDb.prototype['secure-access-delay'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['skip_dry_run'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretUpdateMongoDb.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretUpdateMongoDb.prototype['use-special-characters'] = undefined;
