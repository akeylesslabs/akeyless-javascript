...
class AuthMethodUpdateApiKey {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodUpdateApiKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodUpdateApiKey</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodUpdateApiKey.RequiredProperties) {
...
AuthMethodUpdateApiKey.RequiredProperties = ["name"];
 ...
 */
AuthMethodUpdateApiKey.prototype['allowed-client-type'] = undefined;
 ...
 */
AuthMethodUpdateApiKey.prototype['expiration-event-in'] = undefined;
