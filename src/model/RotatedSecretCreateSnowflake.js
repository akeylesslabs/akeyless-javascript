...
class RotatedSecretCreateSnowflake {
    /**
     * Constructs a new <code>RotatedSecretCreateSnowflake</code>.
    ...
    constructor(name, rotatorType, targetName) { 
        ...
        RotatedSecretCreateSnowflake.initialize(this, name, rotatorType, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreateSnowflake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreateSnowflake} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreateSnowflake} The populated <code>RotatedSecretCreateSnowflake</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreateSnowflake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreateSnowflake</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreateSnowflake.RequiredProperties) {
 ...
 */
RotatedSecretCreateSnowflake.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreateSnowflake.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreateSnowflake.prototype['input-rule'] = undefined;
 ...
 */
RotatedSecretCreateSnowflake.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreateSnowflake.prototype['lock-ttl'] = undefined;
 ...
 * @member {String} name
 */
RotatedSecretCreateSnowflake.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreateSnowflake.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreateSnowflake.prototype['password-length'] = undefined;

/**
 * RSA Private key (base64 encoded) to rotate (relevant only for rotator-type=key)
 * @member {String} private-key
 */
RotatedSecretCreateSnowflake.prototype['private-key'] = undefined;

/**
 * The path to the file containing the private key (relevant only for rotator-type=key)
 * @member {String} private-key-file-name
 */
RotatedSecretCreateSnowflake.prototype['private-key-file-name'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreateSnowflake.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretCreateSnowflake.prototype['rotated-password'] = undefined;
 ...
 */
RotatedSecretCreateSnowflake.prototype['rotated-username'] = undefined;
 ...
 */
RotatedSecretCreateSnowflake.prototype['skip-dry-run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
RotatedSecretCreateSnowflake.prototype['tags'] = undefined;

/**
 * The target name to associate
 * @member {String} target-name
 */
RotatedSecretCreateSnowflake.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
RotatedSecretCreateSnowflake.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreateSnowflake.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreateSnowflake.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreateSnowflake.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreateSnowflake.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreateSnowflake.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreateSnowflake;
