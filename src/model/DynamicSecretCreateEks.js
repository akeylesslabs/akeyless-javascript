...
/**
 * The DynamicSecretCreateEks model module.
 * @module model/DynamicSecretCreateEks
 * @version 5.0.34
 */
class DynamicSecretCreateEks {
    /**
     * Constructs a new <code>DynamicSecretCreateEks</code>.
     * dynamicSecretCreateEks is a command that creates eks dynamic secret
     * @alias module:model/DynamicSecretCreateEks
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretCreateEks.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretCreateEks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretCreateEks} obj Optional instance to populate.
     * @return {module:model/DynamicSecretCreateEks} The populated <code>DynamicSecretCreateEks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretCreateEks();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateEks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateEks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateEks.RequiredProperties) {
...
DynamicSecretCreateEks.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateEks.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretCreateEks.prototype['description'] = undefined;

/**
 * Access Key ID
 * @member {String} eks-access-key-id
 */
DynamicSecretCreateEks.prototype['eks-access-key-id'] = undefined;

/**
 * IAM assume role
 * @member {String} eks-assume-role
 */
DynamicSecretCreateEks.prototype['eks-assume-role'] = undefined;

/**
 * EKS cluster CA certificate
 * @member {String} eks-cluster-ca-cert
 */
DynamicSecretCreateEks.prototype['eks-cluster-ca-cert'] = undefined;

/**
 * EKS cluster URL endpoint
 * @member {String} eks-cluster-endpoint
 */
DynamicSecretCreateEks.prototype['eks-cluster-endpoint'] = undefined;

/**
 * EKS cluster name
 * @member {String} eks-cluster-name
 */
DynamicSecretCreateEks.prototype['eks-cluster-name'] = undefined;
 ...
 * @default 'us-east-2'
 */
DynamicSecretCreateEks.prototype['eks-region'] = 'us-east-2';

/**
 * Secret Access Key
 * @member {String} eks-secret-access-key
 */
DynamicSecretCreateEks.prototype['eks-secret-access-key'] = undefined;
 ...
 */
DynamicSecretCreateEks.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateEks.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateEks.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreateEks.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateEks.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretCreateEks.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretCreateEks.prototype['output-rule'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key-name
 */
DynamicSecretCreateEks.prototype['producer-encryption-key-name'] = undefined;

/**
 * Enable Port forwarding while using CLI access
 * @member {Boolean} secure-access-allow-port-forwading
 */
DynamicSecretCreateEks.prototype['secure-access-allow-port-forwading'] = undefined;

/**
 * Deprecated. use secure-access-certificate-issuer
 * @member {String} secure-access-bastion-issuer
 */
DynamicSecretCreateEks.prototype['secure-access-bastion-issuer'] = undefined;

/**
 * Path to the SSH Certificate Issuer for your Akeyless Secure Access
 * @member {String} secure-access-certificate-issuer
 */
DynamicSecretCreateEks.prototype['secure-access-certificate-issuer'] = undefined;

/**
 * The K8s cluster endpoint URL
 * @member {String} secure-access-cluster-endpoint
 */
DynamicSecretCreateEks.prototype['secure-access-cluster-endpoint'] = undefined;

/**
 * The delay duration, in seconds, to wait after generating just-in-time credentials. Accepted range: 0-120 seconds
 * @member {Number} secure-access-delay
 */
DynamicSecretCreateEks.prototype['secure-access-delay'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
DynamicSecretCreateEks.prototype['secure-access-enable'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateEks.prototype['secure-access-web'] = false;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
DynamicSecretCreateEks.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretCreateEks.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretCreateEks.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretCreateEks.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretCreateEks.prototype['uid-token'] = undefined;
 ...
 * @default '15m'
 */
DynamicSecretCreateEks.prototype['user-ttl'] = '15m';
...
export default DynamicSecretCreateEks;
