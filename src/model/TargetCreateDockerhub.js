...
class TargetCreateDockerhub {
    ...
    /**
     * Validates the JSON data with respect to <code>TargetCreateDockerhub</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetCreateDockerhub</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetCreateDockerhub.RequiredProperties) {
...
TargetCreateDockerhub.RequiredProperties = ["name"];

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
TargetCreateDockerhub.prototype['delete_protection'] = undefined;
 ...
 */
TargetCreateDockerhub.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetCreateDockerhub.prototype['lock-ttl'] = undefined;
 ...
 */
TargetCreateDockerhub.prototype['rotate-on-unlock'] = undefined;
