...
class GatewayCreateK8SAuthConfig {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayCreateK8SAuthConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayCreateK8SAuthConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayCreateK8SAuthConfig.RequiredProperties) {
...
GatewayCreateK8SAuthConfig.RequiredProperties = ["access-id", "k8s-host", "name", "signing-key"];
 ...
 * @default 'token'
 */
GatewayCreateK8SAuthConfig.prototype['k8s-auth-type'] = 'token';
 ...
 */
GatewayCreateK8SAuthConfig.prototype['k8s-client-certificate'] = undefined;
 ...
 */
GatewayCreateK8SAuthConfig.prototype['k8s-client-key'] = undefined;
 ...
 */
GatewayCreateK8SAuthConfig.prototype['use-gw-service-account'] = undefined;
