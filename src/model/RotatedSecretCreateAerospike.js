...
class RotatedSecretCreateAerospike {
    /**
     * Constructs a new <code>RotatedSecretCreateAerospike</code>.
     * rotatedSecretCreateAerospike is a command that creates a rotated secret item.
     * @alias module:model/RotatedSecretCreateAerospike
    ...
    constructor(name, rotatorType, targetName) { 
        ...
        RotatedSecretCreateAerospike.initialize(this, name, rotatorType, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreateAerospike</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreateAerospike} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreateAerospike} The populated <code>RotatedSecretCreateAerospike</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretCreateAerospike();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreateAerospike</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreateAerospike</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreateAerospike.RequiredProperties) {
...
RotatedSecretCreateAerospike.RequiredProperties = ["name", "rotator-type", "target-name"];
 ...
 */
RotatedSecretCreateAerospike.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretCreateAerospike.prototype['authentication-credentials'] = 'use-user-creds';

/**
 * @member {String} auto-rotate
 */
RotatedSecretCreateAerospike.prototype['auto-rotate'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
RotatedSecretCreateAerospike.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
RotatedSecretCreateAerospike.prototype['description'] = undefined;
 ...
 */
RotatedSecretCreateAerospike.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreateAerospike.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreateAerospike.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretCreateAerospike.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreateAerospike.prototype['json'] = false;

/**
 * @member {String} key
 */
RotatedSecretCreateAerospike.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretCreateAerospike.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreateAerospike.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretCreateAerospike.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretCreateAerospike.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreateAerospike.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreateAerospike.prototype['password-length'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreateAerospike.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretCreateAerospike.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretCreateAerospike.prototype['rotated-username'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretCreateAerospike.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretCreateAerospike.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretCreateAerospike.prototype['rotation-interval'] = undefined;

/**
 * The rotator type. options: [target/password]
 * @member {String} rotator-type
 */
RotatedSecretCreateAerospike.prototype['rotator-type'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretCreateAerospike.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
RotatedSecretCreateAerospike.prototype['tags'] = undefined;

/**
 * The target name to associate
 * @member {String} target-name
 */
RotatedSecretCreateAerospike.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
RotatedSecretCreateAerospike.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreateAerospike.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreateAerospike.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreateAerospike.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreateAerospike.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreateAerospike.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreateAerospike;
