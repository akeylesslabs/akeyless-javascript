...
class TargetUpdateGcp {
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateGcp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateGcp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateGcp.RequiredProperties) {
...
TargetUpdateGcp.RequiredProperties = ["name"];

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
TargetUpdateGcp.prototype['delete_protection'] = undefined;
 ...
 */
TargetUpdateGcp.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetUpdateGcp.prototype['lock-ttl'] = undefined;
 ...
 */
TargetUpdateGcp.prototype['rotate-on-unlock'] = undefined;
