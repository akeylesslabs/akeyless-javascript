...
class UpdateZeroSSLTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateZeroSSLTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateZeroSSLTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateZeroSSLTarget.RequiredProperties) {
...
UpdateZeroSSLTarget.RequiredProperties = ["api-key", "imap-fqdn", "imap-password", "imap-username", "name"];
 ...
 */
UpdateZeroSSLTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
UpdateZeroSSLTarget.prototype['lock-ttl'] = undefined;
 ...
 */
UpdateZeroSSLTarget.prototype['rotate-on-unlock'] = undefined;
