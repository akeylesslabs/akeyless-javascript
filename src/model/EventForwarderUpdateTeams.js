...
/**
 * The EventForwarderUpdateTeams model module.
 * @module model/EventForwarderUpdateTeams
 * @version 5.0.19
 */
class EventForwarderUpdateTeams {
    /**
     * Constructs a new <code>EventForwarderUpdateTeams</code>.
     * eventForwarderUpdateTeams is a command that updates teams event forwarder
     * @alias module:model/EventForwarderUpdateTeams
    ...
    constructor(gatewaysEventSourceLocations, name, url) { 
        ...
        EventForwarderUpdateTeams.initialize(this, gatewaysEventSourceLocations, name, url);
    }
    ...
    /**
     * Constructs a <code>EventForwarderUpdateTeams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventForwarderUpdateTeams} obj Optional instance to populate.
     * @return {module:model/EventForwarderUpdateTeams} The populated <code>EventForwarderUpdateTeams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventForwarderUpdateTeams();
    ...
    /**
     * Validates the JSON data with respect to <code>EventForwarderUpdateTeams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventForwarderUpdateTeams</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventForwarderUpdateTeams.RequiredProperties) {
...
EventForwarderUpdateTeams.RequiredProperties = ["gateways-event-source-locations", "name", "url"];

/**
 * Auth Method Event sources
 * @member {Array.<String>} auth-methods-event-source-locations
 */
EventForwarderUpdateTeams.prototype['auth-methods-event-source-locations'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
EventForwarderUpdateTeams.prototype['description'] = undefined;
 ...
 * @default 'true'
 */
EventForwarderUpdateTeams.prototype['enable'] = 'true';
 ...
 */
EventForwarderUpdateTeams.prototype['event-types'] = undefined;

/**
 * Event sources
 * @member {Array.<String>} gateways-event-source-locations
 */
EventForwarderUpdateTeams.prototype['gateways-event-source-locations'] = undefined;

/**
 * Items Event sources
 * @member {Array.<String>} items-event-source-locations
 */
EventForwarderUpdateTeams.prototype['items-event-source-locations'] = undefined;
 ...
 * @default false
 */
EventForwarderUpdateTeams.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
EventForwarderUpdateTeams.prototype['keep-prev-version'] = undefined;
 ...
 * @member {String} key
 */
EventForwarderUpdateTeams.prototype['key'] = undefined;

/**
 * EventForwarder name
 * @member {String} name
 */
EventForwarderUpdateTeams.prototype['name'] = undefined;

/**
 * New EventForwarder name
 * @member {String} new-name
 */
EventForwarderUpdateTeams.prototype['new-name'] = undefined;

/**
 * Targets Event sources
 * @member {Array.<String>} targets-event-source-locations
 */
EventForwarderUpdateTeams.prototype['targets-event-source-locations'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
EventForwarderUpdateTeams.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
EventForwarderUpdateTeams.prototype['uid-token'] = undefined;

/**
 * Teams Webhook URL
 * @member {String} url
 */
EventForwarderUpdateTeams.prototype['url'] = undefined;
...
export default EventForwarderUpdateTeams;
