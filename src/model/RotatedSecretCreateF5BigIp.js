...
class RotatedSecretCreateF5BigIp {
    /**
     * Constructs a new <code>RotatedSecretCreateF5BigIp</code>.
     * @alias module:model/RotatedSecretCreateF5BigIp
    ...
    constructor(name, rotatorType, targetName) { 
        ...
        RotatedSecretCreateF5BigIp.initialize(this, name, rotatorType, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreateF5BigIp</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreateF5BigIp} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreateF5BigIp} The populated <code>RotatedSecretCreateF5BigIp</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretCreateF5BigIp();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreateF5BigIp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreateF5BigIp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreateF5BigIp.RequiredProperties) {
...
RotatedSecretCreateF5BigIp.RequiredProperties = ["name", "rotator-type", "target-name"];
 ...
 */
RotatedSecretCreateF5BigIp.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretCreateF5BigIp.prototype['authentication-credentials'] = 'use-user-creds';

/**
 * @member {String} auto-rotate
 */
RotatedSecretCreateF5BigIp.prototype['auto-rotate'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
RotatedSecretCreateF5BigIp.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
RotatedSecretCreateF5BigIp.prototype['description'] = undefined;
 ...
 */
RotatedSecretCreateF5BigIp.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreateF5BigIp.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreateF5BigIp.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretCreateF5BigIp.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreateF5BigIp.prototype['json'] = false;

/**
 * @member {String} key
 */
RotatedSecretCreateF5BigIp.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretCreateF5BigIp.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreateF5BigIp.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretCreateF5BigIp.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretCreateF5BigIp.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreateF5BigIp.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreateF5BigIp.prototype['password-length'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreateF5BigIp.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretCreateF5BigIp.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretCreateF5BigIp.prototype['rotated-username'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretCreateF5BigIp.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretCreateF5BigIp.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretCreateF5BigIp.prototype['rotation-interval'] = undefined;

/**
 * The rotator type. options: [target/password]
 * @member {String} rotator-type
 */
RotatedSecretCreateF5BigIp.prototype['rotator-type'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretCreateF5BigIp.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
RotatedSecretCreateF5BigIp.prototype['tags'] = undefined;

/**
 * The target name to associate
 * @member {String} target-name
 */
RotatedSecretCreateF5BigIp.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
RotatedSecretCreateF5BigIp.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreateF5BigIp.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreateF5BigIp.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreateF5BigIp.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreateF5BigIp.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreateF5BigIp.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreateF5BigIp;
