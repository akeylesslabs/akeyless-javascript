...
/**
 * The TargetUpdateGodaddy model module.
 * @module model/TargetUpdateGodaddy
 * @version 5.0.34
 */
class TargetUpdateGodaddy {
    /**
     * Constructs a new <code>TargetUpdateGodaddy</code>.
     * @alias module:model/TargetUpdateGodaddy
    ...
    constructor(apiKey, imapFqdn, imapPassword, imapUsername, name, secret) { 
        ...
        TargetUpdateGodaddy.initialize(this, apiKey, imapFqdn, imapPassword, imapUsername, name, secret);
    }
    ...
    /**
     * Constructs a <code>TargetUpdateGodaddy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetUpdateGodaddy} obj Optional instance to populate.
     * @return {module:model/TargetUpdateGodaddy} The populated <code>TargetUpdateGodaddy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetUpdateGodaddy();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateGodaddy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateGodaddy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateGodaddy.RequiredProperties) {
...
TargetUpdateGodaddy.RequiredProperties = ["api-key", "imap-fqdn", "imap-password", "imap-username", "name", "secret"];

/**
 * Key of the api credentials to the Godaddy account
 * @member {String} api-key
 */
TargetUpdateGodaddy.prototype['api-key'] = undefined;

/**
 * Customer ID (ShopperId) required for renewal of imported certificates
 * @member {String} customer_id
 */
TargetUpdateGodaddy.prototype['customer_id'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
TargetUpdateGodaddy.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
TargetUpdateGodaddy.prototype['description'] = undefined;

/**
 * ImapFQDN of the IMAP service, FQDN or IPv4 address. Must be FQDN if the IMAP is using TLS
 * @member {String} imap-fqdn
 */
TargetUpdateGodaddy.prototype['imap-fqdn'] = undefined;

/**
 * ImapPassword to access the IMAP service
 * @member {String} imap-password
 */
TargetUpdateGodaddy.prototype['imap-password'] = undefined;
 ...
 * @default '993'
 */
TargetUpdateGodaddy.prototype['imap-port'] = '993';

/**
 * ImapUsername to access the IMAP service
 * @member {String} imap-username
 */
TargetUpdateGodaddy.prototype['imap-username'] = undefined;
 ...
 * @default false
 */
TargetUpdateGodaddy.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
TargetUpdateGodaddy.prototype['keep-prev-version'] = undefined;

/**
 * The name of a key that used to encrypt the target secret value (if empty, the account default protectionKey key will be used)
 * @member {String} key
 */
TargetUpdateGodaddy.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
TargetUpdateGodaddy.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetUpdateGodaddy.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
TargetUpdateGodaddy.prototype['max-versions'] = undefined;

/**
 * Target name
 * @member {String} name
 */
TargetUpdateGodaddy.prototype['name'] = undefined;

/**
 * New target name
 * @member {String} new-name
 */
TargetUpdateGodaddy.prototype['new-name'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
TargetUpdateGodaddy.prototype['rotate-on-unlock'] = undefined;

/**
 * Secret of the api credentials to the Godaddy account
 * @member {String} secret
 */
TargetUpdateGodaddy.prototype['secret'] = undefined;
 ...
 * @default '5m'
 */
TargetUpdateGodaddy.prototype['timeout'] = '5m';

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
TargetUpdateGodaddy.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
TargetUpdateGodaddy.prototype['uid-token'] = undefined;
...
export default TargetUpdateGodaddy;
