...
class KmipCreateClient {
    ...
    static initialize(obj, name) { 
        obj['activate-keys-on-creation'] = 'false';
        obj['certificate-ttl'] = 90;
        obj['json'] = false;
        obj['name'] = name;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>KmipCreateClient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KmipCreateClient</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KmipCreateClient.RequiredProperties) {
...
KmipCreateClient.RequiredProperties = ["name"];
