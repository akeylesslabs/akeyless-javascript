...
class GatewayCreateProducerEks {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayCreateProducerEks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayCreateProducerEks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayCreateProducerEks.RequiredProperties) {
...
GatewayCreateProducerEks.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
GatewayCreateProducerEks.prototype['ara-enabled'] = undefined;
 ...
 */
GatewayCreateProducerEks.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayCreateProducerEks.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
GatewayCreateProducerEks.prototype['input-rule'] = undefined;
 ...
 */
GatewayCreateProducerEks.prototype['output-rule'] = undefined;
 ...
 */
GatewayCreateProducerEks.prototype['secure-access-certificate-issuer'] = undefined;
 ...
 */
GatewayCreateProducerEks.prototype['secure-access-delay'] = undefined;
 ...
 */
GatewayCreateProducerEks.prototype['skip-dry-run'] = undefined;
