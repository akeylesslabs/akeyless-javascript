...
/**
 * The DynamicSecretCreatePing model module.
 * @module model/DynamicSecretCreatePing
 * @version 5.0.34
 */
class DynamicSecretCreatePing {
    /**
     * Constructs a new <code>DynamicSecretCreatePing</code>.
     * dynamicSecretCreatePing is a command that creates ping dynamic secret
     * @alias module:model/DynamicSecretCreatePing
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretCreatePing.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretCreatePing</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretCreatePing} obj Optional instance to populate.
     * @return {module:model/DynamicSecretCreatePing} The populated <code>DynamicSecretCreatePing</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretCreatePing();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreatePing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreatePing</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreatePing.RequiredProperties) {
...
DynamicSecretCreatePing.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreatePing.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['description'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreatePing.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreatePing.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreatePing.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreatePing.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretCreatePing.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretCreatePing.prototype['output-rule'] = undefined;
 ...
 * @default '9999'
 */
DynamicSecretCreatePing.prototype['ping-administrative-port'] = '9999';
 ...
 */
DynamicSecretCreatePing.prototype['ping-atm-id'] = undefined;
 ...
 * @default '9031'
 */
DynamicSecretCreatePing.prototype['ping-authorization-port'] = '9031';
 ...
 */
DynamicSecretCreatePing.prototype['ping-cert-subject-dn'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['ping-client-authentication-type'] = 'CLIENT_SECRET';
 ...
 * @default 'false'
 */
DynamicSecretCreatePing.prototype['ping-enforce-replay-prevention'] = 'false';
 ...
 */
DynamicSecretCreatePing.prototype['ping-grant-types'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['ping-issuer-dn'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['ping-jwks'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['ping-jwks-url'] = undefined;

/**
 * Ping Federate privileged user password
 * @member {String} ping-password
 */
DynamicSecretCreatePing.prototype['ping-password'] = undefined;

/**
 * Ping Federate privileged user
 * @member {String} ping-privileged-user
 */
DynamicSecretCreatePing.prototype['ping-privileged-user'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['ping-redirect-uris'] = undefined;

/**
 * Limit the OAuth client to specific scopes list
 * @member {Array.<String>} ping-restricted-scopes
 */
DynamicSecretCreatePing.prototype['ping-restricted-scopes'] = undefined;
 ...
 */
DynamicSecretCreatePing.prototype['ping-signing-algo'] = undefined;

/**
 * Ping URL
 * @member {String} ping-url
 */
DynamicSecretCreatePing.prototype['ping-url'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key-name
 */
DynamicSecretCreatePing.prototype['producer-encryption-key-name'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
DynamicSecretCreatePing.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretCreatePing.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretCreatePing.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretCreatePing.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretCreatePing.prototype['uid-token'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretCreatePing.prototype['user-ttl'] = '60m';
...
export default DynamicSecretCreatePing;
