 ...
 */
DynamicSecretUpdateArtifactory.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretUpdateArtifactory.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretUpdateArtifactory.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateArtifactory.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretUpdateArtifactory.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretUpdateArtifactory.prototype['output-rule'] = undefined;
 ...
 */
DynamicSecretUpdateArtifactory.prototype['skip-dry-run'] = undefined;
