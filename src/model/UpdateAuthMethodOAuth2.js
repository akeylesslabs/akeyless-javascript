...
class UpdateAuthMethodOAuth2 {
    ...
    constructor(name, uniqueIdentifier) { 
        ...
        UpdateAuthMethodOAuth2.initialize(this, name, uniqueIdentifier);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAuthMethodOAuth2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAuthMethodOAuth2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAuthMethodOAuth2.RequiredProperties) {
...
UpdateAuthMethodOAuth2.RequiredProperties = ["name", "unique-identifier"];
 ...
 */
UpdateAuthMethodOAuth2.prototype['allowed-client-type'] = undefined;
 ...
 */
UpdateAuthMethodOAuth2.prototype['expiration-event-in'] = undefined;
