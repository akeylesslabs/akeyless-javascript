...
class UpdateGodaddyTarget {
    ...
    constructor(apiKey, imapFqdn, imapPassword, imapUsername, name, secret) { 
        ...
        UpdateGodaddyTarget.initialize(this, apiKey, imapFqdn, imapPassword, imapUsername, name, secret);
    }
    ...
    /**
     * Constructs a <code>UpdateGodaddyTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGodaddyTarget} obj Optional instance to populate.
     * @return {module:model/UpdateGodaddyTarget} The populated <code>UpdateGodaddyTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGodaddyTarget();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGodaddyTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGodaddyTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateGodaddyTarget.RequiredProperties) {
...
UpdateGodaddyTarget.RequiredProperties = ["api-key", "imap-fqdn", "imap-password", "imap-username", "name", "secret"];

/**
 * Key of the api credentials to the Godaddy account
 * @member {String} api-key
 */
UpdateGodaddyTarget.prototype['api-key'] = undefined;
 ...
 * @default '993'
 */
UpdateGodaddyTarget.prototype['imap-port'] = '993';

/**
 * ImapUsername to access the IMAP service
 * @member {String} imap-username
 */
UpdateGodaddyTarget.prototype['imap-username'] = undefined;
 ...
 * @default false
 */
UpdateGodaddyTarget.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
UpdateGodaddyTarget.prototype['keep-prev-version'] = undefined;
 ...
 * @member {String} name
 */
UpdateGodaddyTarget.prototype['name'] = undefined;
 ...
 */
UpdateGodaddyTarget.prototype['secret'] = undefined;
 ...
 * @default '5m'
 */
UpdateGodaddyTarget.prototype['timeout'] = '5m';

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
UpdateGodaddyTarget.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
UpdateGodaddyTarget.prototype['uid-token'] = undefined;

/**
 * Deprecated
 * @member {Boolean} update-version
 */
UpdateGodaddyTarget.prototype['update-version'] = undefined;
...
export default UpdateGodaddyTarget;
