...
class CreateZeroSSLTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateZeroSSLTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateZeroSSLTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateZeroSSLTarget.RequiredProperties) {
...
CreateZeroSSLTarget.RequiredProperties = ["api-key", "imap-fqdn", "imap-password", "imap-username", "name"];
 ...
 */
CreateZeroSSLTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateZeroSSLTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateZeroSSLTarget.prototype['rotate-on-unlock'] = undefined;
