...
class DynamicSecretUpdateVenafi {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateVenafi</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateVenafi</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateVenafi.RequiredProperties) {
...
DynamicSecretUpdateVenafi.RequiredProperties = ["name"];
 ...
 */
DynamicSecretUpdateVenafi.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateVenafi.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretUpdateVenafi.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretUpdateVenafi.prototype['output-rule'] = undefined;
