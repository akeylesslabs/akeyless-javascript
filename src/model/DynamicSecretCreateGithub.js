...
class DynamicSecretCreateGithub {
    /**
     * Constructs a new <code>DynamicSecretCreateGithub</code>.
     * dynamicSecretCreateGithub is a command that creates github dynamic secret
     * @alias module:model/DynamicSecretCreateGithub
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretCreateGithub.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretCreateGithub</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretCreateGithub} obj Optional instance to populate.
     * @return {module:model/DynamicSecretCreateGithub} The populated <code>DynamicSecretCreateGithub</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretCreateGithub();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateGithub</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateGithub</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateGithub.RequiredProperties) {
...
DynamicSecretCreateGithub.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateGithub.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretCreateGithub.prototype['github-app-id'] = undefined;

/**
 * App private key
 * @member {String} github-app-private-key
 */
DynamicSecretCreateGithub.prototype['github-app-private-key'] = undefined;
 ...
 */
DynamicSecretCreateGithub.prototype['github-base-url'] = 'https://api.github.com/';

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateGithub.prototype['input-rule'] = undefined;

/**
 * GitHub application installation id
 * @member {Number} installation-id
 */
DynamicSecretCreateGithub.prototype['installation-id'] = undefined;

/**
 * Optional, mutually exclusive with installation id, GitHub organization name
 * @member {String} installation-organization
 */
DynamicSecretCreateGithub.prototype['installation-organization'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateGithub.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretCreateGithub.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretCreateGithub.prototype['output-rule'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
DynamicSecretCreateGithub.prototype['skip_dry_run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretCreateGithub.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretCreateGithub.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretCreateGithub.prototype['token'] = undefined;

/**
 * Optional - installation token's allowed permissions
 * @member {Array.<String>} token-permissions
 */
DynamicSecretCreateGithub.prototype['token-permissions'] = undefined;

/**
 * Optional - installation token's allowed repositories
 * @member {Array.<String>} token-repositories
 */
DynamicSecretCreateGithub.prototype['token-repositories'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretCreateGithub.prototype['token-ttl'] = '60m';

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretCreateGithub.prototype['uid-token'] = undefined;
...
export default DynamicSecretCreateGithub;
