...
class TargetUpdateLetsEncrypt {
    ...
    /**
     * Constructs a <code>TargetUpdateLetsEncrypt</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetUpdateLetsEncrypt} obj Optional instance to populate.
     * @return {module:model/TargetUpdateLetsEncrypt} The populated <code>TargetUpdateLetsEncrypt</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetUpdateLetsEncrypt();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateLetsEncrypt</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateLetsEncrypt</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateLetsEncrypt.RequiredProperties) {
 ...
 * @default 'http'
 */
TargetUpdateLetsEncrypt.prototype['acme-challenge'] = 'http';

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
TargetUpdateLetsEncrypt.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
TargetUpdateLetsEncrypt.prototype['description'] = undefined;
 ...
 * @default false
 */
TargetUpdateLetsEncrypt.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
TargetUpdateLetsEncrypt.prototype['keep-prev-version'] = undefined;

/**
 * The name of a key that used to encrypt the target secret value (if empty, the account default protectionKey key will be used)
 * @member {String} key
 */
TargetUpdateLetsEncrypt.prototype['key'] = undefined;

/**
 * @member {String} lets-encrypt-url
 * @default 'production'
 */
TargetUpdateLetsEncrypt.prototype['lets-encrypt-url'] = 'production';

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
TargetUpdateLetsEncrypt.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetUpdateLetsEncrypt.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
TargetUpdateLetsEncrypt.prototype['max-versions'] = undefined;

/**
 * Target name
 * @member {String} name
 */
TargetUpdateLetsEncrypt.prototype['name'] = undefined;

/**
 * New target name
 * @member {String} new-name
 */
TargetUpdateLetsEncrypt.prototype['new-name'] = undefined;

/**
 * Azure resource group name. Required when dns-target-creds points to Azure target
 * @member {String} resource-group
 */
TargetUpdateLetsEncrypt.prototype['resource-group'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
TargetUpdateLetsEncrypt.prototype['rotate-on-unlock'] = undefined;

/**
 * @member {String} timeout
 * @default '5m'
 */
TargetUpdateLetsEncrypt.prototype['timeout'] = '5m';

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
TargetUpdateLetsEncrypt.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
TargetUpdateLetsEncrypt.prototype['uid-token'] = undefined;
...
export default TargetUpdateLetsEncrypt;
