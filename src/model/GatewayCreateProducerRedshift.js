...
class GatewayCreateProducerRedshift {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayCreateProducerRedshift</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayCreateProducerRedshift</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayCreateProducerRedshift.RequiredProperties) {
 ...
 */
GatewayCreateProducerRedshift.prototype['custom-username-template'] = undefined;
 ...
 */
GatewayCreateProducerRedshift.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayCreateProducerRedshift.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
GatewayCreateProducerRedshift.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
GatewayCreateProducerRedshift.prototype['item-custom-fields'] = undefined;
 ...
 */
GatewayCreateProducerRedshift.prototype['output-rule'] = undefined;
 ...
 */
GatewayCreateProducerRedshift.prototype['skip-dry-run'] = undefined;
 ...
 */
GatewayCreateProducerRedshift.prototype['use-capital-letters'] = undefined;
 ...
 */
GatewayCreateProducerRedshift.prototype['use-lower-letters'] = undefined;
 ...
 */
GatewayCreateProducerRedshift.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
GatewayCreateProducerRedshift.prototype['use-special-characters'] = undefined;
