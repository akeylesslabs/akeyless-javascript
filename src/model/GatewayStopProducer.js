...
class GatewayStopProducer {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayStopProducer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayStopProducer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayStopProducer.RequiredProperties) {
...
GatewayStopProducer.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
GatewayStopProducer.prototype['ara-enabled'] = undefined;
 ...
 */
GatewayStopProducer.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayStopProducer.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
GatewayStopProducer.prototype['input-rule'] = undefined;
 ...
 */
GatewayStopProducer.prototype['output-rule'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
GatewayStopProducer.prototype['skip_dry_run'] = undefined;
