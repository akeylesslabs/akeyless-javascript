...
class GatewayCreateProducerPing {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayCreateProducerPing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayCreateProducerPing</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayCreateProducerPing.RequiredProperties) {
...
GatewayCreateProducerPing.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
GatewayCreateProducerPing.prototype['ara-enabled'] = undefined;
 ...
 */
GatewayCreateProducerPing.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayCreateProducerPing.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
GatewayCreateProducerPing.prototype['input-rule'] = undefined;
 ...
 */
GatewayCreateProducerPing.prototype['output-rule'] = undefined;
 ...
 */
GatewayCreateProducerPing.prototype['skip_dry_run'] = undefined;
