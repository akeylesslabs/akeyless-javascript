...
class BastionsList {
    ...
    /**
     * Validates the JSON data with respect to <code>BastionsList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BastionsList</code>.
     */
    static validateJSON(data) {
        if (data['clusters']) { // data not null
            ...
            for (const item of data['clusters']) {
                BastionListEntry.validateJSON(item);
            };
        }
