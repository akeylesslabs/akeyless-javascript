...
class EsmListSecretsOutput {
    ...
    /**
     * Validates the JSON data with respect to <code>EsmListSecretsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EsmListSecretsOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['secrets_list']) { // data not null
            ...
            if (!Array.isArray(data['secrets_list'])) {
                throw new Error("Expected the field `secrets_list` to be an array in the JSON data but got " + data['secrets_list']);
            }
            // validate the optional field `secrets_list` (array)
            for (const item of data['secrets_list']) {
 ...
 */
EsmListSecretsOutput.prototype['next_token'] = undefined;
