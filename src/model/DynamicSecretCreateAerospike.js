...
class DynamicSecretCreateAerospike {
    /**
     * Constructs a new <code>DynamicSecretCreateAerospike</code>.
     * dynamicSecretCreateAerospike is a command that creates an Aerospike dynamic secret
     * @alias module:model/DynamicSecretCreateAerospike
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretCreateAerospike.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretCreateAerospike</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretCreateAerospike} obj Optional instance to populate.
     * @return {module:model/DynamicSecretCreateAerospike} The populated <code>DynamicSecretCreateAerospike</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretCreateAerospike();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateAerospike</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateAerospike</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateAerospike.RequiredProperties) {
...
DynamicSecretCreateAerospike.RequiredProperties = ["name"];

/**
 * @member {Array.<String>} aerospike-roles
 */
DynamicSecretCreateAerospike.prototype['aerospike-roles'] = undefined;

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateAerospike.prototype['ara-enabled'] = undefined;

/**
 * Customize how temporary usernames are generated using go template
 * @member {String} custom-username-template
 */
DynamicSecretCreateAerospike.prototype['custom-username-template'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
DynamicSecretCreateAerospike.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
DynamicSecretCreateAerospike.prototype['description'] = undefined;
 ...
 */
DynamicSecretCreateAerospike.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateAerospike.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateAerospike.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreateAerospike.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
DynamicSecretCreateAerospike.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretCreateAerospike.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretCreateAerospike.prototype['output-rule'] = undefined;
 ...
 */
DynamicSecretCreateAerospike.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretCreateAerospike.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretCreateAerospike.prototype['uid-token'] = undefined;
 ...
 */
DynamicSecretCreateAerospike.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretCreateAerospike.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretCreateAerospike.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretCreateAerospike.prototype['use-special-characters'] = undefined;

/**
 * @member {String} user-ttl
 */
DynamicSecretCreateAerospike.prototype['user-ttl'] = undefined;
...
export default DynamicSecretCreateAerospike;
