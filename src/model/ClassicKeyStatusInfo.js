...
class ClassicKeyStatusInfo {
    ...
    /**
     * Validates the JSON data with respect to <code>ClassicKeyStatusInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClassicKeyStatusInfo</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['last_status'] && !(typeof data['last_status'] === 'string' || data['last_status'] instanceof String)) {
            throw new Error("Expected the field `last_status` to be a primitive type in the JSON string but got " + data['last_status']);
        }
