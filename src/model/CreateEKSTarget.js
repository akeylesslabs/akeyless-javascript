...
class CreateEKSTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEKSTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEKSTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateEKSTarget.RequiredProperties) {
...
CreateEKSTarget.RequiredProperties = ["eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-secret-access-key", "name"];
 ...
 */
CreateEKSTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateEKSTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateEKSTarget.prototype['rotate-on-unlock'] = undefined;
