...
class CreateGcpTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGcpTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGcpTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGcpTarget.RequiredProperties) {
...
CreateGcpTarget.RequiredProperties = ["name"];
 ...
 */
CreateGcpTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateGcpTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateGcpTarget.prototype['rotate-on-unlock'] = undefined;
