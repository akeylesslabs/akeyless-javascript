...
class DynamicSecretUpdatePing {
    /**
     * Constructs a new <code>DynamicSecretUpdatePing</code>.
     * dynamicSecretUpdatePing is a command that updates Ping dynamic secret
     * @alias module:model/DynamicSecretUpdatePing
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretUpdatePing.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretUpdatePing</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretUpdatePing} obj Optional instance to populate.
     * @return {module:model/DynamicSecretUpdatePing} The populated <code>DynamicSecretUpdatePing</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretUpdatePing();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdatePing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdatePing</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdatePing.RequiredProperties) {
...
DynamicSecretUpdatePing.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretUpdatePing.prototype['ara-enabled'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
DynamicSecretUpdatePing.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
DynamicSecretUpdatePing.prototype['description'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdatePing.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretUpdatePing.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretUpdatePing.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
DynamicSecretUpdatePing.prototype['json'] = false;
 ...
 */
DynamicSecretUpdatePing.prototype['output-rule'] = undefined;
 ...
 * @default '9999'
 */
DynamicSecretUpdatePing.prototype['ping-administrative-port'] = '9999';
 ...
 */
DynamicSecretUpdatePing.prototype['ping-atm-id'] = undefined;
 ...
 * @default '9031'
 */
DynamicSecretUpdatePing.prototype['ping-authorization-port'] = '9031';
 ...
 */
DynamicSecretUpdatePing.prototype['ping-cert-subject-dn'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['ping-client-authentication-type'] = 'CLIENT_SECRET';
 ...
 * @default 'false'
 */
DynamicSecretUpdatePing.prototype['ping-enforce-replay-prevention'] = 'false';
 ...
 */
DynamicSecretUpdatePing.prototype['ping-grant-types'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['ping-issuer-dn'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['ping-jwks'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['ping-jwks-url'] = undefined;

/**
 * Ping Federate privileged user password
 * @member {String} ping-password
 */
DynamicSecretUpdatePing.prototype['ping-password'] = undefined;

/**
 * Ping Federate privileged user
 * @member {String} ping-privileged-user
 */
DynamicSecretUpdatePing.prototype['ping-privileged-user'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['ping-redirect-uris'] = undefined;

/**
 * Limit the OAuth client to specific scopes list
 * @member {Array.<String>} ping-restricted-scopes
 */
DynamicSecretUpdatePing.prototype['ping-restricted-scopes'] = undefined;
 ...
 */
DynamicSecretUpdatePing.prototype['ping-signing-algo'] = undefined;

/**
 * Ping URL
 * @member {String} ping-url
 */
DynamicSecretUpdatePing.prototype['ping-url'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key-name
 */
DynamicSecretUpdatePing.prototype['producer-encryption-key-name'] = undefined;

/**
 * If set, dry-run will be skipped [true/false]
 * @member {Boolean} skip-dry-run
 */
DynamicSecretUpdatePing.prototype['skip-dry-run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretUpdatePing.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretUpdatePing.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretUpdatePing.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretUpdatePing.prototype['uid-token'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretUpdatePing.prototype['user-ttl'] = '60m';
...
export default DynamicSecretUpdatePing;
