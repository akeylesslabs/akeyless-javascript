...
/**
 * The RotatedSecretUpdateMysql model module.
 * @module model/RotatedSecretUpdateMysql
 * @version 5.0.37
 */
class RotatedSecretUpdateMysql {
    /**
     * Constructs a new <code>RotatedSecretUpdateMysql</code>.
     * @alias module:model/RotatedSecretUpdateMysql
     * @param name {String} Rotated secret name
     */
    constructor(name) { 
        
        RotatedSecretUpdateMysql.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretUpdateMysql</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretUpdateMysql} obj Optional instance to populate.
     * @return {module:model/RotatedSecretUpdateMysql} The populated <code>RotatedSecretUpdateMysql</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretUpdateMysql();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretUpdateMysql</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretUpdateMysql</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretUpdateMysql.RequiredProperties) {
...
RotatedSecretUpdateMysql.RequiredProperties = ["name"];

/**
 * List of the new tags that will be attached to this item
 * @member {Array.<String>} add-tag
 */
RotatedSecretUpdateMysql.prototype['add-tag'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['authentication-credentials'] = 'use-user-creds';

/**
 * @member {String} auto-rotate
 */
RotatedSecretUpdateMysql.prototype['auto-rotate'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
RotatedSecretUpdateMysql.prototype['delete_protection'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['description'] = 'default_metadata';
 ...
 */
RotatedSecretUpdateMysql.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretUpdateMysql.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretUpdateMysql.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretUpdateMysql.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretUpdateMysql.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
RotatedSecretUpdateMysql.prototype['keep-prev-version'] = undefined;

/**
 * @member {String} key
 */
RotatedSecretUpdateMysql.prototype['key'] = undefined;

/**
 * Lock this secret for read/update while an SRA session is active
 * @member {String} lock-during-sra-session
 */
RotatedSecretUpdateMysql.prototype['lock-during-sra-session'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretUpdateMysql.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretUpdateMysql.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretUpdateMysql.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretUpdateMysql.prototype['name'] = undefined;

/**
 * New item name
 * @member {String} new-name
 */
RotatedSecretUpdateMysql.prototype['new-name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretUpdateMysql.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretUpdateMysql.prototype['password-length'] = undefined;

/**
 * List of the existent tags that will be removed from this item
 * @member {Array.<String>} rm-tag
 */
RotatedSecretUpdateMysql.prototype['rm-tag'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['rotate-after-disconnect'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretUpdateMysql.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretUpdateMysql.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretUpdateMysql.prototype['rotated-username'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretUpdateMysql.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretUpdateMysql.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretUpdateMysql.prototype['rotation-interval'] = undefined;

/**
 * Deprecated. use secure-access-certificate-issuer
 * @member {String} secure-access-bastion-issuer
 */
RotatedSecretUpdateMysql.prototype['secure-access-bastion-issuer'] = undefined;

/**
 * Path to the SSH Certificate Issuer for your Akeyless Secure Access
 * @member {String} secure-access-certificate-issuer
 */
RotatedSecretUpdateMysql.prototype['secure-access-certificate-issuer'] = undefined;

/**
 * The DB name (relevant only for DB Dynamic-Secret)
 * @member {String} secure-access-db-name
 */
RotatedSecretUpdateMysql.prototype['secure-access-db-name'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
RotatedSecretUpdateMysql.prototype['secure-access-enable'] = undefined;

/**
 * Target servers for connections (In case of Linked Target association, host(s) will inherit Linked Target hosts - Relevant only for Dynamic Secrets/producers)
 * @member {Array.<String>} secure-access-host
 */
RotatedSecretUpdateMysql.prototype['secure-access-host'] = undefined;
 ...
 * @default false
 */
RotatedSecretUpdateMysql.prototype['secure-access-web'] = false;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretUpdateMysql.prototype['skip_dry_run'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
RotatedSecretUpdateMysql.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretUpdateMysql.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretUpdateMysql.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretUpdateMysql.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretUpdateMysql;
