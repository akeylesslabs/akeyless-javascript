...
class DynamicSecretUpdateK8s {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateK8s</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateK8s</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateK8s.RequiredProperties) {
...
DynamicSecretUpdateK8s.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretUpdateK8s.prototype['ara-enabled'] = undefined;

/**
 * Customize how temporary usernames are generated using go template
 * @member {String} custom-username-template
 */
DynamicSecretUpdateK8s.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretUpdateK8s.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateK8s.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretUpdateK8s.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretUpdateK8s.prototype['k8s-rolebinding-yaml-data'] = undefined;
 ...
 */
DynamicSecretUpdateK8s.prototype['output-rule'] = undefined;
 ...
 */
DynamicSecretUpdateK8s.prototype['secure-access-certificate-issuer'] = undefined;
 ...
 */
DynamicSecretUpdateK8s.prototype['secure-access-delay'] = undefined;
 ...
 */
DynamicSecretUpdateK8s.prototype['skip_dry_run'] = undefined;
