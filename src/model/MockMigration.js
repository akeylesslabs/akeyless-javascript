...
class MockMigration {
    ...
    /**
     * Validates the JSON data with respect to <code>MockMigration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MockMigration</code>.
     */
    static validateJSON(data) {
        ...
        if (data['payload']) { // data not null
          MockPayload.validateJSON(data['payload']);
        }
