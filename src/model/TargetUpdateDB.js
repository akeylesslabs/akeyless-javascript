...
class TargetUpdateDB {
    /**
     * Constructs a new <code>TargetUpdateDB</code>.
     * @alias module:model/TargetUpdateDB
     * @param connectionType {String} Type of connection to mssql/oracle database [credentials/cloud-identity/wallet]
     * @param dbType {String} 
     * @param name {String} Target name
     */
    constructor(connectionType, dbType, name) { 
        
        TargetUpdateDB.initialize(this, connectionType, dbType, name);
    }
    ...
    /**
     * Constructs a <code>TargetUpdateDB</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetUpdateDB} obj Optional instance to populate.
     * @return {module:model/TargetUpdateDB} The populated <code>TargetUpdateDB</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetUpdateDB();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateDB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateDB</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateDB.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['DBDefinedConnectionType'] && !(typeof data['DBDefinedConnectionType'] === 'string' || data['DBDefinedConnectionType'] instanceof String)) {
            throw new Error("Expected the field `DBDefinedConnectionType` to be a primitive type in the JSON string but got " + data['DBDefinedConnectionType']);
        }
        // ensure the json data is a string
...
TargetUpdateDB.RequiredProperties = ["connection-type", "db-type", "name"];

/**
 * @member {String} DBDefinedConnectionType
 */
TargetUpdateDB.prototype['DBDefinedConnectionType'] = undefined;

/**
 * (Optional) Client id (relevant for \"cloud-service-provider\" only)
 * @member {String} azure-client-id
 */
TargetUpdateDB.prototype['azure-client-id'] = undefined;

/**
 * (Optional) Client secret (relevant for \"cloud-service-provider\" only)
 * @member {String} azure-client-secret
 */
TargetUpdateDB.prototype['azure-client-secret'] = undefined;
 ...
 */
TargetUpdateDB.prototype['cloud-service-provider'] = undefined;

/**
 * Cluster Mode
 * @member {Boolean} cluster-mode
 */
TargetUpdateDB.prototype['cluster-mode'] = undefined;

/**
 * Deprecated - use description
 * @member {String} comment
 */
TargetUpdateDB.prototype['comment'] = undefined;
 ...
 * @default 'credentials'
 */
TargetUpdateDB.prototype['connection-type'] = 'credentials';

/**
 * @member {String} db-name
 */
TargetUpdateDB.prototype['db-name'] = undefined;

/**
 * (Optional) DB server certificates
 * @member {String} db-server-certificates
 */
TargetUpdateDB.prototype['db-server-certificates'] = undefined;

/**
 * (Optional) Server name for certificate verification
 * @member {String} db-server-name
 */
TargetUpdateDB.prototype['db-server-name'] = undefined;

/**
 * @member {String} db-type
 */
TargetUpdateDB.prototype['db-type'] = undefined;
 ...
 * @member {String} host
 */
TargetUpdateDB.prototype['host'] = undefined;
 ...
 * @default false
 */
TargetUpdateDB.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
TargetUpdateDB.prototype['keep-prev-version'] = undefined;

/**
 * The name of a key that used to encrypt the target secret value (if empty, the account default protectionKey key will be used)
 * @member {String} key
 */
TargetUpdateDB.prototype['key'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
TargetUpdateDB.prototype['max-versions'] = undefined;

/**
 * @member {Boolean} mongodb-atlas
 */
TargetUpdateDB.prototype['mongodb-atlas'] = undefined;

/**
 * MongoDB Atlas private key
 * @member {String} mongodb-atlas-api-private-key
 */
TargetUpdateDB.prototype['mongodb-atlas-api-private-key'] = undefined;

/**
 * MongoDB Atlas public key
 * @member {String} mongodb-atlas-api-public-key
 */
TargetUpdateDB.prototype['mongodb-atlas-api-public-key'] = undefined;

/**
 * MongoDB Atlas project ID
 * @member {String} mongodb-atlas-project-id
 */
TargetUpdateDB.prototype['mongodb-atlas-project-id'] = undefined;

/**
 * MongoDB server default authentication database
 * @member {String} mongodb-default-auth-db
 */
TargetUpdateDB.prototype['mongodb-default-auth-db'] = undefined;

/**
 * MongoDB server URI options
 * @member {String} mongodb-uri-options
 */
TargetUpdateDB.prototype['mongodb-uri-options'] = undefined;

/**
 * Target name
 * @member {String} name
 */
TargetUpdateDB.prototype['name'] = undefined;

/**
 * New target name
 * @member {String} new-name
 */
TargetUpdateDB.prototype['new-name'] = undefined;

/**
 * Oracle db service name
 * @member {String} oracle-service-name
 */
TargetUpdateDB.prototype['oracle-service-name'] = undefined;

/**
 * Oracle Wallet login type (password/mtls)
 * @member {String} oracle-wallet-login-type
 */
TargetUpdateDB.prototype['oracle-wallet-login-type'] = undefined;

/**
 * Oracle wallet p12 file data in base64
 * @member {String} oracle-wallet-p12-file-data
 */
TargetUpdateDB.prototype['oracle-wallet-p12-file-data'] = undefined;

/**
 * Oracle wallet sso file data in base64
 * @member {String} oracle-wallet-sso-file-data
 */
TargetUpdateDB.prototype['oracle-wallet-sso-file-data'] = undefined;

/**
 * @member {String} port
 */
TargetUpdateDB.prototype['port'] = undefined;
 ...
 */
TargetUpdateDB.prototype['snowflake-account'] = undefined;

/**
 * RSA Private key (base64 encoded)
 * @member {String} snowflake-api-private-key
 */
TargetUpdateDB.prototype['snowflake-api-private-key'] = undefined;

/**
 * The Private key passphrase
 * @member {String} snowflake-api-private-key-password
 */
TargetUpdateDB.prototype['snowflake-api-private-key-password'] = undefined;
 ...
 * @default false
 */
TargetUpdateDB.prototype['ssl'] = false;

/**
 * SSL connection certificate
 * @member {String} ssl-certificate
 */
TargetUpdateDB.prototype['ssl-certificate'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
TargetUpdateDB.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
TargetUpdateDB.prototype['uid-token'] = undefined;

/**
 * @member {String} user-name
 */
TargetUpdateDB.prototype['user-name'] = undefined;
