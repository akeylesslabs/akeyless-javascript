...
class UpdateNativeK8STarget {
    ...
    constructor(name) { 
        ...
        UpdateNativeK8STarget.initialize(this, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNativeK8STarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNativeK8STarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateNativeK8STarget.RequiredProperties) {
...
UpdateNativeK8STarget.RequiredProperties = ["name"];
 ...
 */
UpdateNativeK8STarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
UpdateNativeK8STarget.prototype['lock-ttl'] = undefined;
 ...
 */
UpdateNativeK8STarget.prototype['rotate-on-unlock'] = undefined;
