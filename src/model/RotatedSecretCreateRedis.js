...
class RotatedSecretCreateRedis {
    /**
     * Constructs a new <code>RotatedSecretCreateRedis</code>.
    ...
    constructor(name, rotatorType, targetName) { 
        ...
        RotatedSecretCreateRedis.initialize(this, name, rotatorType, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreateRedis</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreateRedis} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreateRedis} The populated <code>RotatedSecretCreateRedis</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretCreateRedis();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreateRedis</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreateRedis</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreateRedis.RequiredProperties) {
...
RotatedSecretCreateRedis.RequiredProperties = ["name", "rotator-type", "target-name"];
 ...
 */
RotatedSecretCreateRedis.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretCreateRedis.prototype['authentication-credentials'] = 'use-user-creds';
 ...
 */
RotatedSecretCreateRedis.prototype['description'] = undefined;
 ...
 */
RotatedSecretCreateRedis.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreateRedis.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreateRedis.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretCreateRedis.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreateRedis.prototype['json'] = false;

/**
 * @member {String} key
 */
RotatedSecretCreateRedis.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretCreateRedis.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreateRedis.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
RotatedSecretCreateRedis.prototype['max-versions'] = undefined;

/**
 * Rotated secret name
 * @member {String} name
 */
RotatedSecretCreateRedis.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreateRedis.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreateRedis.prototype['password-length'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreateRedis.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretCreateRedis.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretCreateRedis.prototype['rotated-username'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretCreateRedis.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretCreateRedis.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretCreateRedis.prototype['rotation-interval'] = undefined;

/**
 * The rotator type. options: [target/password]
 * @member {String} rotator-type
 */
RotatedSecretCreateRedis.prototype['rotator-type'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretCreateRedis.prototype['skip_dry_run'] = undefined;
 ...
 * @member {String} token
 */
RotatedSecretCreateRedis.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreateRedis.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreateRedis.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreateRedis.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreateRedis.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreateRedis.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreateRedis;
