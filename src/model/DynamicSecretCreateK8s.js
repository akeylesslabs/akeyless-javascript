...
class DynamicSecretCreateK8s {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateK8s</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateK8s</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateK8s.RequiredProperties) {
 ...
 */
DynamicSecretCreateK8s.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretCreateK8s.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateK8s.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateK8s.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
DynamicSecretCreateK8s.prototype['item-custom-fields'] = undefined;
 ...
 */
DynamicSecretCreateK8s.prototype['k8s-rolebinding-yaml-data'] = undefined;
 ...
 */
DynamicSecretCreateK8s.prototype['output-rule'] = undefined;
 ...
 */
DynamicSecretCreateK8s.prototype['secure-access-certificate-issuer'] = undefined;
 ...
 */
DynamicSecretCreateK8s.prototype['secure-access-delay'] = undefined;
 ...
 */
DynamicSecretCreateK8s.prototype['skip-dry-run'] = undefined;
