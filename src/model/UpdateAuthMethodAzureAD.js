...
class UpdateAuthMethodAzureAD {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAuthMethodAzureAD</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAuthMethodAzureAD</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAuthMethodAzureAD.RequiredProperties) {
...
UpdateAuthMethodAzureAD.RequiredProperties = ["bound-tenant-id", "name"];
 ...
 */
UpdateAuthMethodAzureAD.prototype['allowed-client-type'] = undefined;
 ...
 */
UpdateAuthMethodAzureAD.prototype['audit-logs-claims'] = undefined;
 ...
 */
UpdateAuthMethodAzureAD.prototype['expiration-event-in'] = undefined;
 ...
 */
UpdateAuthMethodAzureAD.prototype['unique-identifier'] = undefined;
