...
class GatewayUpdateProducerGcp {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayUpdateProducerGcp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayUpdateProducerGcp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GatewayUpdateProducerGcp.RequiredProperties) {
 ...
 */
GatewayUpdateProducerGcp.prototype['ara-enabled'] = undefined;

/**
 * Customize how temporary usernames are generated using go template
 * @member {String} custom-username-template
 */
GatewayUpdateProducerGcp.prototype['custom-username-template'] = undefined;
 ...
 */
GatewayUpdateProducerGcp.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
GatewayUpdateProducerGcp.prototype['enable-ai-quorum'] = undefined;
 ...
 */
GatewayUpdateProducerGcp.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
GatewayUpdateProducerGcp.prototype['item-custom-fields'] = undefined;
 ...
 */
GatewayUpdateProducerGcp.prototype['output-rule'] = undefined;
 ...
 */
GatewayUpdateProducerGcp.prototype['skip_dry_run'] = undefined;
