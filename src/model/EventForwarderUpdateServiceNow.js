...
class EventForwarderUpdateServiceNow {
    ...
    /**
     * Validates the JSON data with respect to <code>EventForwarderUpdateServiceNow</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventForwarderUpdateServiceNow</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventForwarderUpdateServiceNow.RequiredProperties) {
...
EventForwarderUpdateServiceNow.RequiredProperties = ["gateways-event-source-locations", "name"];
