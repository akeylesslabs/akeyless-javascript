...
class WebBastionGuacamole {
    ...
    /**
     * Validates the JSON data with respect to <code>WebBastionGuacamole</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebBastionGuacamole</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['keyboard_layout'] && !(typeof data['keyboard_layout'] === 'string' || data['keyboard_layout'] instanceof String)) {
            throw new Error("Expected the field `keyboard_layout` to be a primitive type in the JSON string but got " + data['keyboard_layout']);
        }
