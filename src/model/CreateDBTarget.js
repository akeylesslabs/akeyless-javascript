...
class CreateDBTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDBTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDBTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDBTarget.RequiredProperties) {
...
CreateDBTarget.RequiredProperties = ["connection-type", "db-type", "name"];
 ...
 */
CreateDBTarget.prototype['oracle-wallet-login-type'] = undefined;

/**
 * Oracle wallet p12 file data in base64
 * @member {String} oracle-wallet-p12-file-data
 */
CreateDBTarget.prototype['oracle-wallet-p12-file-data'] = undefined;

/**
 * Oracle wallet sso file data in base64
 * @member {String} oracle-wallet-sso-file-data
 */
CreateDBTarget.prototype['oracle-wallet-sso-file-data'] = undefined;
