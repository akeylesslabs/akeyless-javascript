...
class DynamicSecretUpdateGoogleWorkspace {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateGoogleWorkspace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateGoogleWorkspace</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateGoogleWorkspace.RequiredProperties) {
...
DynamicSecretUpdateGoogleWorkspace.RequiredProperties = ["access-mode", "admin-email", "name"];
 ...
 */
DynamicSecretUpdateGoogleWorkspace.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretUpdateGoogleWorkspace.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateGoogleWorkspace.prototype['enable-ai-quorum'] = undefined;
 ...
 * @default 'ext_email'
 */
DynamicSecretUpdateGoogleWorkspace.prototype['fixed-user-claim-keyname'] = 'ext_email';
 ...
 */
DynamicSecretUpdateGoogleWorkspace.prototype['skip_dry_run'] = undefined;
