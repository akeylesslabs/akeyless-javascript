...
class UpdateAuthMethodCert {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAuthMethodCert</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAuthMethodCert</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAuthMethodCert.RequiredProperties) {
...
UpdateAuthMethodCert.RequiredProperties = ["name", "unique-identifier"];
 ...
 */
UpdateAuthMethodCert.prototype['expiration-event-in'] = undefined;
 ...
 */
UpdateAuthMethodCert.prototype['require-crl-dp'] = undefined;
