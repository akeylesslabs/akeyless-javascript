...
class TargetUpdateGitlab {
    /**
     * Constructs a new <code>TargetUpdateGitlab</code>.
     * @alias module:model/TargetUpdateGitlab
     * @param name {String} Target name
     */
    constructor(name) { 
        
        TargetUpdateGitlab.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>TargetUpdateGitlab</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetUpdateGitlab} obj Optional instance to populate.
     * @return {module:model/TargetUpdateGitlab} The populated <code>TargetUpdateGitlab</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetUpdateGitlab();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetUpdateGitlab</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetUpdateGitlab</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetUpdateGitlab.RequiredProperties) {
...
TargetUpdateGitlab.RequiredProperties = ["name"];

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
TargetUpdateGitlab.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
TargetUpdateGitlab.prototype['description'] = undefined;

/**
 * Gitlab access token
 * @member {String} gitlab-access-token
 */
TargetUpdateGitlab.prototype['gitlab-access-token'] = undefined;

/**
 * Gitlab tls certificate (base64 encoded)
 * @member {String} gitlab-certificate
 */
TargetUpdateGitlab.prototype['gitlab-certificate'] = undefined;
 ...
 */
TargetUpdateGitlab.prototype['gitlab-url'] = 'https://gitlab.com/';
 ...
 * @default false
 */
TargetUpdateGitlab.prototype['json'] = false;

/**
 * Whether to keep previous version [true/false]. If not set, use default according to account settings
 * @member {String} keep-prev-version
 */
TargetUpdateGitlab.prototype['keep-prev-version'] = undefined;

/**
 * The name of a key that used to encrypt the target secret value (if empty, the account default protectionKey key will be used)
 * @member {String} key
 */
TargetUpdateGitlab.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
TargetUpdateGitlab.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetUpdateGitlab.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
TargetUpdateGitlab.prototype['max-versions'] = undefined;

/**
 * Target name
 * @member {String} name
 */
TargetUpdateGitlab.prototype['name'] = undefined;

/**
 * New target name
 * @member {String} new-name
 */
TargetUpdateGitlab.prototype['new-name'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
TargetUpdateGitlab.prototype['rotate-on-unlock'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
TargetUpdateGitlab.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
TargetUpdateGitlab.prototype['uid-token'] = undefined;
...
export default TargetUpdateGitlab;
