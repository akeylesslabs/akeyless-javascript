...
class AuthMethodUpdateLdap {
    /**
     * Constructs a new <code>AuthMethodUpdateLdap</code>.
     * authMethodUpdateLdap is a command that updates a new auth method that will be able to authenticate using LDAP.
     * @alias module:model/AuthMethodUpdateLdap
     * @param name {String} Auth Method name
     */
    constructor(name) { 
        
        AuthMethodUpdateLdap.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>AuthMethodUpdateLdap</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthMethodUpdateLdap} obj Optional instance to populate.
     * @return {module:model/AuthMethodUpdateLdap} The populated <code>AuthMethodUpdateLdap</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthMethodUpdateLdap();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodUpdateLdap</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodUpdateLdap</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodUpdateLdap.RequiredProperties) {
...
AuthMethodUpdateLdap.RequiredProperties = ["name"];
 ...
 * @default 0
 */
AuthMethodUpdateLdap.prototype['access-expires'] = 0;
 ...
 */
AuthMethodUpdateLdap.prototype['allowed-client-type'] = undefined;

/**
 * Subclaims to include in audit logs, e.g \"--audit-logs-claims email --audit-logs-claims username\"
 * @member {Array.<String>} audit-logs-claims
 */
AuthMethodUpdateLdap.prototype['audit-logs-claims'] = undefined;

/**
 * A CIDR whitelist with the IPs that the access is restricted to
 * @member {Array.<String>} bound-ips
 */
AuthMethodUpdateLdap.prototype['bound-ips'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
AuthMethodUpdateLdap.prototype['delete_protection'] = undefined;

/**
 * Auth Method description
 * @member {String} description
 */
AuthMethodUpdateLdap.prototype['description'] = undefined;

/**
 * How many days before the expiration of the auth method would you like to be notified.
 * @member {Array.<String>} expiration-event-in
 */
AuthMethodUpdateLdap.prototype['expiration-event-in'] = undefined;

/**
 * if true: enforce role-association must include sub claims
 * @member {Boolean} force-sub-claims
 */
AuthMethodUpdateLdap.prototype['force-sub-claims'] = undefined;
 ...
 */
AuthMethodUpdateLdap.prototype['gen-key'] = undefined;

/**
 * A CIDR whitelist with the GW IPs that the access is restricted to
 * @member {Array.<String>} gw-bound-ips
 */
AuthMethodUpdateLdap.prototype['gw-bound-ips'] = undefined;
 ...
 * @default false
 */
AuthMethodUpdateLdap.prototype['json'] = false;
 ...
 * @default 0
 */
AuthMethodUpdateLdap.prototype['jwt-ttl'] = 0;

/**
 * Auth Method name
 * @member {String} name
 */
AuthMethodUpdateLdap.prototype['name'] = undefined;
 ...
 */
AuthMethodUpdateLdap.prototype['public-key-data'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
AuthMethodUpdateLdap.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
AuthMethodUpdateLdap.prototype['uid-token'] = undefined;
 ...
 * @default 'users'
 */
AuthMethodUpdateLdap.prototype['unique-identifier'] = 'users';
...
export default AuthMethodUpdateLdap;
