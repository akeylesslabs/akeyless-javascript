...
class CreateAuthMethodAWSIAM {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAuthMethodAWSIAM</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAuthMethodAWSIAM</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAuthMethodAWSIAM.RequiredProperties) {
...
CreateAuthMethodAWSIAM.RequiredProperties = ["bound-aws-account-id", "name"];
 ...
 */
CreateAuthMethodAWSIAM.prototype['expiration-event-in'] = undefined;
 ...
 */
CreateAuthMethodAWSIAM.prototype['unique-identifier'] = undefined;
