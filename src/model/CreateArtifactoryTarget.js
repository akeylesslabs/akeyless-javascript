...
class CreateArtifactoryTarget {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateArtifactoryTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateArtifactoryTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateArtifactoryTarget.RequiredProperties) {
...
CreateArtifactoryTarget.RequiredProperties = ["artifactory-admin-name", "artifactory-admin-pwd", "base-url", "name"];
 ...
 */
CreateArtifactoryTarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
CreateArtifactoryTarget.prototype['lock-ttl'] = undefined;
 ...
 */
CreateArtifactoryTarget.prototype['rotate-on-unlock'] = undefined;
