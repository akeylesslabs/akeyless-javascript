...
class RotatedSecretCreatePostgresql {
    /**
     * Constructs a new <code>RotatedSecretCreatePostgresql</code>.
    ...
    constructor(name, rotatorType, targetName) { 
        ...
        RotatedSecretCreatePostgresql.initialize(this, name, rotatorType, targetName);
    }
    ...
    /**
     * Constructs a <code>RotatedSecretCreatePostgresql</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RotatedSecretCreatePostgresql} obj Optional instance to populate.
     * @return {module:model/RotatedSecretCreatePostgresql} The populated <code>RotatedSecretCreatePostgresql</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RotatedSecretCreatePostgresql();
    ...
    /**
     * Validates the JSON data with respect to <code>RotatedSecretCreatePostgresql</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RotatedSecretCreatePostgresql</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RotatedSecretCreatePostgresql.RequiredProperties) {
...
RotatedSecretCreatePostgresql.RequiredProperties = ["name", "rotator-type", "target-name"];
 ...
 */
RotatedSecretCreatePostgresql.prototype['ara-enabled'] = undefined;
 ...
 */
RotatedSecretCreatePostgresql.prototype['authentication-credentials'] = 'use-user-creds';

/**
 * @member {String} auto-rotate
 */
RotatedSecretCreatePostgresql.prototype['auto-rotate'] = undefined;

/**
 * Protection from accidental deletion of this object [true/false]
 * @member {String} delete_protection
 */
RotatedSecretCreatePostgresql.prototype['delete_protection'] = undefined;

/**
 * Description of the object
 * @member {String} description
 */
RotatedSecretCreatePostgresql.prototype['description'] = undefined;
 ...
 */
RotatedSecretCreatePostgresql.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
RotatedSecretCreatePostgresql.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input)
 * @member {Array.<String>} input-rule
 */
RotatedSecretCreatePostgresql.prototype['input-rule'] = undefined;

/**
 * Additional custom fields to associate with the item
 * @member {Object.<String, String>} item-custom-fields
 */
RotatedSecretCreatePostgresql.prototype['item-custom-fields'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreatePostgresql.prototype['json'] = false;
 ...
 */
RotatedSecretCreatePostgresql.prototype['lock-during-sra-session'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
RotatedSecretCreatePostgresql.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
RotatedSecretCreatePostgresql.prototype['lock-ttl'] = undefined;
 ...
 * @member {String} name
 */
RotatedSecretCreatePostgresql.prototype['name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
RotatedSecretCreatePostgresql.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
RotatedSecretCreatePostgresql.prototype['password-length'] = undefined;
 ...
 */
RotatedSecretCreatePostgresql.prototype['rotate-after-disconnect'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
RotatedSecretCreatePostgresql.prototype['rotate-on-unlock'] = undefined;

/**
 * rotated-username password (relevant only for rotator-type=password)
 * @member {String} rotated-password
 */
RotatedSecretCreatePostgresql.prototype['rotated-password'] = undefined;

/**
 * username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password)
 * @member {String} rotated-username
 */
RotatedSecretCreatePostgresql.prototype['rotated-username'] = undefined;

/**
 * How many days before the rotation of the item would you like to be notified
 * @member {Array.<String>} rotation-event-in
 */
RotatedSecretCreatePostgresql.prototype['rotation-event-in'] = undefined;

/**
 * @member {Number} rotation-hour
 */
RotatedSecretCreatePostgresql.prototype['rotation-hour'] = undefined;

/**
 * @member {String} rotation-interval
 */
RotatedSecretCreatePostgresql.prototype['rotation-interval'] = undefined;

/**
 * The rotator type. options: [target/password]
 * @member {String} rotator-type
 */
RotatedSecretCreatePostgresql.prototype['rotator-type'] = undefined;

/**
 * Deprecated. use secure-access-certificate-issuer
 * @member {String} secure-access-bastion-issuer
 */
RotatedSecretCreatePostgresql.prototype['secure-access-bastion-issuer'] = undefined;

/**
 * Path to the SSH Certificate Issuer for your Akeyless Secure Access
 * @member {String} secure-access-certificate-issuer
 */
RotatedSecretCreatePostgresql.prototype['secure-access-certificate-issuer'] = undefined;

/**
 * The DB name (relevant only for DB Dynamic-Secret)
 * @member {String} secure-access-db-name
 */
RotatedSecretCreatePostgresql.prototype['secure-access-db-name'] = undefined;

/**
 * The DB schema
 * @member {String} secure-access-db-schema
 */
RotatedSecretCreatePostgresql.prototype['secure-access-db-schema'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
RotatedSecretCreatePostgresql.prototype['secure-access-enable'] = undefined;

/**
 * Target servers for connections (In case of Linked Target association, host(s) will inherit Linked Target hosts - Relevant only for Dynamic Secrets/producers)
 * @member {Array.<String>} secure-access-host
 */
RotatedSecretCreatePostgresql.prototype['secure-access-host'] = undefined;
 ...
 * @default false
 */
RotatedSecretCreatePostgresql.prototype['secure-access-web'] = false;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
RotatedSecretCreatePostgresql.prototype['skip_dry_run'] = undefined;
 ...
 * @member {String} token
 */
RotatedSecretCreatePostgresql.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
RotatedSecretCreatePostgresql.prototype['uid-token'] = undefined;
 ...
 */
RotatedSecretCreatePostgresql.prototype['use-capital-letters'] = undefined;
 ...
 */
RotatedSecretCreatePostgresql.prototype['use-lower-letters'] = undefined;
 ...
 */
RotatedSecretCreatePostgresql.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
RotatedSecretCreatePostgresql.prototype['use-special-characters'] = undefined;
...
export default RotatedSecretCreatePostgresql;
