...
class UpdateRotatedSecret {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRotatedSecret</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRotatedSecret</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRotatedSecret.RequiredProperties) {
...
UpdateRotatedSecret.RequiredProperties = ["name"];
 ...
 */
UpdateRotatedSecret.prototype['secure-access-certificate-issuer'] = undefined;
