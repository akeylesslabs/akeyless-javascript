...
class EmailTokenizerInfo {
    ...
    /**
     * Validates the JSON data with respect to <code>EmailTokenizerInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailTokenizerInfo</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['fixed_domain_suffix'] && !(typeof data['fixed_domain_suffix'] === 'string' || data['fixed_domain_suffix'] instanceof String)) {
            throw new Error("Expected the field `fixed_domain_suffix` to be a primitive type in the JSON string but got " + data['fixed_domain_suffix']);
        }
