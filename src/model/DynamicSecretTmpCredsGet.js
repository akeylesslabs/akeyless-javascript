 ...
 */
DynamicSecretTmpCredsGet.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretTmpCredsGet.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretTmpCredsGet.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretTmpCredsGet.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretTmpCredsGet.prototype['output-rule'] = undefined;

/**
 * If set, dry-run will be skipped
 * @member {String} skip_dry_run
 */
DynamicSecretTmpCredsGet.prototype['skip_dry_run'] = undefined;
