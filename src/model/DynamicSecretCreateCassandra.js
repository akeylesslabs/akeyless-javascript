...
class DynamicSecretCreateCassandra {
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretCreateCassandra</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretCreateCassandra</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretCreateCassandra.RequiredProperties) {
...
DynamicSecretCreateCassandra.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretCreateCassandra.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['custom-username-template'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretCreateCassandra.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretCreateCassandra.prototype['input-rule'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['output-rule'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['skip_dry_run'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretCreateCassandra.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretCreateCassandra.prototype['use-special-characters'] = undefined;
