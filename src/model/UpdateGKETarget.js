...
class UpdateGKETarget {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGKETarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGKETarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateGKETarget.RequiredProperties) {
...
UpdateGKETarget.RequiredProperties = ["name"];
 ...
 */
UpdateGKETarget.prototype['description'] = undefined;
 ...
 */
UpdateGKETarget.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
UpdateGKETarget.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
UpdateGKETarget.prototype['max-versions'] = undefined;
 ...
 */
UpdateGKETarget.prototype['rotate-on-unlock'] = undefined;
