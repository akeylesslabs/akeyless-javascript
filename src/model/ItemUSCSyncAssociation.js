...
import RemoteSecretInfo from './RemoteSecretInfo';
...
class ItemUSCSyncAssociation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = RemoteSecretInfo.constructFromObject(data['attributes']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          RemoteSecretInfo.validateJSON(data['attributes']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/RemoteSecretInfo} attributes
 */
