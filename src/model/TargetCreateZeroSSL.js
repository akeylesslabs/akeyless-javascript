...
class TargetCreateZeroSSL {
    /**
     * Constructs a new <code>TargetCreateZeroSSL</code>.
     * targetCreateZeroSSL is a command that creates a new ZeroSSL target
     * @alias module:model/TargetCreateZeroSSL
    ...
    constructor(apiKey, imapFqdn, imapPassword, imapUsername, name) { 
        ...
        TargetCreateZeroSSL.initialize(this, apiKey, imapFqdn, imapPassword, imapUsername, name);
    }
    ...
    /**
     * Constructs a <code>TargetCreateZeroSSL</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetCreateZeroSSL} obj Optional instance to populate.
     * @return {module:model/TargetCreateZeroSSL} The populated <code>TargetCreateZeroSSL</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetCreateZeroSSL();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetCreateZeroSSL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetCreateZeroSSL</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TargetCreateZeroSSL.RequiredProperties) {
...
TargetCreateZeroSSL.RequiredProperties = ["api-key", "imap-fqdn", "imap-password", "imap-username", "name"];
 ...
 * @default '993'
 */
TargetCreateZeroSSL.prototype['imap-port'] = '993';
 ...
 */
TargetCreateZeroSSL.prototype['imap-target-email'] = undefined;

/**
 * ImapUsername to access the IMAP service
 * @member {String} imap-username
 */
TargetCreateZeroSSL.prototype['imap-username'] = undefined;
 ...
 * @default false
 */
TargetCreateZeroSSL.prototype['json'] = false;

/**
 * The name of a key that used to encrypt the target secret value (if empty, the account default protectionKey key will be used)
 * @member {String} key
 */
TargetCreateZeroSSL.prototype['key'] = undefined;

/**
 * Lock this secret after each successful value read
 * @member {String} lock-on-read
 */
TargetCreateZeroSSL.prototype['lock-on-read'] = undefined;

/**
 * Lock TTL in minutes
 * @member {String} lock-ttl
 */
TargetCreateZeroSSL.prototype['lock-ttl'] = undefined;

/**
 * Set the maximum number of versions, limited by the account settings defaults.
 * @member {String} max-versions
 */
TargetCreateZeroSSL.prototype['max-versions'] = undefined;

/**
 * Target name
 * @member {String} name
 */
TargetCreateZeroSSL.prototype['name'] = undefined;

/**
 * Rotate this secret after it is unlocked
 * @member {String} rotate-on-unlock
 */
TargetCreateZeroSSL.prototype['rotate-on-unlock'] = undefined;
 ...
 * @default '5m'
 */
TargetCreateZeroSSL.prototype['timeout'] = '5m';

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
TargetCreateZeroSSL.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
TargetCreateZeroSSL.prototype['uid-token'] = undefined;
...
export default TargetCreateZeroSSL;
