...
class UpdateRole {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['event-forwarder-access'] && !(typeof data['event-forwarder-access'] === 'string' || data['event-forwarder-access'] instanceof String)) {
            throw new Error("Expected the field `event-forwarder-access` to be a primitive type in the JSON string but got " + data['event-forwarder-access']);
        }
        // ensure the json data is a string
...
UpdateRole.RequiredProperties = ["name"];
 ...
 */
UpdateRole.prototype['ara-reports-access'] = undefined;
 ...
 * @default false
 */
UpdateRole.prototype['json'] = false;
