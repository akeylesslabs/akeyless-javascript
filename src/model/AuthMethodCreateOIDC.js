...
class AuthMethodCreateOIDC {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthMethodCreateOIDC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthMethodCreateOIDC</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthMethodCreateOIDC.RequiredProperties) {
...
AuthMethodCreateOIDC.RequiredProperties = ["name", "unique-identifier"];
 ...
 */
AuthMethodCreateOIDC.prototype['allowed-client-type'] = undefined;
 ...
 */
AuthMethodCreateOIDC.prototype['expiration-event-in'] = undefined;
