...
class DynamicSecretUpdateRabbitMq {
    /**
     * Constructs a new <code>DynamicSecretUpdateRabbitMq</code>.
     * dynamicSecretUpdateRabbitMq is a command that updates rabbitmq dynamic secret
     * @alias module:model/DynamicSecretUpdateRabbitMq
     * @param name {String} Dynamic secret name
     */
    constructor(name) { 
        
        DynamicSecretUpdateRabbitMq.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DynamicSecretUpdateRabbitMq</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DynamicSecretUpdateRabbitMq} obj Optional instance to populate.
     * @return {module:model/DynamicSecretUpdateRabbitMq} The populated <code>DynamicSecretUpdateRabbitMq</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DynamicSecretUpdateRabbitMq();
    ...
    /**
     * Validates the JSON data with respect to <code>DynamicSecretUpdateRabbitMq</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DynamicSecretUpdateRabbitMq</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DynamicSecretUpdateRabbitMq.RequiredProperties) {
...
DynamicSecretUpdateRabbitMq.RequiredProperties = ["name"];

/**
 * Enable or disable Agentic Runtime Authority rule enforcement for this item. Mirrors commands.AgenticRulesParams.AraEnabled.
 * @member {Boolean} ara-enabled
 */
DynamicSecretUpdateRabbitMq.prototype['ara-enabled'] = undefined;
 ...
 */
DynamicSecretUpdateRabbitMq.prototype['enable-agentic-runtime-authority'] = undefined;

/**
 * Turns on AI Quorum checks for this item.
 * @member {Boolean} enable-ai-quorum
 */
DynamicSecretUpdateRabbitMq.prototype['enable-ai-quorum'] = undefined;

/**
 * Agentic input rule in name=...,rule=... format (e.g. name=rule1,rule=Sanitize input) Mirrors commands.AgenticRulesParams — kept separate because ResourceDS cannot embed it (different package, different struct layout).
 * @member {Array.<String>} input-rule
 */
DynamicSecretUpdateRabbitMq.prototype['input-rule'] = undefined;
 ...
 * @default false
 */
DynamicSecretUpdateRabbitMq.prototype['json'] = false;

/**
 * Dynamic secret name
 * @member {String} name
 */
DynamicSecretUpdateRabbitMq.prototype['name'] = undefined;

/**
 * Dynamic secret name
 * @member {String} new-name
 */
DynamicSecretUpdateRabbitMq.prototype['new-name'] = undefined;

/**
 * Agentic output rule in name=...,rule=... format (e.g. name=rule1,rule=Mask secrets)
 * @member {Array.<String>} output-rule
 */
DynamicSecretUpdateRabbitMq.prototype['output-rule'] = undefined;

/**
 * The length of the password to be generated
 * @member {String} password-length
 */
DynamicSecretUpdateRabbitMq.prototype['password-length'] = undefined;

/**
 * Dynamic producer encryption key
 * @member {String} producer-encryption-key-name
 */
DynamicSecretUpdateRabbitMq.prototype['producer-encryption-key-name'] = undefined;

/**
 * RabbitMQ Admin password
 * @member {String} rabbitmq-admin-pwd
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-admin-pwd'] = undefined;

/**
 * RabbitMQ Admin User
 * @member {String} rabbitmq-admin-user
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-admin-user'] = undefined;

/**
 * Server URI
 * @member {String} rabbitmq-server-uri
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-server-uri'] = undefined;

/**
 * User configuration permission
 * @member {String} rabbitmq-user-conf-permission
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-user-conf-permission'] = undefined;

/**
 * User read permission
 * @member {String} rabbitmq-user-read-permission
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-user-read-permission'] = undefined;

/**
 * User Tags
 * @member {String} rabbitmq-user-tags
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-user-tags'] = undefined;

/**
 * User Virtual Host
 * @member {String} rabbitmq-user-vhost
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-user-vhost'] = undefined;

/**
 * User write permission
 * @member {String} rabbitmq-user-write-permission
 */
DynamicSecretUpdateRabbitMq.prototype['rabbitmq-user-write-permission'] = undefined;

/**
 * Enable/Disable secure remote access [true/false]
 * @member {String} secure-access-enable
 */
DynamicSecretUpdateRabbitMq.prototype['secure-access-enable'] = undefined;

/**
 * Destination URL to inject secrets
 * @member {String} secure-access-url
 */
DynamicSecretUpdateRabbitMq.prototype['secure-access-url'] = undefined;
 ...
 * @default true
 */
DynamicSecretUpdateRabbitMq.prototype['secure-access-web'] = true;
 ...
 * @default false
 */
DynamicSecretUpdateRabbitMq.prototype['secure-access-web-browsing'] = false;
 ...
 * @default false
 */
DynamicSecretUpdateRabbitMq.prototype['secure-access-web-proxy'] = false;

/**
 * If set, dry-run will be skipped [true/false]
 * @member {Boolean} skip-dry-run
 */
DynamicSecretUpdateRabbitMq.prototype['skip-dry-run'] = undefined;

/**
 * Add tags attached to this object
 * @member {Array.<String>} tags
 */
DynamicSecretUpdateRabbitMq.prototype['tags'] = undefined;

/**
 * Target name
 * @member {String} target-name
 */
DynamicSecretUpdateRabbitMq.prototype['target-name'] = undefined;

/**
 * Authentication token (see `/auth` and `/configure`)
 * @member {String} token
 */
DynamicSecretUpdateRabbitMq.prototype['token'] = undefined;

/**
 * The universal identity token, Required only for universal_identity authentication
 * @member {String} uid-token
 */
DynamicSecretUpdateRabbitMq.prototype['uid-token'] = undefined;
 ...
 */
DynamicSecretUpdateRabbitMq.prototype['use-capital-letters'] = undefined;
 ...
 */
DynamicSecretUpdateRabbitMq.prototype['use-lower-letters'] = undefined;
 ...
 */
DynamicSecretUpdateRabbitMq.prototype['use-numbers'] = undefined;

/**
 * @member {String} use-special-characters
 */
DynamicSecretUpdateRabbitMq.prototype['use-special-characters'] = undefined;
 ...
 * @default '60m'
 */
DynamicSecretUpdateRabbitMq.prototype['user-ttl'] = '60m';
...
export default DynamicSecretUpdateRabbitMq;
