...
class CreateAuthMethodOCI {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAuthMethodOCI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAuthMethodOCI</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAuthMethodOCI.RequiredProperties) {
...
CreateAuthMethodOCI.RequiredProperties = ["group-ocid", "name", "tenant-ocid"];
 ...
 */
CreateAuthMethodOCI.prototype['allowed-client-type'] = undefined;
 ...
 */
CreateAuthMethodOCI.prototype['expiration-event-in'] = undefined;
