...
**allowedClientType** | **[String]** | A default list of client types that are allowed to authenticate [cli,ui,gateway-admin,sdk,mobile,extension]. | [optional] 
...
**enableAiQuorum** | **String** | Enable AI Quorum checks account-wide [true/false] | [optional] 
...
**lockAllowedClientType** | **String** | Lock allowed-client-type setting in the account [true/false]. | [optional] 
...
**lockMaxTtl** | **Number** | Set the maximum TTL for item/target locks in minutes | [optional] 
